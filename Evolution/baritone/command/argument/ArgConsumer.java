...
public class ArgConsumer implements IArgConsumer {
	 ...
	 * to datatypes when an operation is performed upon them.
	 *
	 * @see IDatatype
	...
	public ICommandArgument get2() throws CommandNotEnoughArgumentsException {
		requireMin(1);
		ICommandArgument arg = args.getFirst();
		consumed.add(arg);
		return arg;
	}

	public String getString2() throws CommandNotEnoughArgumentsException {
		return get2().getValue();
	}
