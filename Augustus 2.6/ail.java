...
public class ail extends ahw
{
    ...
    public ail() {
        this.j(this.M.b().a(ail.b, aio.a.a).a(ail.a, ahw.a.b));
    }
    
    @Override
    public arn g(final alz \u2603) {
        final aio.a a = \u2603.b(ail.b);
        switch (ail$2.b[\u2603.b(ail.a).ordinal()]) {
            default: {
                switch (ail$2.a[a.ordinal()]) {
                    default: {
                        return aio.a.b.c();
                    }
                    case 2: {
    ...
    public alz a(final int \u2603) {
        alz alz = this.Q().a(ail.b, aio.a.a((\u2603 & 0x3) % 4));
        switch (\u2603 & 0xC) {
            case 0: {
                alz = alz.a(ail.a, ahw.a.b);
                break;
            }
            case 4: {
                alz = alz.a(ail.a, ahw.a.a);
                break;
            }
            case 8: {
                alz = alz.a(ail.a, ahw.a.c);
                break;
            }
            default: {
                alz = alz.a(ail.a, ahw.a.d);
                break;
            }
        }
        return alz;
    ...
    @Override
    protected ama e() {
        return new ama(this, new amo[] { ail.b, ail.a });
    }
    
    @Override
    protected zx i(final alz \u2603) {
        return new zx(zw.a(this), 1, \u2603.b(ail.b).a());
    }
