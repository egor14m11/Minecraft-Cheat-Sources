...
public class OutlineUtils {
	...
	public static void renderFour(EntityPlayer e) {
		if (KillAura.getTabName(e).length() > 2 && KillAura.CLASS.Teams.getValue() && KillAura
				.getTabName(Minecraft.getMinecraft().thePlayer).startsWith(KillAura.getTabName(e).substring(0, 2))) {
			setColor(new Color(255, 255, 255));
		} else if (FriendManager.isFriend(e.getName())) {
			setColor(new Color(0, 0, 255));
		} else if (PlayerESP.rainbow.getValue()) {
			setColor(new Color(PlayerESP.rainbow(2000000L, 1.0F).getRGB()));
		} else {
	...
	public static void renderFourChest(TileEntityChest te) {
		setColor(new Color(255, 255, 0));
		GL11.glDepthMask(false);
		GL11.glDisable(GL11.GL_DEPTH_TEST);
		GL11.glEnable(GL11.GL_POLYGON_OFFSET_LINE);
	...
	public static void renderFourEChest(TileEntityEnderChest te) {
