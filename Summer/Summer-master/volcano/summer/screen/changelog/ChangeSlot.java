...
public class ChangeSlot extends GuiSlot {
	...
	protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_,
		...
		Minecraft.getMinecraft().fontRendererObj.func_175063_a(change.getType().toString(), p_180791_2_ + 2,
				p_180791_3_ + 2, getColor(change));
		Minecraft.getMinecraft().fontRendererObj.func_175063_a(change.getLabel(), p_180791_2_ + 2, p_180791_3_ + 12,
				-1);
	}
