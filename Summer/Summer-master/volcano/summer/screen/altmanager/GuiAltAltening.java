...
public final class GuiAltAltening extends GuiScreen {
	...
	public GuiAltAltening(GuiScreen previousScreen) {
	...
	protected void actionPerformed(GuiButton button) {
		...
		case 0:/*
				 ...
				 * 
				 * } else if (!this.combined.getText().isEmpty() &&
				 * this.combined.getText().contains(":")) {
				 * 
				 ...
				 * } else {
				 * 
				 * thread = new AltLoginThread(this.username.getText(),
			...
			try {
				Summer.altService.switchService(AltService.EnumAltService.THEALTENING);
				thread = new AltLoginThread(this.username.getText(), "a");
				thread.start();
	...
	public void drawScreen(int x, int y, float z) {
		...
		drawCenteredString(this.mc.fontRendererObj, "Altening Login", this.width / 2, 20, -1);
		...
		if (this.username.getText().isEmpty()) {
			...
			drawString(this.mc.fontRendererObj, "Token", this.width / 2 - 96, 66, -7829368);

		}

		if (this.password.getText().isEmpty()) {

			drawString(this.mc.fontRendererObj, "", this.width / 2 - 96, 200, -7829368);
	...
	public void initGui() {
		...
		this.password = new PasswordField(this.mc.fontRendererObj, this.width / 2 - 1000, 100, 200, 20);

		this.combined = new GuiTextField(eventButton, mc.fontRendererObj, width / 2 - 1000, 140, 200, 20);
