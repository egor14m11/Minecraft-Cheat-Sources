package volcano.summer.screen.clickgui.one2.elements;
...
public class Panel {
	...
	public Panel(final String title, final int posX, final int posY, final int width, final int height,
			final boolean expanded, final boolean pinned, final ClickGui parent) {
	...
	public Panel(final String title, final int posX, final int posY, final boolean expanded, final boolean pinned,
	...
	private boolean isDoubleClick() {
		...
		t.schedule(new TimerTask() {
			@Override
			public void run() {
				Panel.access$0(Panel.this, false);
			}
		}, 500L);
		return false;
	}
