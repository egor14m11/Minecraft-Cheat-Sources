...
class LayerIDecoder implements FrameDecoder {
	...
	public void create(final SoundStream stream0, final Frame header0, final SynthesisFilter filtera,
	...
	abstract static class Subband {
		...
		static {
			scalefactors = new float[] { 2.0f, 1.587401f, 1.2599211f, 1.0f, 0.7937005f, 0.62996054f, 0.5f, 0.39685026f,
					0.31498027f, 0.25f, 0.19842513f, 0.15749013f, 0.125f, 0.099212565f, 0.07874507f, 0.0625f,
					0.049606282f, 0.039372534f, 0.03125f, 0.024803141f, 0.019686267f, 0.015625f, 0.012401571f,
					0.009843133f, 0.0078125f, 0.0062007853f, 0.0049215667f, 0.00390625f, 0.0031003926f, 0.0024607833f,
					0.001953125f, 0.0015501963f, 0.0012303917f, 9.765625E-4f, 7.7509816E-4f, 6.1519584E-4f,
					4.8828125E-4f, 3.8754908E-4f, 3.0759792E-4f, 2.4414062E-4f, 1.9377454E-4f, 1.5379896E-4f,
					1.2207031E-4f, 9.688727E-5f, 7.689948E-5f, 6.1035156E-5f, 4.8443635E-5f, 3.844974E-5f,
					3.0517578E-5f, 2.4221818E-5f, 1.922487E-5f, 1.5258789E-5f, 1.2110909E-5f, 9.612435E-6f,
					7.6293945E-6f, 6.0554544E-6f, 4.8062175E-6f, 3.8146973E-6f, 3.0277272E-6f, 2.4031087E-6f,
					1.9073486E-6f, 1.5138636E-6f, 1.2015544E-6f, 0.0f };
		}

		public abstract void read_allocation(final SoundStream p0, final Frame p1, final Crc16 p2)
	...
	static class SubbandLayer1 extends Subband {
		...
		static {
			table_factor = new float[] { 0.0f, 0.6666667f, 0.2857143f, 0.13333334f, 0.06451613f, 0.031746034f,
					0.015748031f, 0.007843138f, 0.0039138943f, 0.0019550342f, 9.770396E-4f, 4.884005E-4f, 2.4417043E-4f,
					1.2207776E-4f, 6.103702E-5f };
			table_offset = new float[] { 0.0f, -0.6666667f, -0.8571429f, -0.9333334f, -0.9677419f, -0.98412704f,
					-0.992126f, -0.9960785f, -0.99804306f, -0.9990225f, -0.9995115f, -0.99975586f, -0.9998779f,
					-0.99993896f, -0.9999695f };
		}
		...
		@Override
		public void read_allocation(final SoundStream stream, final Frame header, final Crc16 crc)
				throws DecoderException {
		...
		@Override
		public boolean put_next_sample(final int channels, final SynthesisFilter filter1,
				final SynthesisFilter filter2) {
	...
	static class SubbandLayer1Stereo extends SubbandLayer1 {
		...
		public boolean put_next_sample(final int channels, final SynthesisFilter filter1,
			...
			if (this.channel2_allocation != 0 && channels != 1) {
				final float sample2 = (this.channel2_sample * this.channel2_factor + this.channel2_offset)
