...
public class GuiStreamUnavailable extends GuiScreen {
	...
	public void initGui() {
		if (this.field_152323_r.isEmpty()) {
			this.field_152323_r.addAll(this.fontRendererObj.listFormattedStringToWidth(
					this.field_152326_h.func_152561_a().getFormattedText(), (int) (this.width * 0.75F)));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		int var4 = Math.max((int) (this.height * 0.85D / 2.0D
				- this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT / 2.0F), 50);
