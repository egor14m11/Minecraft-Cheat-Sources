...
public abstract class GuiSlot {
	...
	public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
		if (this.field_178041_q) {
			...
			var7.addVertexWithUV(this.left, this.bottom, 0.0D, this.left / var8,
					(this.bottom + (int) this.amountScrolled) / var8);
			var7.addVertexWithUV(this.right, this.bottom, 0.0D, this.right / var8,
					(this.bottom + (int) this.amountScrolled) / var8);
			var7.addVertexWithUV(this.right, this.top, 0.0D, this.right / var8,
					(this.top + (int) this.amountScrolled) / var8);
			var7.addVertexWithUV(this.left, this.top, 0.0D, this.left / var8,
					(this.top + (int) this.amountScrolled) / var8);
			var6.draw();
