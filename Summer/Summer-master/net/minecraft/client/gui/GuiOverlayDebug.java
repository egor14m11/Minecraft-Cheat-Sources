	...
	protected List call() {
		...
		if (this.func_175236_d()) {
			return Lists
					.newArrayList(
							new String[] {
									"Minecraft 1.8 (" + this.mc.func_175600_c() + "/"
									...
									"", String
											.format("XYZ: %.3f / %.5f / %.3f",
													new Object[] { Double.valueOf(this.mc.func_175606_aa().posX),
															Double.valueOf(this.mc.func_175606_aa()
