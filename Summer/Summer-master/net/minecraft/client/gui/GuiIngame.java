...
public class GuiIngame extends Gui {
	...
	public void func_175180_a(float p_175180_1_) {
		...
		if (this.func_175183_b() && this.mc.gameSettings.thirdPersonView < 1 && !Summer.moduleManager.getModule(Crosshair.class).getState()) {
		...
		GlStateManager.pushMatrix();
		EventRender2D eventRender2D = new EventRender2D(var3, var4);
