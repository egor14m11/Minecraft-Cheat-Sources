...
public class GuiPlayerTabOverlay extends Gui {
	...
	private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_,
		...
		if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
			...
			int var9 = Math.max(MathHelper.ceiling_float_int(var7 / 2),
					Math.max(MathHelper.ceiling_float_int(p_175247_6_.func_178860_m() / 2), 10));
			boolean var10 = p_175247_6_.func_178858_o() > this.field_175251_g.getUpdateCounter()
					&& (p_175247_6_.func_178858_o() - this.field_175251_g.getUpdateCounter()) / 3L % 2L == 1L;
			...
			if (var8 > 0) {
				...
				if (var11 > 3.0F) {
					...
					for (var12 = 0; var12 < var8; ++var12) {
						...
						if (var12 * 2 + 1 < var7) {
							this.func_175174_a(p_175247_4_ + var12 * var11, p_175247_2_, var12 >= 10 ? 160 : 52, 0, 9,
									9);
						}

						if (var12 * 2 + 1 == var7) {
							this.func_175174_a(p_175247_4_ + var12 * var11, p_175247_2_, var12 >= 10 ? 169 : 61, 0, 9,
									9);
						}
					}
				} else {
			...
			this.field_175250_f.fontRendererObj.func_175063_a(var15,
					p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var15), p_175247_2_, 16777215);
		}
	}
