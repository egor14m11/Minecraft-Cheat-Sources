...
public class WorldRenderer {
	...
	public WorldRenderer.State getVertexState(float p_178971_1_, float p_178971_2_, float p_178971_3_) {
		...
		PriorityQueue var5 = new PriorityQueue(this.rawBufferIndex,
				new QuadComparator(this.rawFloatBuffer, (float) (p_178971_1_ + this.xOffset),
						(float) (p_178971_2_ + this.yOffset), (float) (p_178971_3_ + this.zOffset),
	...
	public void func_178978_a(float p_178978_1_, float p_178978_2_, float p_178978_3_, int p_178978_4_) {
		...
		if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
			...
			var7 = (int) ((this.field_179007_h >> 24 & 255) * p_178978_1_);
			var8 = (int) ((this.field_179007_h >> 16 & 255) * p_178978_2_);
			var9 = (int) ((this.field_179007_h >> 8 & 255) * p_178978_3_);
			var6 &= 255;
