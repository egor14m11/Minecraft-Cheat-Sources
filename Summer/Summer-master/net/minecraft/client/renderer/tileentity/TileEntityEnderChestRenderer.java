...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer {
	...
	public void func_180540_a(TileEntityEnderChest p_180540_1_, double p_180540_2_, double p_180540_4_,
		...
		if (Summer.moduleManager.getModule(ChestESP.class).getState()
				&& (ChestESP.chestespMode.getStringValue().equalsIgnoreCase("Outline"))) {
			if (ChestESP.enderchest.getValue()) {
				...
				OutlineUtils.renderFourEChest(p_180540_1_);
				field_147521_c.renderAll();
