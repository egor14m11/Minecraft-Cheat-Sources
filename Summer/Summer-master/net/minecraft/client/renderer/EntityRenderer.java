...
import volcano.summer.client.events.GammaSettingEvent;
import volcano.summer.screen.mainmenu.ClientMainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	public void setupCameraTransform(float partialTicks, int pass) {
		...
		if ((this.mc.gameSettings.viewBobbing
				|| (this.mc.thePlayer.onGround)/*
												 * && !(Summer.moduleManager.
												 * getModule(Tracers.class)).
												 * state
												 */)) {
			this.setupViewBobbing(partialTicks); // TODO TRACERS
		}
		...
		if (this.lightmapUpdateNeeded) {
			...
			if (var2 != null) {
				...
				for (int var3 = 0; var3 < 256; ++var3) {
					...
					GammaSettingEvent gammaSettingEvent = new GammaSettingEvent(this.mc.gameSettings.gammaSetting);
					Summer.eventManager.call(gammaSettingEvent);
	...
	private void addRainParticles() {
		// if (Summer.moduleManager.getModule(Weather.class).state) {
		// return;
		// }
	...
	private void frameInit() {
		...
		if ((this.mc.currentScreen instanceof ClientMainMenu)) {
			updateMainMenu((ClientMainMenu) this.mc.currentScreen);
		}
