...
import volcano.summer.client.util.OutlineUtils;
...
public abstract class RendererLivingEntity extends Render {
	...
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
			...
			if ((Summer.moduleManager.getModule(Chams.class).getState()) && (Chams.isCorrect(p_76986_1_))) {
				GL11.glEnable(32823);
			...
			try {
				...
				if (this.field_177098_i) {
					...
					if (Summer.moduleManager.getModule(PlayerESP.class).getState()
							&& PlayerESP.playerESPMode.getStringValue().equalsIgnoreCase("Outline")) {
						GlStateManager.depthMask(true);
						if (!(p_76986_1_ instanceof EntityPlayer) || !((EntityPlayer) p_76986_1_).isInvisible()) {
							renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
						}
	...
	protected boolean func_177088_c(EntityLivingBase p_177088_1_) {
		...
		float var61 = (var2 >> 16 & 255) / 255.0F;
		float var71 = (var2 >> 8 & 255) / 255.0F;
	...
	public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_,
		...
		if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector
			...
			if (this.canRenderName(p_77033_1_)) {
				...
				if ((var8 < var10 * var10) || Summer.moduleManager.getModule(Nametags.class).state) {
					String var11 = p_77033_1_.getDisplayName().getFormattedText();
					float var12 = 0.02666667F;
					GlStateManager.alphaFunc(516, 0.1F);

					if ((p_77033_1_.isSneaking()) && (!Summer.moduleManager.getModule(Nametags.class).state)) {
						FontRenderer var13 = this.getFontRendererFromRenderManager();
						GlStateManager.pushMatrix();
						GlStateManager
								.translate((float) p_77033_2_,
