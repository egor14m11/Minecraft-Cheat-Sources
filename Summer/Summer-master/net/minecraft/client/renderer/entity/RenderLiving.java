	...
	protected void func_110827_b(EntityLiving p_110827_1_, double p_110827_2_, double p_110827_4_, double p_110827_6_,
		...
		if (!Config.isShaders() || !Shaders.isShadowPass) {
			...
			if (var10 != null) {
				...
				double var13 = this.func_110828_a(var10.prevRotationYaw, var10.rotationYaw, p_110827_9_ * 0.5F)
						* 0.01745329238474369D;
				double var15 = this.func_110828_a(var10.prevRotationPitch, var10.rotationPitch, p_110827_9_ * 0.5F)
						* 0.01745329238474369D;
				...
				double var25 = this.func_110828_a(var10.prevPosX, var10.posX, p_110827_9_) - var17 * 0.7D
						- var19 * 0.5D * var23;
				double var27 = this.func_110828_a(var10.prevPosY + var10.getEyeHeight() * 0.7D,
						var10.posY + var10.getEyeHeight() * 0.7D, p_110827_9_) - var21 * 0.5D - 0.25D;
				double var29 = this.func_110828_a(var10.prevPosZ, var10.posZ, p_110827_9_) - var19 * 0.7D
						+ var17 * 0.5D * var23;
				double var31 = this.func_110828_a(p_110827_1_.prevRenderYawOffset, p_110827_1_.renderYawOffset,
