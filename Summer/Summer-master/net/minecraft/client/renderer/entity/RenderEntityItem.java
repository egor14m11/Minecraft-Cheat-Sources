...
import volcano.summer.client.ClientPhysic;
...
public class RenderEntityItem extends Render {
	...
	private int func_177077_a(EntityItem p_177077_1_, double p_177077_2_, double p_177077_4_, double p_177077_6_,
		...
		if (var11 == null) {
			...
			float var14 = 0.25F;
			float var15 = MathHelper.sin((p_177077_1_.func_174872_o() + p_177077_8_) / 10.0F + p_177077_1_.hoverStart)
					* 0.1F + 0.1F;
	...
	public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
		if (Summer.moduleManager.getModule(ItemPhysic.class).getState()) {
			ClientPhysic.doRender((EntityItem)entity, x, y, z, entityYaw, partialTicks);
		} else {
