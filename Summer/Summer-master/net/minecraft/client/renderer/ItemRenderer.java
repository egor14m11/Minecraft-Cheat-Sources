...
public class ItemRenderer {
		...
		if (this.itemToRender != null) {
			if ((this.itemToRender.getItem() instanceof ItemMap)) {
				...
				case 4:
					...
					if (Summer.moduleManager.getModule(Animations.class).getState()) {
						if (Animations.animation.getStringValue().equalsIgnoreCase("Summer")) {
							this.Matt(-0.3f, var4);
							this.func_178103_d();
							break;
						}

						if (Animations.animation.getStringValue().equalsIgnoreCase("1.7")) {
							func_178096_b(var2, var4);
							func_178103_d();
							break;
						}

						if (Animations.animation.getStringValue().equalsIgnoreCase("Push")) {
						...
						if (Animations.animation.getStringValue().equalsIgnoreCase("Geo")) {
							this.func_178096_b(-0.2F, var4);
							this.func_178103_d();
							break;
						}

						if (Animations.animation.getStringValue().equalsIgnoreCase("Winter")) {
							func_178096_b(var2, var4);
							func_178103_d();
	...
	private void func_178096_bXD(final float p_1780961, final float p_1780962) {
		GlStateManager.translate(0.56f, -0.52f, -0.71999997f);
