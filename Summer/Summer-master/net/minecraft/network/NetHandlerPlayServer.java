...
public class NetHandlerPlayServer implements INetHandlerPlayServer, IUpdatePlayerListBox {
	...
	public void update() {
		...
		if (this.playerEntity.getLastActiveTime() > 0L && this.serverController.getMaxPlayerIdleMinutes() > 0
				&& MinecraftServer.getCurrentTimeMillis()
						- this.playerEntity.getLastActiveTime() > this.serverController.getMaxPlayerIdleMinutes() * 1000
								* 60) {
	...
	public void processPlayer(C03PacketPlayer packetIn) {
		...
		if (!this.playerEntity.playerConqueredTheEnd) {
			...
			if (this.hasMoved) {
				...
				float var41 = 0.0625F;
				boolean var42 = var2.getCollidingBoundingBoxes(this.playerEntity,
						this.playerEntity.getEntityBoundingBox().contract(var41, var41, var41)).isEmpty();
				...
				if (!this.playerEntity.noClip) {
					boolean var46 = var2.getCollidingBoundingBoxes(this.playerEntity,
							this.playerEntity.getEntityBoundingBox().contract(var41, var41, var41)).isEmpty();
				...
				AxisAlignedBB var49 = this.playerEntity.getEntityBoundingBox().expand(var41, var41, var41)
	...
	public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
		...
		if (packetIn.getPlacedBlockDirection() == 255) {
			...
			if (this.hasMoved
					&& this.playerEntity.getDistanceSq(var5.getX() + 0.5D, var5.getY() + 0.5D,
							var5.getZ() + 0.5D) < 64.0D
