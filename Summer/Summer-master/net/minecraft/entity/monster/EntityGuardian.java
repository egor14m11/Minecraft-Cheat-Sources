...
public class EntityGuardian extends EntityMob {
	...
	public float func_180484_a(BlockPos p_180484_1_) {
		return this.worldObj.getBlockState(p_180484_1_).getBlock().getMaterial() == Material.water
				? 10.0F + this.worldObj.getLightBrightness(p_180484_1_) - 0.5F : super.func_180484_a(p_180484_1_);
	}
			...
			if (this.func_175472_n() && this.isInWater()) {
				...
				for (int var2 = 0; var2 < 2; ++var2) {
					this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE,
							this.posX + (this.rand.nextDouble() - 0.5D) * this.width - var1.xCoord * 1.5D,
							this.posY + this.rand.nextDouble() * this.height - var1.yCoord * 1.5D,
							this.posZ + (this.rand.nextDouble() - 0.5D) * this.width - var1.zCoord * 1.5D, 0.0D, 0.0D,
							0.0D, new int[0]);
				}
			}
				...
				if (var14 != null) {
					...
					while (var12 < var10) {
						...
						this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + var4 * var12,
								this.posY + var6 * var12 + this.getEyeHeight(), this.posZ + var8 * var12, 0.0D, 0.0D,
								0.0D, new int[0]);
					}
				}
			}
	...
	class GuardianMoveHelper extends EntityMoveHelper {
		...
		public void onUpdateMoveHelper() {
			if (this.update && !this.field_179930_g.getNavigator().noPath()) {
				...
				double var11 = Math.sin((this.field_179930_g.ticksExisted + this.field_179930_g.getEntityId()) * 0.5D)
						* 0.05D;
				...
				var11 = Math.sin((this.field_179930_g.ticksExisted + this.field_179930_g.getEntityId()) * 0.75D)
						* 0.05D;
