...
public class EntityEnderman extends EntityMob {
	...
	private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
		...
		if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
			...
			Vec3 var4 = new Vec3(this.posX - p_70821_1_.posX, this.getEntityBoundingBox().minY + this.height / 2.0F
					- (p_70821_1_.posY + p_70821_1_.getEyeHeight()), this.posZ - p_70821_1_.posZ);
	...
	protected boolean teleportToEntity(Entity p_70816_1_) {
		Vec3 var2 = new Vec3(this.posX - p_70816_1_.posX,
	...
	protected boolean teleportTo(double p_70825_1_, double p_70825_3_, double p_70825_5_) {
		...
		if (!var13) {
			...
			for (int var29 = 0; var29 < var28; ++var29) {
				...
				this.worldObj.spawnParticle(EnumParticleTypes.PORTAL, var22, var24, var26, var19, var20, var21,
						new int[0]);
			}
