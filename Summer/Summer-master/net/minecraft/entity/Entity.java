...
import volcano.summer.client.events.SafeEvent;
...
public abstract class Entity implements ICommandSender {
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			boolean var19 = (this.onGround && this.isSneaking() && this instanceof EntityPlayer)
					|| (this.onGround && this.equals(Minecraft.thePlayer) && Summer.moduleManager.getModule(
							Scaffold.class).state /* && Scaffold.mode.getValString().equalsIgnoreCase("Normal") */);
			...
			if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z)) {
                ...
                List<AxisAlignedBB> list = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var13, y, var17));
                AxisAlignedBB axisalignedbb4 = this.getEntityBoundingBox();
                AxisAlignedBB axisalignedbb5 = axisalignedbb4.addCoord(var13, 0.0D, var17);
                double d9 = y;
	...
	/**
	 * public final Vec3 func_174806_f(float p_174806_1_, float p_174806_2_) { float
	 * var3 = MathHelper.cos(-p_174806_2_ * 0.017453292F - 3.1415927F); float var4 =
	 * MathHelper.sin(-p_174806_2_ * 0.017453292F - 3.1415927F); float var5 =
	 * -MathHelper.cos(-p_174806_1_ * 0.017453292F); float var6 =
	 * MathHelper.sin(-p_174806_1_ * 0.017453292F); return new Vec3(var4 * var5,
	 * var6, var3 * var5); }
	 */
