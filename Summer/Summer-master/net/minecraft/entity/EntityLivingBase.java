...
public abstract class EntityLivingBase extends Entity {
	...
	public void onEntityUpdate() {
		...
		if (this.isEntityAlive()) {
			if (this.isEntityInsideOpaqueBlock()) {
				...
				if (var2 < 0.0D) {
					this.attackEntityFrom(DamageSource.inWall, Math.max(1,
			...
			if (!this.canBreatheUnderwater() && !this.isPotionActive(Potion.waterBreathing.id) && !var7) {
				...
				if (this.getAir() == -20) {
					...
					for (int var3 = 0; var3 < 8; ++var3) {
						...
						this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + var4, this.posY + var5,
								this.posZ + var6, this.motionX, this.motionY, this.motionZ, new int[0]);
					}
		...
		if (this.prevRotationYawHead != this.rotationYawHead) {
			++this.headMovement;
		}
		...
		if (this.deathTime == 20) {
			...
			for (var1 = 0; var1 < 20; ++var1) {
				...
				this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL,
						...
						this.posZ + this.rand.nextFloat() * this.width * 2.0F - this.width, var8, var4, var6,
						new int[0]);
			}
		}
	}
		...
		if (var11 > 0) {
			...
			if (var4 && var11 > 0) {
				...
				this.worldObj.spawnParticle(var12 ? EnumParticleTypes.SPELL_MOB_AMBIENT : EnumParticleTypes.SPELL_MOB,
						...
						this.posZ + (this.rand.nextDouble() - 0.5D) * this.width, var5, var7, var9, new int[0]);
			}
		}
	}
	...
	public boolean canEntityBeSeen(Entity p_70685_1_) {
		return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + this.getEyeHeight(), this.posZ),
