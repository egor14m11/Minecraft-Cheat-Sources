...
public class Block {
	...
	public int getLightValue() {
		if (Summer.moduleManager.getModule(Fullbright.class).getState()) {
			return 15;
		}
	...
	public boolean isFullCube() {
		return !Summer.moduleManager.getModule(Xray.class).getState();
	}
	...
	public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
		if ((Summer.moduleManager.getModule(Xray.class).getState())
				|| (Summer.moduleManager.getModule(Fullbright.class).getState())) {
			return 200;
		}
	...
	public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list,
		...
		event.setBlock(state.getBlock(), this.getCollisionBoundingBox(worldIn, pos, state), pos.getX(), pos.getY(),
				pos.getZ(), pos);
		EventManager.call(event);

		AxisAlignedBB var7 = event.getBoundingBox();
		// AxisAlignedBB var7 = this.getCollisionBoundingBox(worldIn, pos,
		// state);
