...
public abstract class BiomeGenBase {
	...
	public final float func_180626_a(BlockPos p_180626_1_) {
		if (p_180626_1_.getY() > 64) {
			float var2 = (float) (temperatureNoise.func_151601_a(p_180626_1_.getX() * 1.0D / 8.0D,
	...
	public BiomeGenBase.TempCategory getTempCategory() {
		return this.temperature < 0.2D ? BiomeGenBase.TempCategory.COLD
				: (this.temperature < 1.0D ? BiomeGenBase.TempCategory.MEDIUM : BiomeGenBase.TempCategory.WARM);
	}
