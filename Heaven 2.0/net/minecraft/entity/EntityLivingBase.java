...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
    	HitAnimation hitAnimation = Wrapper.getModule().get("HitAnimation");
    	int speed = (int) (hitAnimation.isEnabled() ? hitAnimation.speed.getValue() : 6);
            ...
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
            {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
                {
                    if (this.isElytraFlying())
                    {
                    	...
                    	StrafeEvent strafeEvent = new StrafeEvent((float) d6, (float)d8, (float)d1);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isJumping)
        {
            ...
            {
                this.jump();
                this.jumpTicks = Wrapper.getModule().get("NoJumpDelay").isEnabled() ? 0 : 10;
            }
        }
        else
        {
    	...
    	EventManager.call(new LivingEntityEvent(EventType.POST));
    }
    ...
    {
    	NoPush noPush = Wrapper.getModule().get("NoPush");
    	if (this == Wrapper.getPlayer() && noPush.isEnabled() && noPush.entity.isToggle())
    		return false;
