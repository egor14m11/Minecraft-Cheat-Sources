...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onUpdate()
    {
        ...
        this.noClip = this.isSpectator() || clipEvent.isCancelled();
    ...
    public boolean isPushedByWater()
    {
    	...
    	if (noPush.isEnabled() && noPush.water.isToggle())
    		return false;
    ...
    {
        if (Wrapper.getModule().get("HandFlicker").isEnabled() && this == Wrapper.getPlayer() && Wrapper.MC.gameSettings.thirdPersonView == 0)
            return Wrapper.MC.gameSettings.mainHand;
