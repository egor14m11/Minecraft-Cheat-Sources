...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.world != null)
        {
            ...
            for (int j = 0; j < list.size(); ++j)
            {
                ...
                if (entity1 instanceof EntityArmorStand && noInteract.isEnabled() && noInteract.armorStands.isToggle()) {
                    return;
                }
    ...
    private void hurtCameraEffect(float partialTicks)
    {
		...
		if (noRender.isEnabled() && noRender.noHurtCam.isToggle())
			return;
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (raytraceresult != null && !Wrapper.getModule().get("CameraClip").isEnabled()) {
