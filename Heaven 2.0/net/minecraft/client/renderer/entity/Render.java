...
import org.spray.heaven.features.module.modules.render.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    {
        NameTags nameTags = ((NameTags) Wrapper.getModule().get("NameTags"));
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            if (nameProtect.isEnabled() && nameProtect.scoreboard.isToggle() && nameProtect.isValid(str)) {
            	str = nameProtect.PROTECT;
            }
