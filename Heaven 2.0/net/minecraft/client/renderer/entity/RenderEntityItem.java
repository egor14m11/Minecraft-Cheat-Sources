...
import org.spray.heaven.features.module.modules.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem> {
	...
	private int transformModelCount(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_,
		...
		if (item == null) {
			...
			if (Wrapper.getModule().get("ItemPhysics").isEnabled()) {
				shadowSize = 0;
				int i = this.getModelCount(itemstack);
				float f2 = p_177077_9_.getItemCameraTransforms()
						.getTransform(ItemCameraTransforms.TransformType.GROUND).scale.y;
				GlStateManager.translate((float) p_177077_2_, ((float) p_177077_4_ + 0.25F * f2) - 0.1,
						(float) p_177077_6_);
