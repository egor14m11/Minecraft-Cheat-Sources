...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public ResourceLocation getEntityTexture(AbstractClientPlayer entity) {
        ...
        if (customModel.isEnabled() && (!customModel.onlySelf.isToggle() || entity == Minecraft.getMinecraft().player || Wrapper.getFriend().contains(entity.getName()) && customModel.friends.isToggle())) {
            if (customModel.isEnabled() && customModel.mode.getCurrentMode().equals("Amogus")) {
                return new ResourceLocation("heaven/textures/models/amogus.png");
            }

            if (customModel.isEnabled() && customModel.mode.getCurrentMode().equals("Demon")) {
                return new ResourceLocation("heaven/textures/models/demon.png");
            }
        }
