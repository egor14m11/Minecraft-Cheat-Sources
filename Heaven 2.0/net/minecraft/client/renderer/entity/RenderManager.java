...
public class RenderManager
{
    ...
    private void renderDebugBoundingBox(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        HitBoxes hitboxes = ((HitBoxes)Wrapper.getModule().get("HitBoxes"));
        AxisAlignedBB axisalignedbb = hitboxes.isEnabled() && hitboxes.visible.isToggle() ? 
        		entityIn.getEntityBoundingBox().expandXyz(hitboxes.getCustomSize(entityIn)) : entityIn.getEntityBoundingBox();
