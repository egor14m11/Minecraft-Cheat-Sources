...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        EventManager.call(new StartRegisterEvent(EventType.PRE));
        ...
        EventManager.call(new StartRegisterEvent(EventType.POST));
    }
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("heaven/textures/gui/logo_16x16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("heaven/textures/gui/logo_32x32.png"));
    ...
    {
        OpenScreenEvent event = new OpenScreenEvent(guiScreenIn);
        ...
        if (guiScreenIn instanceof GuiMainMenu || guiScreenIn instanceof GuiMultiplayer)
        {
            ...
            this.ingameGUI.getChatGUI().clearChatMessages(!Wrapper.getModule().get("ChatHistory").isEnabled());
        }
    ...
    {
        return this.world == null && this.currentScreen != null ? 299 : this.gameSettings.limitFramerate;
    }
