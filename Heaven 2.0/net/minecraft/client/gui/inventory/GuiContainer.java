...
import org.spray.heaven.features.module.modules.player.ChestStealer;
import org.spray.heaven.features.module.modules.player.ItemScroller;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    private final Animation animation = new EaseBackIn(270, 1f, 1.03f);
    ...
    public void initGui()
    {
        ...
        int buttonHeight = 20;
        buttonList.add(new GuiButton(555, 4, 6, 130, buttonHeight, "Disable KillAura"));
        buttonList.add(new GuiButton(666, 4, 6 + buttonHeight + 3, 130, buttonHeight, "Disable ChestStealer"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            ...
            {
            	ItemScroller scroller = Wrapper.getModule().get("ItemScroller");
            	if (scroller.isEnabled() && Mouse.isButtonDown(0) && Keyboard.isKeyDown(this.mc.gameSettings.keyBindSneak.getKeyCode()) 
            			&& timer.hasReached(scroller.delay.getValue())) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 555) {
        	Wrapper.getModule().get("KillAura").disable();
        }
        else if (button.id == 666) {
        	Wrapper.getModule().get("ChestStealer").disable();
        }
    }
