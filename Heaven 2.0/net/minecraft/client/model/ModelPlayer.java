...
import org.spray.heaven.features.module.modules.render.CustomModels;
...
//        super.render(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
        ...
        if ((!customModel.onlySelf.isToggle() || entityIn == (Minecraft.getMinecraft()).player || (Wrapper.getFriend().contains(entityIn.getName()) && customModel.friends.isToggle())) && customModel.isEnabled()) {
            if (customModel.mode.getCurrentMode().equals("Amogus")) {
                ...
                int bodyColor = customModel.bodyColor.getColor().getRGB();

                int eyeColor = customModel.eyeColor.getColor().getRGB();
                int legsColor = customModel.legsColor.getColor().getRGB();
                
                if (customModel.friendHighlight.isToggle() && Wrapper.getFriend().contains(entityIn.getName())) {
            ...
            } else if (customModel.isEnabled() && customModel.mode.getCurrentMode().equals("Rabbit")) {
                GlStateManager.pushMatrix();
            ...
            } else if (customModel.isEnabled() && customModel.mode.getCurrentMode().equals("Demon")) {
