...
public class Drawable {
	...
	public static void startScissor(double x, double y, double width, double height, double factor) {
		...
		double scaleWidth = (double) Wrapper.MC.displayWidth / resolution.getScaledWidth_double();
		double scaleHeight = (double) Wrapper.MC.displayHeight / resolution.getScaledHeight_double();

		scaleWidth *= factor;
		scaleHeight *= factor;

		GL11.glScissor((int) (x * scaleWidth), (Wrapper.MC.displayHeight) - (int) ((y + height) * scaleHeight),
