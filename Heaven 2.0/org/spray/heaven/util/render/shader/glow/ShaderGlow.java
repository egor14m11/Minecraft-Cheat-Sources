...
public abstract class ShaderGlow {
	...
	public ShaderGlow(String vertShader, String fragmentShader) {
		int vertexShaderID, fragmentShaderID;

		try {
			final InputStream vertexStream = getClass()
					.getResourceAsStream("/assets/minecraft/infinity/shaders/" + vertShader);
			...
			final InputStream fragmentStream = getClass()
					.getResourceAsStream("/assets/minecraft/infinity/shaders/fragment/" + fragmentShader);
