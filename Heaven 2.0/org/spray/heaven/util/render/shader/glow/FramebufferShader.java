 ...
 * @author TheSlowly
 */
public abstract class FramebufferShader extends ShaderGlow {
    ...
    public FramebufferShader(String vertShader, String fragmentShader) {
        super(vertShader, fragmentShader);
    }
