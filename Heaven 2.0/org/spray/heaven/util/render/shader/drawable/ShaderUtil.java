package org.spray.heaven.util.render.shader.drawable;
...
public class ShaderUtil {
    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                default:
                    fragmentShaderID = createShader(
                            Wrapper.MC.getResourceManager().getResource(new ResourceLocation(fragmentShaderLoc))
            ...
            int vertexShaderID = createShader(
                    Wrapper.MC.getResourceManager().getResource(new ResourceLocation(vertexShaderLoc)).getInputStream(),
                    GL_VERTEX_SHADER);
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "heaven/shaders/vertex.vsh");
    }
    ...
    public static void drawQuads(float x, float y, float width, float height) {
        if (Wrapper.MC.gameSettings.ofFastRender) return;
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);
        glVertex2f(x, y);
        glTexCoord2f(0, 1);
