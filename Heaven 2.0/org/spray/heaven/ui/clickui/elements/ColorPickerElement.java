...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        IFont.WEB_SETTINGS.drawString(setting.getName(), x + 4, y + 4, clickUI.textShadow.isToggle(), -1);
        Drawable.drawBlurredShadow((int) (x + width - 20), (int) (y + 5), 14, 6, 10, setting.getColor());
        RoundedShader.drawRound((float) (x + width - 20), (float) (y + 5), 14, 6, 1, setting.getColor());

        renderPicker(mouseX, mouseY, setting.getColor());
    }
    ...
    private void updatePos() {
        float[] hsb = Color.RGBtoHSB(setting.getColor().getRed(), setting.getColor().getGreen(),
                setting.getColor().getBlue(), null);
