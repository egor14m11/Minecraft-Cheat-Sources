...
public class FileManager {
    ...
    public static File directory = new File("hexbyte");
    public static ArrayList<CustomFile> files = new ArrayList<>();

    public FileManager() {
       // files.add(new AltConfig("MacroConfig", true));
    }
    ...
    public abstract static class CustomFile {
        ...
        public CustomFile(String name, boolean loadOnStart) {
            ...
            this.file = new File(FileManager.directory, name + ".hex");
            if (!this.file.exists()) {
                try {
                    this.saveFile();
                } catch (Exception e) {
