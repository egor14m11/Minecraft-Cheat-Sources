...
import ua.apraxia.utility.math.RandomUtils;
...
public class ClipCommand
    ...
    public ClipCommand() {
        super("clip", "clip | vclip | hclip | random", ".clip | hclip | vclip | eclip | random + | - | bedrock  | <value> | up  | down", "clip", "vclip", "eclip", "hclip", "random", "VertClip");
    }
    ...
    public void execute(String ... args2) {
        if (args2.length > 1) {
            ...
            if (args2[0].equalsIgnoreCase("clip") || args2[0].equalsIgnoreCase("vclip")) {
                ...
                try {
                    ...
                    if (args2[1].equals("random")) {
                        a = RandomUtils.getRandom(7);
                        b = RandomUtils.getRandom(444);
                        if (a < 222.0) {
                            this.mc.player.setPositionAndUpdate(this.mc.player.posX, this.mc.player.posY - a, this.mc.player.posZ);
                            ChatUtility.addChatMessage("\u0443\u0441\u043f\u0435\u0448\u043d\u044b\u0439 \u0442\u0435\u043b\u0435\u043f\u043e\u0440\u0442 \u0432\u043d\u0438\u0437 \u043d\u0430 " + a + " \u0431\u043b\u043e\u043a\u043e\u0432");
                        } else {
                            this.mc.player.setPositionAndUpdate(this.mc.player.posX, this.mc.player.posY + a, this.mc.player.posZ);
                            ChatUtility.addChatMessage("\u0443\u0441\u043f\u0435\u0448\u043d\u044b\u0439 \u0442\u0435\u043b\u0435\u043f\u043e\u0440\u0442 \u0432\u0432\u0435\u0440\u0445 \u043d\u0430 " + a + " \u0431\u043b\u043e\u043a\u043e\u0432");
                        }
                    }
                    if (args2[1].equals("+")) {
                        int i = 0;
                    ...
                    if (args2[1].equals("down")) {
                        for (int i = 0; i < 255; ++i) {
                            ...
                            ChatUtility.addChatMessage((Object)((Object) TextFormatting.RED) + "\u0422\u0443\u0442 \u043c\u043e\u0436\u043d\u043e \u0442\u0435\u043b\u0435\u043f\u043e\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c\u0441\u044f \u0442\u043e\u043b\u044c\u043a\u043e \u043f\u043e\u0434 \u0431\u0435\u0434\u0440\u043e\u043a.");
                            return;
                        }
                    }
                    ...
                    if (args2[1].equals("down") || args2[1].equals("up")) {
                        if (y == 0.0f) {
                            if (NumberUtils.isNumber(args2[1])) {
                                ...
                                ChatUtility.addChatMessage((Object)((Object)TextFormatting.RED) + args2[1] + (Object)((Object)TextFormatting.GRAY) + " \u043d\u0435 \u044f\u0432\u043b\u044f\u0435\u0442\u0441\u044f \u0447\u0438\u0441\u043b\u043e\u043c!");
                                return;
                            }
                        }
                        int i = 0;
            ...
            if (args2[0].equalsIgnoreCase("hclip")) {
                ...
                try {
                    if (args2[1].equals("random")) {
                        double a2 = RandomUtils.getRandom(20);
                        this.mc.player.setPositionAndUpdate(x - Math.sin(yaw) * a2, y2, z + Math.cos(yaw) * a2);
                        ChatUtility.addChatMessage("\u0443\u0441\u043f\u0435\u0448\u043d\u044b\u0439 \u0442\u0435\u043b\u0435\u043f\u043e\u0440\u0442 \u0432\u043f\u0435\u0440\u0435\u0434 \u043d\u0430 " + a2 + " \u0431\u043b\u043e\u043a\u043e\u0432");
                    }
                    if (args2[1].equals("+")) {
