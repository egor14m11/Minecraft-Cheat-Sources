package ua.apraxia.utility.font;
...
public class Font {
    ...
    public Font(java.awt.Font font, boolean antiAlias, boolean fractionalMetrics) {
        this.font = font;
    ...
    public static java.awt.Font readFontFromFile(String fontName, float size) {
        try {
            java.awt.Font font = java.awt.Font.createFont(java.awt.Font.PLAIN, Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("stardust/fonts/" + fontName)).getInputStream());
    ...
    protected BufferedImage generateFontImage(java.awt.Font font, boolean antiAlias, boolean fractionalMetrics,
                                              CharData[] chars) {
