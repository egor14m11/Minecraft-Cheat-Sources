...
public class GradientUtility implements Utility {
    ...
    private static final ShaderUtility gradientMaskShader = new ShaderUtility("stardust/shaders/gradientMask.frag");
    private static final ShaderUtility gradientShader = new ShaderUtility("stardust/shaders/gradient.frag");
