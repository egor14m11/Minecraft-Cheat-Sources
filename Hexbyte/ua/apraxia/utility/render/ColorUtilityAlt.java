...
public class ColorUtilityAlt implements Utility {
    ...
    public static int getColor(int red, int green, int blue) {
        return ColorUtilityAlt.getColor(red, green, blue, 255);
    }
    ...
    public static int getColor(int brightness, int alpha) {
        return ColorUtilityAlt.getColor(brightness, brightness, brightness, alpha);
    }
