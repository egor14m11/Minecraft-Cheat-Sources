...
import ua.apraxia.eventapi.events.impl.player.EventUpdateLiving;
import ua.apraxia.modules.impl.player.FreeCam;
import ua.apraxia.modules.impl.player.NoPush;
import ua.apraxia.utility.other.wavecape.CapeHolder;
import ua.apraxia.utility.other.wavecape.stim.StickSimulation;
...
public abstract class EntityPlayer extends EntityLivingBase implements CapeHolder
{
    ...
    public void onUpdate() {
        this.noClip =  Hexbyte.getInstance().moduleManagment.getModule(FreeCam.class).isModuleState() || this.isSpectator();
    ...
    public boolean isPushedByWater() {
        if (Hexbyte.getInstance().moduleManagment.getModule(NoPush.class).isModuleState() && NoPush.water.value) {
            return false;
        }
        return !this.capabilities.isFlying;
    }
