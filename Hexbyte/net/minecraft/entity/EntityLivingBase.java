...
public abstract class EntityLivingBase extends Entity
{
    ...
    private int getArmSwingAnimationEnd() {
           if (Hexbyte.getInstance().moduleManagment.getModule(ItemAnimations.class).isModuleState()) {
                 int speed = (int) ItemAnimations.speed.value;
    ...
    {
        if (Hexbyte.getInstance().moduleManagment.getModule(NoPush.class).isModuleState() && NoPush.players.value && this instanceof EntityPlayerSP) {
            return false;
        }
