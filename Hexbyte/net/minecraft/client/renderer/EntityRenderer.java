...
import ua.apraxia.gui.menu.GuiMainMenu;
import ua.apraxia.modules.impl.player.NoInteract;
import ua.apraxia.modules.impl.world.NoRenderOverlay;
import ua.apraxia.modules.impl.world.WorldFeatures;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.world != null)
        {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (entity1 instanceof EntityArmorStand && Hexbyte.getInstance().moduleManagment.getModule(NoInteract.class).isModuleState() && NoInteract.armorStands.value) {
                    return;
                }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (Hexbyte.getInstance().moduleManagment.getModule(NoRenderOverlay.class).isModuleState() && NoRenderOverlay.noHurtCam.value) {
            return;
        }
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (raytraceresult != null) {
                        ...
                        if (Hexbyte.getInstance().moduleManagment.getModule(NoRenderOverlay.class).isModuleState() && NoRenderOverlay.cameraClip.value) {
                        } else {
                            if (d7 < d3) {
                                d3 = d7;
                            }
    ...
    private void updateLightmap(float partialTicks)
    {
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                if (Hexbyte.getInstance().moduleManagment.getModule(WorldFeatures.class).isModuleState() && WorldFeatures.worldColor.value) {
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        if (Hexbyte.getInstance().moduleManagment.getModule(WorldFeatures.class).isModuleState() && WorldFeatures.snow.value) {
            ...
            if (f > 0.0F) {
                ...
                for (int k1 = k - i1; k1 <= k + i1; k1++) {
                    for (int l1 = i - i1; l1 <= i + i1; l1++) {
                        ...
                        boolean check = Hexbyte.getInstance().moduleManagment.getModule(WorldFeatures.class).isModuleState() && WorldFeatures.snow.value ? true : ((biome.canRain() || biome.getEnableSnow()));
                        if (check) {
                    ...
                    for (int l1 = i - i1; l1 <= i + i1; l1++) {
                        ...
                        if (biome.canRain() || biome.getEnableSnow()) {
                            ...
                            if (k2 != l2) {
                                this.random.setSeed((l1 * l1 * 3121 + l1 * 45238971 ^ k1 * k1 * 418711 + k1 * 13761));
                                blockpos$mutableblockpos.setPos(l1, k2, k1);
                                float f1 = biome.getTemperature((BlockPos) blockpos$mutableblockpos);
    ...
    public void displayItemActivation(ItemStack stack) {
        if (Hexbyte.getInstance().moduleManagment.getModule(NoRenderOverlay.class).isModuleState() && NoRenderOverlay.antiTotem.value) {
            return;
        }
