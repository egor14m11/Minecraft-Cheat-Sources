...
import ua.apraxia.eventapi.events.impl.player.EventRenderModelEntity;
import ua.apraxia.eventapi.events.impl.render.EventRenderPlayer;
import ua.apraxia.eventapi.events.impl.render.EventRenderPlayerName;
...
import ua.apraxia.modules.impl.render.NameTags;
...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        if (flag || flag1) {
            ...
            EventRenderModelEntity eventPre = new EventRenderModelEntity(entitylivingbaseIn,
                    EventRenderModelEntity.Type.PRE);
            ...
            if (entitylivingbaseIn instanceof EntityPlayer) {
                EventRenderPlayer erp = new EventRenderPlayer((EntityPlayer) entitylivingbaseIn, () -> {
                    this.mainModel.render(entitylivingbaseIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw,
                            headPitch, scaleFactor);
                    this.renderLayers(entitylivingbaseIn, limbSwing, limbSwingAmount, partialTicks, ageInTicks,
                            netHeadYaw, headPitch, scaleFactor);
                });
                EventManager.call(erp);
            }
            EventRenderModelEntity eventPost = new EventRenderModelEntity(entitylivingbaseIn,
                    EventRenderModelEntity.Type.POST);
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (Hexbyte.getInstance().moduleManagment.getModule(NameTags.class).isModuleState()) {
            return;
        }
