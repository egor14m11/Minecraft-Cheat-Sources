...
import ua.apraxia.modules.impl.render.ItemAnimations;
import ua.apraxia.modules.impl.world.NoRenderOverlay;
...
import static ua.apraxia.modules.impl.render.ItemAnimations.*;
...
public class ItemRenderer
{
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide hand, ItemStack stack) {
        EventViewModel event = new EventViewModel(hand);
        EventManager.call(event);
    ...
    public void renderItemInFirstPerson(AbstractClientPlayer player, float p_187457_2_, float p_187457_3_, EnumHand hand, float p_187457_5_, ItemStack stack, float p_187457_7_)
    {
        ...
        {
            AbstractClientPlayer abstractclientplayer = this.mc.player;
            float f1 = abstractclientplayer.getSwingProgress(mc.getRenderPartialTicks());
            ...
            else if (stack.getItem() instanceof ItemMap)
            {
                ...
                if (player.isHandActive() && player.getItemInUseCount() > 0 && player.getActiveHand() == hand) {
                    ...
                    float f5 = 0.2F * MathHelper.sin(MathHelper.sqrt(p_187457_5_) * 6.2831855F);
                    ...
                    f4 = this.mc.player.getSwingProgress(p_187457_2_);
                  ...
                  //  EntityLivingBase target = Aura.target;
                    if (Hexbyte.getInstance().moduleManagment.getModule(ItemAnimations.class).isModuleState() && enumhandside != EnumHandSide.LEFT) {
                        if (anim.is("Default")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            float var5 = MathHelper.sin(MathHelper.sqrt(f4) * 3.1415927f);
                            GlStateManager.rotate(var5 * -70, var5 * 70, 0.0f, var5 * -90);
                        } else if(anim.is("Block")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            this.transformFirstPersonItem(f3 / 10.0F, f4);
                            this.translate();
                        } else if(anim.is("Swing")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            ...
                            GlStateManager.rotate(23, 0, 1, 0);
                            GlStateManager.rotate(-90, 1, 0, 0);
                            GlStateManager.rotate(40, 0, 0, 0);
                        } else if (anim.is("Fap")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            ...
                            GlStateManager.rotate(this.mc.player.isSwingInProgress ? (float) (-alpha) / swingSpeed.value : 0.0F, 1.0F, -0.0F, 1.0F);
                            GlStateManager.translate(0.0, 0.0, 0.5);
                        } else if (anim.is("Wrap")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            this.transformFirstPersonItem(0.0F, 0.0F);
                            this.translate();
                            GlStateManager.rotate(f5 * ItemAnimations.wrapSpeed.value * 50, 1.0F, 0.0F, 0.0F);
                        } else if (anim.is("Spin")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            GlStateManager.rotate((float) (System.currentTimeMillis() / 16L * (long) ((int) ItemAnimations.spinSpeed.value) % 360L), 0.0F, 0.0F, -0.1F);
                            this.transformFirstPersonItem(0.0F, 0.0F);
                            this.translate();
                        } else if (anim.is("Жопа")) {
                            this.transformSideFirstPerson(enumhandside, 0);
                            this.transformFirstPersonItem(0, 0);
                            translate3();
                            float var3 = MathHelper.sin(f4 *f4 * 3.1415927f);
                            float var4 = MathHelper.sin(MathHelper.sqrt(f4) * 3.1415927f);
                            GlStateManager.rotate(var4 * -70, var4 * 40, 0.0f, 0);
                            GlStateManager.rotate(40, -30, 0.0f, 0);
                        } else if (anim.is("None")) {
                            this.transformSideFirstPerson(enumhandside, 0);
    ...
    public void renderOverlays(float partialTicks)
    {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (!Hexbyte.getInstance().moduleManagment.getModule(NoRenderOverlay.class).isModuleState()  && !NoRenderOverlay.noFire.value) {
