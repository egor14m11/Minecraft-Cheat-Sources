...
import ua.apraxia.eventapi.events.impl.input.EventInputKey;
...
import ua.apraxia.modules.impl.other.ChatHistory;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public Hexbyte main = new Hexbyte();
    /**
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof GuiMainMenu || guiScreenIn instanceof GuiMultiplayer)
        {
            ...
            this.ingameGUI.getChatGUI().clearChatMessages(!Hexbyte.getInstance().moduleManagment.getModule(ChatHistory.class).isModuleState());
        }
