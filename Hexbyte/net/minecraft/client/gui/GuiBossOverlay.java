...
import ua.apraxia.eventapi.events.impl.render.EventBossBar;
...
public class GuiBossOverlay extends Gui
{
    ...
    public void renderBossHealth() {
        if (Hexbyte.getInstance().moduleManagment.getModule(NoRenderOverlay.class).isModuleState() && NoRenderOverlay.noBossBar.value) {
            return;
        }
