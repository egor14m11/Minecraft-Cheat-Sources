...
import ua.apraxia.modules.impl.render.Crosshair;
...
import ua.apraxia.modules.impl.render.ScoreboardFeatures;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (scoreobjective1 != null) {
            ...
            EventManager.call(e);
            if (!(Hexbyte.getInstance().moduleManagment.getModule(ScoreboardFeatures.class).isModuleState() && ScoreboardFeatures.noScore.value)) {
    ...
    private void renderAttackIndicator(float partialTicks, ScaledResolution p_184045_2_)
    {
        ...
        if (gamesettings.thirdPersonView == 0)
        {
            ...
            else
            {
                ...
                GlStateManager.enableAlpha();
                if (!Hexbyte.getInstance().moduleManagment.getModule(Crosshair.class).isModuleState()) {
