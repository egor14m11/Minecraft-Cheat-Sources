...
import ua.apraxia.modules.impl.other.ItemScroller;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
            ...
            {
                if (Hexbyte.getInstance().moduleManagment.getModule(ItemScroller.class).isModuleState() && Mouse.isButtonDown(0) && Keyboard.isKeyDown(this.mc.gameSettings.keyBindSneak.getKeyCode()) && this.mc.currentScreen != null && this.timerHelper.hasReached(ItemScroller.scrollerDelay.value)) {
