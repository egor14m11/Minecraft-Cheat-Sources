...
public class GuiClientTextField extends Gui {
    private final int id;
    private int id1;
    private final FontRenderer fontRendererInstance;
    private FontRenderer fontRendererInstance1;
    ...
    public GuiClientTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RoundedUtility.drawRound((float)this.xPosition, (float)this.yPosition, (float)this.width, (float)this.height, 3.0F, new Color(0, 0, 0, 121));
                RenderUtility.drawBlur(() -> RoundedUtility.drawRound((float)this.xPosition, (float)this.yPosition, (float)this.width, (float)this.height, 3.0F, new Color(0, 0, 0, 121)), 15);
            }
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) Fonts.medium16.drawString(s1, (float)l, (float)i1 + 2.0F, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                int var10000 = (int)Fonts.medium16.drawString(s.substring(j), (float)j1 +2, (float)i1 +2, i);
            }

            if (flag1 && !flag2) {
                Fonts.medium16.drawString("_", (float)k1 + 2.0F, (float)i1 + 2.0F, i);
            }

            if (k != j) {
                int l1 = l + Fonts.medium16.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Fonts.medium16.getFontHeight());
            }
        }
