...
public class Gui
{
    ...
    public static void drawGradientRect1(float f8, float sY, double d, double e, int startColor, int endColor)
    {
        ...
        bufferbuilder.pos((double)d, (double)sY, (double)0).color(f1, f2, f3, f).endVertex();
        bufferbuilder.pos((double)f8, (double)sY, (double)0).color(f5, f6, f7, f4).endVertex();
        bufferbuilder.pos((double)f8, (double)e, (double)0).color(f5, f6, f7, f4).endVertex();
        bufferbuilder.pos((double)d, (double)e, (double)0).color(f1, f2, f3, f).endVertex();
        tessellator.draw();
