...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    {
        Hexbyte.getInstance().draggable.getScreen().click(mouseX, mouseY);
    ...
    public void getSentHistory(int msgPos) {
        ...
        protected void mouseReleased(int mouseX, int mouseY, int state) {
            Hexbyte.getInstance().draggable.getScreen().release();
    ...
    {
        Hexbyte.getInstance().draggable.getScreen().draw(mouseX, mouseY);
