...
public class Wings extends Cheats {
    ...
    public Wings() {
        ...
        Summer.INSTANCE.settingsManager.Property(colorRed = new Setting("Red", this, 249, 0, 255, true, () -> !rainbowWings.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(colorGreen = new Setting("Green", this, 255, 0, 255, true,() -> !rainbowWings.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(colorBlue = new Setting("Blue", this, 0, 0, 255, true, () -> !rainbowWings.getValBoolean()));
