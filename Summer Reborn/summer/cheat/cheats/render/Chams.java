...
public class Chams extends Cheats {
    ...
    public Chams() {
        ...
        Summer.INSTANCE.settingsManager.Property(hue = new Setting("Hue", this, 0.8F, 0F, 1.0F, false, () -> !rainbowChams.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(alpha = new Setting("Alpha", this, 0.3F, 0.11F, 1.0F, false));
        Summer.INSTANCE.settingsManager.Property(hueWalls = new Setting("Hue Walls", this, 0.3F, 0F, 1.0F, false, () -> !rainbowChams.getValBoolean()));
