...
public class CustomGlint extends Cheats {
    ...
    public CustomGlint() {
        ...
        Summer.INSTANCE.settingsManager.Property(armorHue = new Setting("Armor Hue", this, 0.8F, 0F, 1.0F, false, () -> !rainbow.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(itemHue = new Setting("Item Hue", this, 0.8F, 0F, 1.0F, false, () -> !rainbow.getValBoolean()));
    }
