    ...
    public void onRender2D(EventRender2D e) {
        if (!mc.gameSettings.showDebugInfo) {
            ...
            if (name.equalsIgnoreCase("Logo")) {
                ...
                if (timer.hasReached(4300)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fummer", 4, 4, c.getRGB());
                    timer.reset();
                } else if (timer.hasReached(2800)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fummer", 4, 4, c.getRGB());
                } else if (timer.hasReached(2400)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fumme_", 4, 4, c.getRGB());
                } else if (timer.hasReached(2000)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fumm_", 4, 4, c.getRGB());
                } else if (timer.hasReached(1600)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fum_", 4, 4, c.getRGB());
                } else if (timer.hasReached(1200)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fu_", 4, 4, c.getRGB());
                } else if (timer.hasReached(900)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7f_", 4, 4, c.getRGB());
                } else if (timer.hasReached(480)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fu_", 4, 4, c.getRGB());
                } else if (timer.hasReached(360)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fum_", 4, 4, c.getRGB());
                } else if (timer.hasReached(240)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fumm_", 4, 4, c.getRGB());
                } else if (timer.hasReached(120)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fumme_", 4, 4, c.getRGB());
                } else if (timer.hasReached(0)) {
                    Summer.INSTANCE.fontManager.getFont(font + " 30").drawStringWithShadow("S\u00A7fummer", 4, 4, c.getRGB());
                }
            }
            ...
            for (Cheats m : enabledMods) {
                ...
                if (CheatManager.getInstance(HUD.class).isToggled()) {
                    ...
                    int astolfo = getGradientOffset(new Color(191, 64, 99), new Color(0, 133, 152), (Math.abs(((System.currentTimeMillis()) / 16)) / 60D) + (yText / ((Summer.INSTANCE.fontManager.getFont(font + " 18").getHeight(m.getDisplayName()) + 135)))).getRGB();
//                    int red = getGradientOffset(new Color(255, 0, 0), new Color(0, 0, 0), (Math.abs(((System.currentTimeMillis()) / 8)) / 120D) + (yText / ((SummerClient.instance.fm.getFont(font + " 18").getHeight(m.getDisplayName()) + 135)))).getRGB();
                    if (rainbow.getValBoolean() && customFont.getValBoolean() && !m.getDisplayName().equals("")) {
                    ...
                    if (style.equalsIgnoreCase("Summer") && !rainbow.getValBoolean() && customFont.getValBoolean() && !m.getDisplayName().equals("")) {
                        if (background.getValBoolean()) {
                            Gui.drawRect(scaledRes.getScaledWidth() - 1, yText - 3, scaledRes.getScaledWidth(),
                    ...
                    if (style.equalsIgnoreCase("Astolfo") && !rainbow.getValBoolean() && customFont.getValBoolean() && !m.getDisplayName().equals("")) {
                        if (background.getValBoolean()) {
                            Gui.drawRect(scaledRes.getScaledWidth() - 1, yText - 3, scaledRes.getScaledWidth(),
                    ...
                    if (style.equalsIgnoreCase("Summer") && !customFont.getValBoolean() && !m.getDisplayName().equals("")) {
                    ...
                    if (style.equalsIgnoreCase("Astolfo") && !customFont.getValBoolean() && !rainbow.getValBoolean() && !m.getDisplayName().equals("")) {
                        Gui.drawRect(scaledRes.getScaledWidth() - 1, yText - 3, scaledRes.getScaledWidth(),
                                yText + Minecraft.fontRendererObj.FONT_HEIGHT + 1, astolfo);

                        Minecraft.fontRendererObj.drawStringWithShadow(m.getDisplayName(), xTextDefault + m.getTransition() + 9.8F - 3, yText, astolfo);
                    }
                    yText += 12;
                    h -= 20.0F;
                }
