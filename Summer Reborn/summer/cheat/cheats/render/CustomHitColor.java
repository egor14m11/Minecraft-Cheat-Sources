...
public class CustomHitColor extends Cheats {
    ...
    public CustomHitColor() {
        ...
        Summer.INSTANCE.settingsManager.Property(damageHue = new Setting("Damage Hue", this, 0.8F, 0F, 1.0F, false, () -> !rainbowHits.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(damageAlpha = new Setting("Damage Alpha", this, 0.3F, 0.3F, 0.7F, false, () -> !rainbowHits.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(damageSaturation = new Setting("Damage Sat", this, 1.0F, 0F, 1.0F, false, () -> !rainbowHits.getValBoolean()));
