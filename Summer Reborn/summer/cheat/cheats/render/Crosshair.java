...
public class Crosshair extends Cheats {
    ...
    public Crosshair() {
        ...
        Summer.INSTANCE.settingsManager.Property(colorRed = new Setting("Red", this, 249, 0, 255, true, () -> !rainbowCrosshair.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(colorGreen = new Setting("Green", this, 255, 0, 255, true, () -> !rainbowCrosshair.getValBoolean()));
        Summer.INSTANCE.settingsManager.Property(colorBlue = new Setting("Blue", this, 0, 0, 255, true, () -> !rainbowCrosshair.getValBoolean()));
