...
public class Keybind extends Component
{
    ...
    public void renderComponent() {
        ...
        GL11.glPushMatrix();
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.binding ? "Waiting key..." : ("BIND: " + Keyboard.getKeyName(this.parent.mod.getKey())), (float)(this.parent.parent.getX() + 7), (float)(this.parent.parent.getY() + this.offset + 2), 11393254);
        GL11.glPopMatrix();
    }
