...
public class Slider extends Component
{
    ...
    public void renderComponent() {
        ...
        GL11.glPushMatrix();
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.set.getName() + ": " + this.set.getValDouble(), (float)(this.parent.parent.getX() + 15), (float)(this.parent.parent.getY() + this.offset + 2), 11393254);
        GL11.glPopMatrix();
    }
    ...
    public void updateComponent(final int mouseX, final int mouseY) {
        ...
        this.renderWidth = 100.0 * (this.set.getValDouble() - min) / (max - min);
        if (this.dragging) {
            if (diff == 0.0) {
