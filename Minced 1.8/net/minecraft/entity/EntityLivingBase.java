...
import Celestial.module.impl.Render.SwingAnimations;
...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if (Smertnix.instance.featureManager.getFeature(SwingAnimations.class).isEnabled()) {
    ...
    public boolean canBePushed() {
        if (Smertnix.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.players.getCurrentValue() && this instanceof EntityPlayerSP) {
            return false;
        }
