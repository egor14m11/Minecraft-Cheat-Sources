...
import Celestial.module.impl.Combat.HitBox;
...
public abstract class Entity implements ICommandSender {
    ...
    public void func_191958_b(float p_191958_1_, float p_191958_2_, float p_191958_3_, float p_191958_4_) {
        ...
        if (f >= 1.0E-4F) {
            ...
            if(Smertnix.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null && this instanceof EntityPlayerSP && KillAura.silentMove.getCurrentValue() && Minecraft.getMinecraft().player.getDistanceToEntity(KillAura.target) > 1) {
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        if (Smertnix.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getCurrentValue()) {
            return false;
        } else {
    ...
    public float getCollisionBorderSize() {
        ...
        if (Smertnix.instance.featureManager.getFeature(HitBox.class).isEnabled()) {
