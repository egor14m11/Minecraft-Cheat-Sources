...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    {
        List<T> list = this.theEntity.world.<T>getEntitiesWithinAABB(this.classToAvoid, this.theEntity.getEntityBoundingBox().expand((double)this.avoidDistance, 3.0D, (double)this.avoidDistance), Predicates.and((Predicate<? super T>) EntitySelectors.CAN_AI_TARGET, (Predicate<? super T>) this.canBeSeenSelector, this.avoidTargetSelector));
