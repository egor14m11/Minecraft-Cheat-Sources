package Celestial.wavecapes.renderlayers;

import Celestial.module.impl.Render.CustomModel;
import Celestial.wavecapes.CapeHolder;
import Celestial.wavecapes.stim.StickSimulation;
import Celestial.wavecapes.util.Mth;
...
public class CustomCapeRenderLayer implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer abstractClientPlayer, float paramFloat1, float paramFloat2, float deltaTick,
        ...
        if (Smertnix.instance.featureManager.getFeature((CustomModel.class)).getState()) {
            return;
        }
