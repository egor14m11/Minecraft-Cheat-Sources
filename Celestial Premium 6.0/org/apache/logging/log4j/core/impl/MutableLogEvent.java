...
ParameterVisitable {
    ...
    protected Object writeReplace() {
        return new Log4jLogEvent.LogEventProxy((LogEvent)this, this.includeLocation);
    }
    ...
    public Log4jLogEvent createMemento() {
        return Log4jLogEvent.deserialize(Log4jLogEvent.serialize((LogEvent)this, (boolean)this.includeLocation));
    }
