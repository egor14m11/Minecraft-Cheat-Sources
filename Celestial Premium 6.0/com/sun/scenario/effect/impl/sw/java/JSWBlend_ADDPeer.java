    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i = 0; i < 0 + n12; ++i) {
            ...
            for (int j = 0; j < 0 + n11; ++j) {
                ...
                float f30 = f22;
                float f31 = f23;
                float f32 = f24 * f31 + f28 * f27 - f31 * f27;
                float f33 = f25 * f31 + f29 * f27 - f31 * f27;
                float f34 = f26 * f31 + f30 * f27 - f31 * f27;
                float f35 = f27 * f31 + f31 * f27 - f31 * f27;
                float f36 = 0.0f;
                float f37 = f32 > f36 ? f32 : f36;
                float f38 = f33 > f36 ? f33 : f36;
                float f39 = f34 > f36 ? f34 : f36;
                float f40 = f35 > f36 ? f35 : f36;
                f32 = f37;
                f33 = f38;
                f34 = f39;
                f35 = f40;
                float f41 = f24 + f28 - f32;
                ...
                arrn3[n14 + j] = (int)(f45 * 255.0f) << 16 | (int)(f46 * 255.0f) << 8 | (int)(f47 * 255.0f) << 0 | (int)(f48 * 255.0f) << 24;
                f9 += f2;
                f10 += f4;
            }
            f6 += f3;
