    ...
    public ImageData filter(Effect effect, RenderState renderState, BaseTransform baseTransform, Rectangle rectangle, ImageData ... arrimageData) {
        ...
        for (int i = 0; i < 0 + n12; ++i) {
            ...
            for (int j = 0; j < 0 + n11; ++j) {
                ...
                float f30 = f22;
                float f31 = f23;
                float f32 = f24 * (f28 + 1.0f - f31) + f28 * (1.0f - f27);
                float f33 = f25 * (f29 + 1.0f - f31) + f29 * (1.0f - f27);
                float f34 = f26 * (f30 + 1.0f - f31) + f30 * (1.0f - f27);
                float f35 = f27 * (f31 + 1.0f - f31) + f31 * (1.0f - f27);
                float f36 = f32;
                float f37 = f33;
                float f38 = f34;
                float f39 = f35;
                ...
                arrn3[n14 + j] = (int)(f36 * 255.0f) << 16 | (int)(f37 * 255.0f) << 8 | (int)(f38 * 255.0f) << 0 | (int)(f39 * 255.0f) << 24;
                f9 += f2;
                f10 += f4;
            }
            f6 += f3;
