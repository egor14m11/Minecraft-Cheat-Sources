...
public class animbackground {
    ...
    public animbackground(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader(animbackground.class.getResourceAsStream("/passthrough.vsh"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(animbackground.class.getResourceAsStream(fragmentShaderLocation), GL_FRAGMENT_SHADER));
