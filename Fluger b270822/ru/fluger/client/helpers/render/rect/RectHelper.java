    ...
    public static void renderShadowHorizontal(float lineWidth, double startAlpha, int size, double posY, double posX1, double posX2, boolean up, boolean edges, float red, float green, float blue) {
        ...
        if (!up) {
            for (double y = 0.0; y < (double)size; y += 0.5) {
                GL11.glColor4d((double)red, (double)green, (double)blue, (double)alpha);
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(posX1 - (edges ? y : 0.0)), (double)(posY + y));
                GL11.glVertex2d((double)(posX2 + (edges ? y : 0.0)), (double)(posY + y));
                GL11.glEnd();
            ...
            for (double y = 0.5; y < (double)size; y += 0.5) {
                GL11.glColor4d((double)red, (double)green, (double)blue, (double)alpha);
                GL11.glBegin((int)1);
                GL11.glVertex2d((double)(posX1 - (edges ? y : 0.0) - 0.5), (double)(posY - y));
                GL11.glVertex2d((double)(posX2 + (edges ? y : 0.0) - 0.5), (double)(posY - y));
                GL11.glEnd();
                alpha = startAlpha - y / (double)size;
            }
        }
