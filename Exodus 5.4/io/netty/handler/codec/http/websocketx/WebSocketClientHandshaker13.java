...
extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        if ((n = uRI.getPort()) == -1) {
            n = "wss".equals(uRI.getScheme()) ? 443 : 80;
        }
        ...
        httpHeaders.add("Upgrade", (Object)"WebSocket".toLowerCase()).add("Connection", (Object)"Upgrade").add("Sec-WebSocket-Key", (Object)string2).add("Host", (Object)(uRI.getHost() + ':' + n));
