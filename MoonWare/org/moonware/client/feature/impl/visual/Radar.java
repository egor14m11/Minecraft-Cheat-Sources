...
public class Radar extends Feature {
    ...
    public void onRender2D(EventRender2D event) {
        ...
        double playerPosX = Minecraft.player.posX;
        double playerPosZ = Minecraft.player.posZ;
        ...
        RenderHelper.drawImage(new Namespaced("moonware/skeet.png"), xOffset + 3.5F, yOffset + 3.5F, sizeRect - 7, 1, Color.WHITE);
        for (EntityPlayer entityPlayer : Minecraft.world.playerEntities) {
            ...
            int color = (Minecraft.player.canEntityBeSeen(entityPlayer) ? new Color(255, 0, 0).getRGB() : new Color(255, 255, 0).getRGB());
            float cos = (float) Math.cos(Minecraft.player.rotationYaw * 0.017453292);
            float sin = (float) Math.sin(Minecraft.player.rotationYaw * 0.017453292);
