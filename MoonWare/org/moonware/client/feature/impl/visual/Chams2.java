...
public class Chams2
    ...
    private static Namespaced space;
    ...
    public Chams2() {
        ...
        clientColor = new BooleanSetting("Client Colored", false, () -> chamsMode.currentMode.equals("Fill"));
        chamsAlpha = new NumberSetting("Chams Aplha", 0.5f, 0.2f, 1.0f, 0.1f, () -> chamsMode.currentMode.equals("Fill"));
        colorChams = new ColorSetting("Chams Color", new Color(0xFFFFFF).getRGB(), () -> chamsMode.currentMode.equals("Fill") && !clientColor.getCurrentValue());
        cosmoSpeed = new NumberSetting("Cosmo Speed", 1.0f, 1.0f, 10.0f, 1.0f, () -> chamsMode.currentMode.equals("Cosmo"));
    ...
    public static void shaderAttach(Entity entity) {
        ...
        Minecraft.getTextureManager().bindTexture(space);
    }
    ...
    static {
        space = new Namespaced("moonware/space.jpg");
