...
public class StencilUtil {
    ...
    public static void setupFBO(Framebuffer framebuffer) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, Minecraft.width, Minecraft.height);
    ...
    public static void initStencilToWrite() {
        ...
        checkSetupFBO(Minecraft.getFramebuffer());
