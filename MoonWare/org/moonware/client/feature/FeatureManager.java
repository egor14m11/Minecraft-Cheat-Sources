...
import org.moonware.client.feature.impl.hud.*;
import org.moonware.client.feature.impl.misc.*;
import org.moonware.client.feature.impl.movement.*;
import org.moonware.client.feature.impl.player.*;
...
public class FeatureManager {
    ...
    public FeatureManager() {
        features.add(new AutoTRAccept());
        features.add(new BreadCrumbs());
        features.add(new PenisESP());
        features.add(new GlowESP());
        //features.add(new ApJumpCircles());
        //features.add(new AutoTotems());
        //features.add(new FakePlayer());
        //features.add(new JumpCircle());
        //features.add(new EntityEsp2());
        //features.add(new FeatureList());
        features.add(new ChinaHatTwo());
        features.add(new ChinaHat2());
        //features.add(new MatrixBoostFly());
        features.add(new KillAura());
        features.add(new DamageSpeed());
        //features.add(new PotJumpCircles());
        //features.add(new ChinaHatTwo());
        features.add(new NameTagi());
        features.add(new StaffAlert());
        features.add(new GAppleCooldown());
        //features.add(new MatrixBoostFly());
        //features.add(new ChinaHat2());
        //features.add(new GlowESP());
        //features.add(new ArrayList2());
        //features.add(new SessionStats());
        features.add(new SessionStaticks());
        //features.add(new AttackAura());
        //features.add(new EntityESP());
        //features.add(new PotJumpCircles());
        //features.add(new Radar());
        //features.add(new PlayerTracker());
        features.add(new AntiWaterCollide());
        //features.add(new EntityEsp2());
        //features.add(new NewFunc());
        /* HUD */
        ...
        features.add(new PearlDebug());
        features.add(new CPUStabilization());
        features.add(new CustomChat());
        //features.add(new Indicators());
        features.add(new WeatherColor());
        ...
        features.add(new MatrixExploitJumpFly());
        ...
        features.add(new DeleteArmorStands());
        features.add(new BlockESP());
        //features.add(new NameTags());
        features.add(new DamageParticles2());
    ...
    public List<Feature> getFeaturesForCategory(Type category) {
        List<Feature> featureList = new java.util.ArrayList<>();
