package org.moonware.client.helpers.render.cosmetic.impl;
...
import org.moonware.client.feature.impl.visual.Cosmetics;
...
public class DragonWing extends ModelBase {
    ...
    public static void render(EntityPlayer player, float partialTicks) {
        try {
            ...
            GL11.glPushMatrix();
            // wingScale
            GL11.glScaled(Cosmetics.scale.getCurrentValue(), Cosmetics.scale.getNumberValue(), Cosmetics.scale.getCurrentValue());
            ...
            Minecraft.getTextureManager().bindTexture(new Namespaced("moonware/wings/gray.png"));
            for (int i = 0; i < 2; i++) {
