...
import org.moonware.client.helpers.Utils.misc.FileUtils;
...
public class ShaderUtil implements Utils {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradient":
                    ...
                    break;
                default:
                    fragmentShaderID = createShader(Minecraft.getResourceManager().getResource(new Namespaced(fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
                    break;
            }
            glAttachShader(program, fragmentShaderID);

            int vertexShaderID = createShader(Minecraft.getResourceManager().getResource(new Namespaced(vertexShaderLoc)).getInputStream(), GL_VERTEX_SHADER);
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "moonware/shaders/vertex.vsh");
    }
    ...
    public static void drawQuads(float x, float y, float width, float height) {
        if (Minecraft.gameSettings.ofFastRender) return;
        glBegin(GL_QUADS);
        glTexCoord2f(0, 0);
        glVertex2f(x, y);
        glTexCoord2f(0, 1);
