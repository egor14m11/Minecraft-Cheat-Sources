...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("moonware/shaders/roundrectoutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("moonware/shaders/roundrecttextured.frag");
    ...
    public static void drawGradientHorizontal2(float x, float y, float width, float height, float radius, Color left, Color right) {
        drawGradientRound(x, y, width - x, height, radius, left, left, right, right);
    }
    public static void drawVerticalGradientOutlinedRoundedRect(float x, float y, float width, float height, float radius,float outlineTickness, Color top, Color bottom) {
    ...
    public static void drawRound(float x, float y, float width, float height, float radius, boolean blur, Color color) {
        ...
        roundedShader.setUniformi("blur", blur ? 10 : 0);
    ...
    private static void setupRoundedRectUniforms(float x, float y, float width, float height, float radius, ShaderUtil roundedTexturedShader) {
        ...
        roundedTexturedShader.setUniformf("location", x * sr.getScaleFactor(),
                (Minecraft.height - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));
