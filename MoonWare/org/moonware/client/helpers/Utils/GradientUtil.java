...
public class GradientUtil {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("moonware/shaders/gradientmask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("moonware/shaders/gradient.frag");
    ...
    public static void drawGradient(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight) {
        ...
        gradientShader.init();
        gradientShader.setUniformf("location", x * sr.getScaleFactor(), (Minecraft.getScaledRoundedHeight() - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));
    ...
    public static void applyGradient(float x, float y, float width, float height, float alpha, Color bottomLeft, Color topLeft, Color bottomRight, Color topRight, Runnable content) {
        ...
        gradientMaskShader.setUniformf("location", x * sr.getScaleFactor(), (Minecraft.getScaledRoundedHeight() - (height * sr.getScaleFactor())) - (y * sr.getScaleFactor()));
