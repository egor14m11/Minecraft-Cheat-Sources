...
public class ColorPickerComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public ColorPickerComponent(Component parent, ColorSetting colorSetting, int x, int y, int width, int height, Feature feature) {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        MWFont.GREYCLIFFCF_MEDIUM.get(18).drawShadow(getName(), x + 2, y + height / 2F - 5, textColor);
        MWFont.MONTSERRAT_BOLD.get(13).draw(getName(), x + 2, y + height / 2F - 3,!feature.getState() ?  new Color(0,0,0).getRGB() : -1);
        ...
        //RectHelper.drawSmoothRect(left - 14, top - 3, right, bottom + 3, colorSetting.getColorValue());
        RoundedUtil.drawRound(left - 14,top - 3, 25, 7,2,new Color(colorSetting.getColor()));
        RenderUtils2.drawBlurredShadow(left - 14,top - 3, 25, 7,9,new Color(colorSetting.getColor()));
//        if (ClickGui.glow.getBoolValue()) {
//            Color colors = new Color(colorSetting.getColorValue());
//            //(colorSetting.getColorValue() >> 24 & 0xFF) / 255.0F
//            RenderHelper2.renderBlurredShadow(new Color(colors.getRed(),colors.getGreen(),colors.getBlue(),colorSetting.getAlpha()), x + width - 3 - 24, top - 4, width - 88, height / 2.0F + 2 + 1.5f,4);
//            //RectHelper.drawGlow(left - 10, top - 6.5, right - 3, top + 10.5, colorSetting.getColorValue());
//        }
        ...
        if (isExpanded()) {
            ...
            // Draw Color Picker
            {
                ...
                RenderUtils2.drawShadow(4,2,() -> RoundedUtil.drawRound(cpLeft + 2, cpTop + 2, COLOR_PICKER_HEIGHT - 5 - 2.5F, COLOR_PICKER_HEIGHT - 7,5, new Color(-1)));
                StencilUtil.initStencilToWrite();
                RoundedUtil.drawRound(cpLeft + 2, cpTop + 2, COLOR_PICKER_HEIGHT - 5 - 2.5F, COLOR_PICKER_HEIGHT - 7,5, new Color(0x000000));
            ...
            // Hue Slider
            {
                ...
                for (int i = 0; i < times; i++) {
                    ...
                    if (last)
                        size--;
                    Helper.gui.drawGradientRect(sLeft + 0.5F, sY, sRight - 0.5F,
                            sY + size,
            ...
            // Alpha Slider
            {
                ...
                Helper.gui.drawGradientRect(sLeft + 0.5F, sTop + 0.5F, sRight - 0.5F,
                        sBottom - 0.5F,
    ...
    public int getHeightWithExpand() {
        this.height = Interpolator.linear(this.height, getHeight() + COLOR_PICKER_HEIGHT, 2f/10);
        return getHeight() + COLOR_PICKER_HEIGHT;
    }

    @Override
    public int getHeight() {
        this.height = Interpolator.linear(this.height, 18, 2f/10);
