...
public class ColorPickerComponent extends ExpandableComponent implements PropertyComponent {
    ...
    public void drawComponent(ScaledResolution scaledResolution, int mouseX, int mouseY) {
        ...
        MWFont.GREYCLIFFCF_MEDIUM.get(16).drawShadow(getName(), x + 2, y + height / 2F - 5, textColor);
        MWFont.GREYCLIFFCF_MEDIUM.get(16).drawShadow(getName(), x + 2, y + height / 2F - 5,-1);
        float left = getX() + width - 13;
        float top = getY() + height / 2.0F - 2;
        float right = getX() + width - 2;
        float bottom = getY() + height / 2.0F + 2;
    ...
    public int getHeightWithExpand() {
        this.height = Interpolator.linear(this.height, getHeight() + COLOR_PICKER_HEIGHT + 3, 2f/10);
        return getHeight() + COLOR_PICKER_HEIGHT;
    }

    @Override
    public int getHeight() {
        this.height = Interpolator.linear(this.height, 21, 2f/10);
