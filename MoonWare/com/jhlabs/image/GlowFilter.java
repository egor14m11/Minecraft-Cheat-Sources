...
public class GlowFilter extends GaussianFilter {
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
		...
		if ( radius > 0 ) {
            GaussianFilter.convolveAndTranspose(kernel, inPixels, outPixels, width, height, alpha, alpha && premultiplyAlpha, false, ConvolveFilter.CLAMP_EDGES);
            GaussianFilter.convolveAndTranspose(kernel, outPixels, inPixels, height, width, alpha, false, alpha && premultiplyAlpha, ConvolveFilter.CLAMP_EDGES);
		}
