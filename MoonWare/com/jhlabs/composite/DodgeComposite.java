    ...
    static class Context extends RGBComposite.RGBCompositeContext {
        ...
        public void composeRGB( int[] src, int[] dst, float alpha ) {
            ...
            for ( int i = 0; i < w; i += 4 ) {
                ...
                dor = RGBComposite.RGBCompositeContext.clamp((sr << 8) / (256-dir));
                dog = RGBComposite.RGBCompositeContext.clamp((sg << 8) / (256-dig));
                dob = RGBComposite.RGBCompositeContext.clamp((sb << 8) / (256-dib));
