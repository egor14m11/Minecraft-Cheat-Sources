...
public class MovementFall extends Movement {
    ...
    public double calculateCost(CalculationContext context) {
        ...
        if (result.y != dest.y) {
            return ActionCosts.COST_INF; // doesn't apply to us, this position is a descend not a fall
        }
        return result.cost;
    }
    ...
    public MovementState updateState(MovementState state) {
        ...
        if (targetRotation == null) {
            ...
            state.setTarget(new MovementState.MovementTarget(RotationUtils.calcRotationFromVec3d(ctx.playerHead(), destCenterOffset, ctx.playerRotations()), false));
        }
        return state;
    }
