...
public class WaypointsCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        BiFunction<IWaypoint, Action, Component> toComponent = (waypoint, _action) -> {
            ...
            Component tagComponent = new TextComponent(waypoint.getTag().name() + " ");
            tagComponent.getStyle().setColor(Formatting.GRAY);
            String name = waypoint.getName();
            Component nameComponent = new TextComponent(!name.isEmpty() ? name : "<empty>");
            nameComponent.getStyle().setColor(!name.isEmpty() ? Formatting.GRAY : Formatting.DARK_GRAY);
            Component timestamp = new TextComponent(" @ " + new Date(waypoint.getCreationTimestamp()));
        ...
        if (action == Action.LIST) {
            ...
            Component component = new TextComponent("Waypoint added: ");
            ...
            if (waypoint == null) {
                ...
                if (action == Action.INFO) {
                    ...
                    Component deleteComponent = new TextComponent("Click to delete this waypoint");
                    ...
                    Component goalComponent = new TextComponent("Click to set goal to this waypoint");
                    ...
                    Component backComponent = new TextComponent("Click to return to the waypoints list");
