...
public class SelCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        if (action == Action.POS1 || action == Action.POS2) {
            ...
            BetterBlockPos playerPos = Minecraft.getRenderViewEntity() != null ? BetterBlockPos.from(new BlockPos(Minecraft.getRenderViewEntity())) : ctx.playerFeet();
    ...
    enum TransformTarget {
        ...
        public static TransformTarget getByName(String name) {
            for (TransformTarget target : values()) {
