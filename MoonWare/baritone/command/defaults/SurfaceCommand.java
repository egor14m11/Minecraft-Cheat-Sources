...
public class SurfaceCommand extends Command {
    ...
    public void execute(String label, IArgConsumer args) throws CommandException {
        ...
        int surfaceLevel = baritone.getPlayerContext().world().getSeaLevel();
        int worldHeight = baritone.getPlayerContext().world().getActualHeight();
        ...
        if (playerPos.getY() > surfaceLevel && Minecraft.world.getBlockState(playerPos.up()).getBlock() instanceof BlockAir) {
        ...
        for (int currentIteratedY = startingYPos; currentIteratedY < worldHeight; currentIteratedY++) {
            ...
            if (!(Minecraft.world.getBlockState(newPos).getBlock() instanceof BlockAir) && newPos.getY() > playerPos.getY()) {
