...
public final class RotationUtils {
     ...
     */
    private static final Vec3d[] BLOCK_SIDE_MULTIPLIERS = {
    ...
    private static Rotation calcRotationFromVec3d(Vec3d orig, Vec3d dest) {
        ...
        double yaw = MathHelper.atan2(delta[0], -delta[2]) + MWUtils.randomFloat(-1, 1);
        double dist = Math.sqrt(delta[0] * delta[0] + delta[2] * delta[2]);
        double pitch = MathHelper.atan2(delta[1], dist) + MWUtils.randomFloat(-1, 1);
        return new Rotation(
