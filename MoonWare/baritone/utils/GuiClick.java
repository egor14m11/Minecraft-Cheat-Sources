...
public class GuiClick extends Screen {
    ...
    public void draw(int mouseX, int mouseY, float partialTick) {
        ...
        if (near != null && far != null) {
            Vec3d viewerPos = new Vec3d(Minecraft.getRenderManager().viewerPosX, Minecraft.getRenderManager().viewerPosY, Minecraft.getRenderManager().viewerPosZ);
            RayTraceResult result = Minecraft.world.rayTraceBlocks(near.add(viewerPos), far.add(viewerPos), false, false, true);
        ...
        if (currentMouseOver != null) { //Catch this, or else a click into void will result in a crash
            if (button == 0) {
                if (clickStart != null && !clickStart.equals(currentMouseOver)) {
                    ...
                    Component component = new TextComponent("Selection made! For usage: " + Baritone.settings().prefix.value + "help sel");
                    component.getStyle()
    ...
    public void onRender() {
        ...
        if (currentMouseOver != null) {
            Entity e = Minecraft.getRenderViewEntity();
