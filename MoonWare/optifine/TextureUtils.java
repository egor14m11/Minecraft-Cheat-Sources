...
public class TextureUtils
{
    ...
    public static ITextureObject getTexture(Namespaced p_getTexture_0_)
    {
    ...
    public static void registerResourceListener()
    {
        ...
        if (iresourcemanager instanceof IReloadableResourceManager)
        {
            ...
            IResourceManagerReloadListener iresourcemanagerreloadlistener = new IResourceManagerReloadListener()
            {
                ...
                {
                    resourcesReloaded(resourceManager);
                }
            };
        ...
        Namespaced resourcelocation = new Namespaced("optifine/TickableTextures");
        Config.getTextureManager().loadTickableTexture(resourcelocation, itickabletextureobject);
    }

    public static Namespaced fixResourceLocation(Namespaced p_fixNamespaced_0_, String p_fixResourceLocation_1_)
    {
        if (!p_fixNamespaced_0_.getNamespace().equals("minecraft"))
        {
            return p_fixNamespaced_0_;
        }
        else
        {
            String s = p_fixNamespaced_0_.getPath();
            String s1 = fixResourcePath(s, p_fixResourceLocation_1_);

            if (s1 != s)
            {
                p_fixNamespaced_0_ = new Namespaced(p_fixNamespaced_0_.getNamespace(), s1);
            }
