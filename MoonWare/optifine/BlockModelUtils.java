...
public class BlockModelUtils
{
    ...
    {
        TextureAtlasSprite textureatlassprite = Minecraft.getTextureMapBlocks().getAtlasSprite(p_makeModelCube_0_);
    ...
    public static IBakedModel makeModel(String p_makeModel_0_, TextureAtlasSprite p_makeModel_1_, TextureAtlasSprite p_makeModel_2_)
    {
        if (p_makeModel_1_ != null && p_makeModel_2_ != null)
        {
            ...
            {
                ModelNamespaced modelresourcelocation = new ModelNamespaced(p_makeModel_0_, "normal");
