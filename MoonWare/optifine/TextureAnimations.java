...
public class TextureAnimations
{
        ...
        else
        {
            ...
            for (int i = 0; i < astring.length; ++i)
            {
                ...
                try
                {
                    ...
                    {
                        Namespaced resourcelocation1 = new Namespaced(textureanimation.getDstTex());
    ...
    public static TextureAnimation makeTextureAnimation(Properties p_makeTextureAnimation_0_, Namespaced p_makeTextureAnimation_1_)
    {
    ...
    private static byte[] loadImage(String p_loadImage_0_, int p_loadImage_1_)
    {
        ...
        try
        {
            Namespaced resourcelocation = new Namespaced(p_loadImage_0_);
            InputStream inputstream = Config.getResourceStream(resourcelocation);
