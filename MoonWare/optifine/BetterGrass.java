...
public class BetterGrass
{
    ...
    public static void update()
    {
        if (spritesLoaded)
        {
            ...
            TextureAtlasSprite textureatlassprite = Config.getTextureMap().registerSprite(new Namespaced("blocks/grass_path_side"));
    ...
    private static void loadProperties(TextureMap p_loadProperties_0_)
    {
        ...
        spriteGrass = p_loadProperties_0_.registerSprite(new Namespaced("blocks/grass_top"));
        spriteGrassSide = p_loadProperties_0_.registerSprite(new Namespaced("blocks/grass_side"));
        spriteGrassPath = p_loadProperties_0_.registerSprite(new Namespaced("blocks/grass_path_top"));
        spriteMycelium = p_loadProperties_0_.registerSprite(new Namespaced("blocks/mycelium_top"));
        spritePodzol = p_loadProperties_0_.registerSprite(new Namespaced("blocks/dirt_podzol_top"));
        spriteSnow = p_loadProperties_0_.registerSprite(new Namespaced("blocks/snow"));
        spritesLoaded = true;
    ...
    private static TextureAtlasSprite registerSprite(Properties p_registerSprite_0_, String p_registerSprite_1_, String p_registerSprite_2_, TextureMap p_registerSprite_3_)
    {
        ...
        Namespaced resourcelocation = new Namespaced("textures/" + s + ".png");
        ...
        Namespaced resourcelocation1 = new Namespaced(s);
