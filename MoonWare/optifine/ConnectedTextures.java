...
public class ConnectedTextures
{
    ...
    private static TextureAtlasSprite getNeighbourIcon(IBlockAccess p_getNeighbourIcon_0_, IBlockState p_getNeighbourIcon_1_, BlockPos p_getNeighbourIcon_2_, IBlockState p_getNeighbourIcon_3_, int p_getNeighbourIcon_4_)
    {
        ...
        IBakedModel ibakedmodel = Minecraft.getBlockRenderDispatcher().getBlockModelShapes().getModelForState(p_getNeighbourIcon_3_);
    ...
    public static void updateIcons(TextureMap p_updateIcons_0_)
    {
        ...
        if (Config.isConnectedTextures())
        {
            ...
            Namespaced resourcelocation = new Namespaced("mcpatcher/ctm/default/empty");
    ...
    private static String[] getDefaultCtmPaths()
    {
        ...
        if (Config.isFromDefaultResourcePack(new Namespaced("textures/blocks/glass.png")))
        {
            list.add(s + "glass.properties");
            list.add(s + "glasspane.properties");
        }

        if (Config.isFromDefaultResourcePack(new Namespaced("textures/blocks/bookshelf.png")))
        {
            list.add(s + "bookshelf.properties");
        }

        if (Config.isFromDefaultResourcePack(new Namespaced("textures/blocks/sandstone_normal.png")))
        {
        ...
        for (int i = 0; i < astring.length; ++i)
        {
            ...
            if (Config.isFromDefaultResourcePack(new Namespaced("textures/blocks/glass_" + s1 + ".png")))
            {
