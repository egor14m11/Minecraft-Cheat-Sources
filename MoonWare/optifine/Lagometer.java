    ...
    public static void showLagometer(ScaledResolution p_showLagometer_0_)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer || gameSettings.showLagometer)
            {
                ...
                GlStateManager.ortho(0.0D, Minecraft.width, Minecraft.height, 0.0D, 1000.0D, 3000.0D);
                ...
                for (int j = 0; j < timesFrame.length; ++j)
                {
                    ...
                    k = k + 155;
                    float f = (float) Minecraft.height;
                    long l = 0L;
                ...
                renderTimeDivider(0, timesFrame.length, 33333333L, 196, 196, 196, (float) Minecraft.height, bufferbuilder);
                renderTimeDivider(0, timesFrame.length, 16666666L, 196, 196, 196, (float) Minecraft.height, bufferbuilder);
                tessellator.draw();
                GlStateManager.enableTexture2D();
                int j2 = Minecraft.height - 80;
                int k2 = Minecraft.height - 160;
                Minecraft.font.drawString("30", 2, k2 + 1, -8947849);
                Minecraft.font.drawString("30", 1, k2, -3881788);
                Minecraft.font.drawString("60", 2, j2 + 1, -8947849);
                Minecraft.font.drawString("60", 1, j2, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                int i2 = Minecraft.height / p_showLagometer_0_.getScaleFactor() - 8;
                IngameHud guiingame = Minecraft.ingameGUI;
                Gui.drawRect(l1 - 1, i2 - 1, l1 + 50, i2 + 10, -1605349296);
                Minecraft.font.drawString(" " + memMbSec + " MB/s", l1, i2, k1);
