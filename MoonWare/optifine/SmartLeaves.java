...
public class SmartLeaves
{
    ...
    static IBakedModel getModelCull(String p_getModelCull_0_, List p_getModelCull_1_)
    {
        ...
        {
            Namespaced resourcelocation = new Namespaced("blockstates/" + p_getModelCull_0_ + "_leaves.json");
            ...
            {
                Namespaced resourcelocation1 = new Namespaced("models/block/" + p_getModelCull_0_ + "_leaves.json");
                ...
                {
                    ModelNamespaced modelresourcelocation = new ModelNamespaced(p_getModelCull_0_ + "_leaves", "normal");
