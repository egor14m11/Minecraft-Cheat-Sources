...
{
    public static void FMLClientHandler_trackBrokenTexture(Namespaced p_FMLClientHandler_trackBrokenTexture_0_, String p_FMLClientHandler_trackBrokenTexture_1_)
    {
    ...
    public static void FMLClientHandler_trackMissingTexture(Namespaced p_FMLClientHandler_trackMissingTexture_0_)
    {
