...
{
    public static Properties readFontProperties(Namespaced p_readFontProperties_0_)
    {
        ...
        else
        {
            ...
            try
            {
                Namespaced resourcelocation = new Namespaced(p_readFontProperties_0_.getNamespace(), s2);
    ...
    public static Namespaced getHdFontLocation(Namespaced p_getHdFontLocation_0_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                s = s2 + s;
                Namespaced resourcelocation = new Namespaced(p_getHdFontLocation_0_.getNamespace(), s);
