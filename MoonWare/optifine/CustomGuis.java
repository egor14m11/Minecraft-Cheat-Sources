...
public class CustomGuis
{
    ...
    public static Namespaced getTextureLocation(Namespaced p_getTextureLocation_0_)
    {
        ...
        else
        {
            ...
            else if (p_getTextureLocation_0_.getNamespace().equals("minecraft") && p_getTextureLocation_0_.getPath().startsWith("textures/gui/"))
            {
    ...
    private static Namespaced getTexturePos(CustomGuiProperties.EnumContainer p_getTexturePos_0_, BlockPos p_getTexturePos_1_, IBlockAccess p_getTexturePos_2_, Namespaced p_getTexturePos_3_)
    {
    ...
    private static Namespaced getTextureEntity(CustomGuiProperties.EnumContainer p_getTextureEntity_0_, Entity p_getTextureEntity_1_, IBlockAccess p_getTextureEntity_2_, Namespaced p_getTextureEntity_3_)
    {
