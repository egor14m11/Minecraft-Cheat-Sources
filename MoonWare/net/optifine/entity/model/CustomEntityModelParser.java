...
public class CustomEntityModelParser
{
    ...
    private static void processExternalModel(JsonObject elem, Map mapModelJsons, String basePath)
    {
        ...
        if (s != null)
        {
            Namespaced resourcelocation = getResourceLocation(basePath, s, ".jpm");
    ...
    public static Namespaced getResourceLocation(String basePath, String path, String extension)
    {
    ...
    public static JsonObject loadJson(Namespaced location) throws IOException, JsonParseException
    {
