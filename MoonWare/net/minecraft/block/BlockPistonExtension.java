...
public class BlockPistonExtension extends BlockDirectional
{
    ...
    public BlockPistonExtension()
    {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockDirectional.FACING, EnumFacing.NORTH).withProperty(TYPE, BlockPistonExtension.EnumPistonType.DEFAULT).withProperty(SHORT, Boolean.valueOf(false)));
    ...
    public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable Entity entityIn, boolean p_185477_7_)
    {
        ...
        Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, getArmShape(state));
    }
    ...
    {
        return state.getValue(BlockDirectional.FACING) == EnumFacing.UP;
    }
    ...
    {
        return getDefaultState().withProperty(BlockDirectional.FACING, getFacing(meta)).withProperty(TYPE, (meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
    ...
    {
        return new BlockStateContainer(this, BlockDirectional.FACING, TYPE, SHORT);
    }

    public BlockFaceShape func_193383_a(IBlockAccess p_193383_1_, IBlockState p_193383_2_, BlockPos p_193383_3_, EnumFacing p_193383_4_)
    {
        return p_193383_4_ == p_193383_2_.getValue(BlockDirectional.FACING) ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
    }
