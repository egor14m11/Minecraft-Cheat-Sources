...
public class BlockShulkerBox extends BlockContainer
{
    ...
    public BlockShulkerBox(EnumDyeColor p_i47248_1_)
    {
        ...
        field_190958_b = p_i47248_1_;
        setCreativeTab(CreativeTabs.DECORATIONS);
        setDefaultState(blockState.getBaseState().withProperty(field_190957_a, EnumFacing.UP));
    }
    ...
    {
        return new TileEntityShulkerBox(field_190958_b);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityShulkerBox)
            {
                ...
                {
                    AxisAlignedBB axisalignedbb = Block.FULL_BLOCK_AABB.addCoord(0.5F * (float)enumfacing.getFrontOffsetX(), 0.5F * (float)enumfacing.getFrontOffsetY(), 0.5F * (float)enumfacing.getFrontOffsetZ()).func_191195_a(enumfacing.getFrontOffsetX(), enumfacing.getFrontOffsetY(), enumfacing.getFrontOffsetZ());
    ...
    {
        return getDefaultState().withProperty(field_190957_a, facing);
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return getDefaultState().withProperty(field_190957_a, enumfacing);
    }
    ...
    public void func_190948_a(ItemStack p_190948_1_, @Nullable World p_190948_2_, List<String> p_190948_3_, ITooltipFlag p_190948_4_)
    {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKey("BlockEntityTag", 10))
        {
            ...
            if (nbttagcompound1.hasKey("Items", 9))
            {
                ...
                if (j - i > 0)
                {
                    p_190948_3_.add(String.format(Formatting.ITALIC + I18n.translateToLocal("container.shulkerBox.more"), j - i));
                }
            }
        }
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        return tileentity instanceof TileEntityShulkerBox ? ((TileEntityShulkerBox)tileentity).func_190584_a(state) : Block.FULL_BLOCK_AABB;
    }
