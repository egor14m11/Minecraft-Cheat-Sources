...
public class BlockConcretePowder extends BlockFalling
{
    ...
    {
        super(Material.SAND);
        setDefaultState(blockState.getBaseState().withProperty(field_192426_a, EnumDyeColor.WHITE));
    ...
    {
        if (!func_192425_e(worldIn, pos, state))
        {
    ...
    {
        return getDefaultState().withProperty(field_192426_a, EnumDyeColor.byMetadata(meta));
    }
