...
public abstract class BlockButton extends BlockDirectional
{
    ...
    protected BlockButton(boolean wooden)
    {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockDirectional.FACING, EnumFacing.NORTH).withProperty(POWERED, Boolean.valueOf(false)));
    ...
    {
        return canPlaceBlock(worldIn, pos, facing) ? getDefaultState().withProperty(BlockDirectional.FACING, facing).withProperty(POWERED, Boolean.valueOf(false)) : getDefaultState().withProperty(BlockDirectional.FACING, EnumFacing.DOWN).withProperty(POWERED, Boolean.valueOf(false));
    }
    ...
    {
        if (checkForDrop(worldIn, pos, state) && !canPlaceBlock(worldIn, pos, state.getValue(BlockDirectional.FACING)))
        {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            notifyNeighbors(worldIn, pos, state.getValue(BlockDirectional.FACING));
    ...
    public int getStrongPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        {
            return blockState.getValue(BlockDirectional.FACING) == side ? 15 : 0;
        }
    }
    ...
    private void checkPressed(IBlockState p_185616_1_, World p_185616_2_, BlockPos p_185616_3_)
    {
        ...
        if (flag && !flag1)
        {
            ...
            notifyNeighbors(p_185616_2_, p_185616_3_, p_185616_1_.getValue(BlockDirectional.FACING));
            p_185616_2_.markBlockRangeForRenderUpdate(p_185616_3_, p_185616_3_);
            playClickSound(null, p_185616_2_, p_185616_3_);
        }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return getDefaultState().withProperty(BlockDirectional.FACING, enumfacing).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0));
    }
