...
public class BlockStateContainer implements IBlockStateContainer {
    ...
    protected BlockStateContainer(Block p_i9_1_, IProperty<?>[] p_i9_2_, ImmutableMap < IUnlistedProperty<?>, Optional<? >> p_i9_3_)
    {
        ...
        {
            Map < IProperty<?>, Comparable<? >> map1 = MapPopulator.createMap(properties.values(), list1);
            BlockStateContainer.StateImplementation blockstatecontainer$stateimplementation = createState(p_i9_1_, ImmutableMap.copyOf(map1), p_i9_3_);
    ...
    public static class Builder
    {
        ...
        public BlockStateContainer.Builder add(IUnlistedProperty<?>... p_add_1_)
        {
            ...
            {
                unlisted.add(iunlistedproperty);
            }
        ...
        {
            IProperty<?>[] iproperty = new IProperty[listed.size()];
            iproperty = listed.toArray(iproperty);

            if (unlisted.size() == 0)
            {
                return new BlockStateContainer(block, iproperty);
            }
            else
            {
                IUnlistedProperty<?>[] iunlistedproperty = new IUnlistedProperty[unlisted.size()];
                iunlistedproperty = unlisted.toArray(iunlistedproperty);
                return (BlockStateContainer)Reflector.newInstance(Reflector.ExtendedBlockState_Constructor, block, iproperty, iunlistedproperty);
            }
        }
    }
    ...
    static class StateImplementation extends BlockStateBase
    {
        ...
        {
            return block.func_190946_v(this);
        }
        ...
        {
            block.addCollisionBoxToList(this, worldIn, pos, p_185908_3_, p_185908_4_, p_185908_5_, p_185908_6_);
        }
        ...
        public AxisAlignedBB getBoundingBox(IBlockAccess blockAccess, BlockPos pos)
        {
            ...
            if (block$enumoffsettype != Block.EnumOffsetType.NONE && !(block instanceof BlockFlower))
            {
                AxisAlignedBB axisalignedbb = block.getBoundingBox(this, blockAccess, pos);
        ...
        {
            return block.func_190949_e(this, p_191059_1_, p_191059_2_);
        }
        ...
        {
            block.neighborChanged(this, worldIn, pos, blockIn, p_189546_4_);
        }
        ...
        {
            return Reflector.callInt(block, Reflector.ForgeBlock_getLightOpacity, this, p_getLightOpacity_1_, p_getLightOpacity_2_);
        }

        public int getLightValue(IBlockAccess p_getLightValue_1_, BlockPos p_getLightValue_2_)
        {
            return Reflector.callInt(block, Reflector.ForgeBlock_getLightValue, this, p_getLightValue_1_, p_getLightValue_2_);
        }

        public boolean isSideSolid(IBlockAccess p_isSideSolid_1_, BlockPos p_isSideSolid_2_, EnumFacing p_isSideSolid_3_)
        {
            return Reflector.callBoolean(block, Reflector.ForgeBlock_isSideSolid, this, p_isSideSolid_1_, p_isSideSolid_2_, p_isSideSolid_3_);
        }
        ...
        {
            return Reflector.callBoolean(block, Reflector.ForgeBlock_doesSideBlockRendering, this, p_doesSideBlockRendering_1_, p_doesSideBlockRendering_2_, p_doesSideBlockRendering_3_);
        }

        public BlockFaceShape func_193401_d(IBlockAccess p_193401_1_, BlockPos p_193401_2_, EnumFacing p_193401_3_)
        {
            return block.func_193383_a(p_193401_1_, this, p_193401_2_, p_193401_3_);
        }
    }
}
