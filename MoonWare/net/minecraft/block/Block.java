...
public class Block
{
    ...
    private static final Namespaced AIR_ID = new Namespaced("air");
    public static final RegistryNamespacedDefaultedByKey<Namespaced, Block> REGISTRY = new RegistryNamespacedDefaultedByKey<Namespaced, Block>(AIR_ID);
    ...
    {
        Namespaced resourcelocation = new Namespaced(name);
    ...
    {
        Block block = state.getBlock();
        if (((NoInteract.craftTable.getBoolValue() && getIdFromBlock(block) == 58) || (NoInteract.standing.getBoolValue() && getIdFromBlock(block) == 63) || (NoInteract.door.getBoolValue() && getIdFromBlock(block) == 193) || (NoInteract.door.getBoolValue() & getIdFromBlock(block) == 194) || (NoInteract.door.getBoolValue() & getIdFromBlock(block) == 195) || (NoInteract.door.getBoolValue() && getIdFromBlock(block) == 196) || (NoInteract.door.getBoolValue() && getIdFromBlock(block) == 197) || (NoInteract.hopper.getBoolValue() && getIdFromBlock(block) == 154) || (NoInteract.furnace.getBoolValue() && getIdFromBlock(block) == 61) || (NoInteract.dispenser.getBoolValue() && getIdFromBlock(block) == 23) || (NoInteract.anvil.getBoolValue() && getIdFromBlock(block) == 145) || (NoInteract.woodenslab.getBoolValue() && getIdFromBlock(block) == 158) || (NoInteract.lever.getBoolValue() && getIdFromBlock(block) == 69)) && (MoonWare.featureManager.getFeatureByClass(NoInteract.class).getState())) {
            return false;
        }
        return isCollidable();
    }
    ...
    {
        return getDefaultState().isFullCube() && !isBlockContainer;
    }
    ...
    public static void registerBlocks()
    {
        ...
        Set<Block> set = Sets.newHashSet(REGISTRY.getObject(new Namespaced("tripwire")));
    ...
    private static void registerBlock(int id, Namespaced textualID, Block block_)
    {
    ...
    {
        registerBlock(id, new Namespaced(textualID), block_);
    }
