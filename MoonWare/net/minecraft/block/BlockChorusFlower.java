...
public class BlockChorusFlower extends Block
{
    ...
    {
        p_185602_1_.setBlockState(p_185602_2_, getDefaultState().withProperty(AGE, Integer.valueOf(p_185602_3_)), 2);
        p_185602_1_.playEvent(1033, p_185602_2_, 0);
    }

    private void placeDeadFlower(World p_185605_1_, BlockPos p_185605_2_)
    {
        p_185605_1_.setBlockState(p_185605_2_, getDefaultState().withProperty(AGE, Integer.valueOf(5)), 2);
