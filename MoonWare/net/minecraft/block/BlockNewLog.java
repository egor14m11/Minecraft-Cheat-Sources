...
public class BlockNewLog extends BlockLog
{
    ...
    public BlockNewLog()
    {
        setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y));
    }
    ...
    {
        return new BlockStateContainer(this, VARIANT, BlockLog.LOG_AXIS);
    }
