...
public abstract class BlockLiquid extends Block
{
    ...
    {
        return p_189542_1_.getMaterial() == blockMaterial ? p_189542_1_.getValue(LEVEL).intValue() : -1;
    }
    ...
    private boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        {
            boolean flag = Block.func_193382_c(block) || block instanceof BlockStairs;
    ...
    protected Vec3d getFlow(IBlockAccess p_189543_1_, BlockPos p_189543_2_, IBlockState p_189543_3_)
    {
        ...
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            int j = getRenderedDepth(p_189543_1_.getBlockState(blockpos$pooledmutableblockpos));
        ...
        if (p_189543_3_.getValue(LEVEL).intValue() >= 8)
        {
            for (EnumFacing enumfacing1 : EnumFacing.Plane.HORIZONTAL)
            {
                ...
                if (isBlockSolid(p_189543_1_, blockpos$pooledmutableblockpos, enumfacing1) || isBlockSolid(p_189543_1_, blockpos$pooledmutableblockpos.up(), enumfacing1))
                {
