...
public class BlockCommandBlock extends BlockContainer
{
        ...
        if (!worldIn.isRemote)
        {
            ...
            if (tileentity instanceof TileEntityCommandBlock)
            {
                ...
                if (tileentitycommandblock$mode == TileEntityCommandBlock.Mode.AUTO)
                {
                    ...
                    if (flag1)
                    {
                        func_193387_a(state, worldIn, pos, commandblockbaselogic, flag);
                    }
    ...
    {
        return getDefaultState().withProperty(FACING, EnumFacing.func_190914_a(pos, placer)).withProperty(CONDITIONAL, Boolean.valueOf(false));
    }
