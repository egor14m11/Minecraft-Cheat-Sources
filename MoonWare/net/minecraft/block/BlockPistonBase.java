...
public class BlockPistonBase extends BlockDirectional
{
    ...
    public BlockPistonBase(boolean isSticky)
    {
        ...
        setDefaultState(blockState.getBaseState().withProperty(BlockDirectional.FACING, EnumFacing.NORTH).withProperty(EXTENDED, Boolean.valueOf(false)));
    ...
    {
        return !state.getValue(EXTENDED).booleanValue() || state.getValue(BlockDirectional.FACING) == EnumFacing.DOWN;
    }
    ...
    {
        worldIn.setBlockState(pos, state.withProperty(BlockDirectional.FACING, EnumFacing.func_190914_a(pos, placer)), 2);
    ...
    {
        return getDefaultState().withProperty(BlockDirectional.FACING, EnumFacing.func_190914_a(pos, placer)).withProperty(EXTENDED, Boolean.valueOf(false));
    }
    ...
    private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending)
    {
        ...
        else
        {
            ...
            for (int l = list.size() - 1; l >= 0; --l)
            {
                ...
                worldIn.setBlockState(blockpos3, Blocks.PISTON_EXTENSION.getDefaultState().withProperty(BlockDirectional.FACING, direction), 4);
    ...
    {
        return getDefaultState().withProperty(BlockDirectional.FACING, getFacing(meta)).withProperty(EXTENDED, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    {
        return new BlockStateContainer(this, BlockDirectional.FACING, EXTENDED);
    }

    public BlockFaceShape func_193383_a(IBlockAccess p_193383_1_, IBlockState p_193383_2_, BlockPos p_193383_3_, EnumFacing p_193383_4_)
    {
        p_193383_2_ = getActualState(p_193383_2_, p_193383_1_, p_193383_3_);
        return p_193383_2_.getValue(BlockDirectional.FACING) != p_193383_4_.getOpposite() && p_193383_2_.getValue(EXTENDED).booleanValue() ? BlockFaceShape.UNDEFINED : BlockFaceShape.SOLID;
    }
}
