...
public class BlockFire extends Block
{
    ...
    {
        return !worldIn.getBlockState(pos.down()).isFullyOpaque() && !Blocks.FIRE.canCatchFire(worldIn, pos.down()) ? state.withProperty(NORTH, Boolean.valueOf(canCatchFire(worldIn, pos.north()))).withProperty(EAST, Boolean.valueOf(canCatchFire(worldIn, pos.east()))).withProperty(SOUTH, Boolean.valueOf(canCatchFire(worldIn, pos.south()))).withProperty(WEST, Boolean.valueOf(canCatchFire(worldIn, pos.west()))).withProperty(UPPER, Boolean.valueOf(canCatchFire(worldIn, pos.up()))) : getDefaultState();
    }
