...
public class ContainerBrewingStand extends Container
{
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < listeners.size(); ++i)
        {
            ...
            {
                icontainerlistener.sendProgressBarUpdate(this, 0, tileBrewingStand.getField(0));
            }

            if (prevFuel != tileBrewingStand.getField(1))
            {
                icontainerlistener.sendProgressBarUpdate(this, 1, tileBrewingStand.getField(1));
            }
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (theSlot.isItemValid(itemstack1))
                {
