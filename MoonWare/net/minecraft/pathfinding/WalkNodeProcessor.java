...
public class WalkNodeProcessor extends NodeProcessor
{
    ...
    public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance)
    {
        int i = 0;
        int j = 0;
        PathNodeType pathnodetype = getPathNodeType(entity, currentPoint.xCoord, currentPoint.yCoord + 1, currentPoint.zCoord);
        ...
        double d0 = (double)currentPoint.yCoord - (1.0D - blockaccess.getBlockState(blockpos).getBoundingBox(blockaccess, blockpos).maxY);
    ...
    {
        return getPathNodeType(blockaccess, x, y, z, entitylivingIn, entitySizeX, entitySizeY, entitySizeZ, getCanBreakDoors(), getCanEnterDoors());
    }
