...
public class PathFinder
{
    ...
    {
        return findPath(worldIn, p_186333_2_, p_186333_3_.posX, p_186333_3_.getEntityBoundingBox().minY, p_186333_3_.posZ, p_186333_4_);
    }

    @Nullable
    public Path findPath(IBlockAccess worldIn, EntityLiving p_186336_2_, BlockPos p_186336_3_, float p_186336_4_)
    {
        return findPath(worldIn, p_186336_2_, (float)p_186336_3_.getX() + 0.5F, (float)p_186336_3_.getY() + 0.5F, (float)p_186336_3_.getZ() + 0.5F, p_186336_4_);
    }
    ...
    {
        path.clearPath();
        nodeProcessor.initProcessor(worldIn, p_186334_2_);
        PathPoint pathpoint = nodeProcessor.getStart();
        PathPoint pathpoint1 = nodeProcessor.getPathPointToCoords(p_186334_3_, p_186334_5_, p_186334_7_);
        Path path = findPath(pathpoint, pathpoint1, p_186334_9_);
