...
public abstract class WorldProvider
{
    ...
    protected void createBiomeProvider()
    {
        ...
        {
            biomeProvider = new BiomeProvider(worldObj.getWorldInfo());
        }
    }
    ...
    public IChunkGenerator createChunkGenerator()
    {
        ...
        {
            return new ChunkGeneratorFlat(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), generatorSettings);
        }
        else if (terrainType == WorldType.DEBUG_WORLD)
        {
            return new ChunkGeneratorDebug(worldObj);
        }
        else
        {
            return new ChunkGeneratorOverworld(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), generatorSettings);
        }
    }
    ...
    public boolean canCoordinateBeSpawn(int x, int z)
    {
        ...
        if (worldObj.getBiome(blockpos).ignorePlayerSpawnSuitability())
        {
            return true;
        }
        else
        {
            return worldObj.getGroundAboveSeaLevel(blockpos).getBlock() == Blocks.GRASS;
        }
    }
