...
public class AnvilSaveConverter extends SaveFormatOld
{
     ...
     */
    public boolean convertMapFormat(String filename, Progress progressCallback)
    {
    ...
    private void convertFile(File baseFolder, Iterable<File> regionFiles, BiomeProvider p_75813_3_, int p_75813_4_, int p_75813_5_, Progress progress)
    {
     ...
     */
    private void convertChunks(File baseFolder, File p_75811_2_, BiomeProvider biomeSource, int p_75811_4_, int p_75811_5_, Progress progressCallback)
    {
        try
        {
            ...
            for (int i = 0; i < 32; ++i)
            {
                ...
                if (l > k)
                {
                    progressCallback.setProgress(l);
                }
            }
