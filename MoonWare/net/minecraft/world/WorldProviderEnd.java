...
public class WorldProviderEnd extends WorldProvider
{
    ...
    {
        return new ChunkGeneratorEnd(worldObj, worldObj.getWorldInfo().isMapFeaturesEnabled(), worldObj.getSeed(), getSpawnCoordinate());
    }
    ...
    public void onWorldSave()
    {
        ...
        worldObj.getWorldInfo().setDimensionData(DimensionType.THE_END, nbttagcompound);
    }
