...
public class BiomeDecorator
{
    ...
    protected void genDecorations(Biome biomeIn, World worldIn, Random random)
    {
        ...
        for (int j1 = 0; j1 < sandPerChunk; ++j1)
        {
            ...
            gravelAsSandGen.generate(worldIn, random, worldIn.getTopSolidOrLiquidBlock(chunkPos.add(i2, 0, j6)));
        }
        ...
        for (int l2 = 0; l2 < flowersPerChunk; ++l2)
        {
            ...
            if (j14 > 0)
            {
                ...
                if (blockflower.getDefaultState().getMaterial() != Material.AIR)
                {
                    ...
                    yellowFlowerGen.generate(worldIn, random, blockpos1);
                }
            }
        }
    ...
    protected void generateOres(World worldIn, Random random)
    {
        ...
        genStandardOre1(worldIn, random, chunkProviderSettings.gravelCount, gravelGen, chunkProviderSettings.gravelMinHeight, chunkProviderSettings.gravelMaxHeight);
