...
public class BiomeSwamp extends Biome
{
    ...
    {
        return Biome.SWAMP_FEATURE;
    }

    public int getGrassColorAtPos(BlockPos pos)
    {
        double d0 = Biome.GRASS_COLOR_NOISE.getValue((double)pos.getX() * 0.0225D, (double)pos.getZ() * 0.0225D);
    ...
    {
        double d0 = Biome.GRASS_COLOR_NOISE.getValue((double)x * 0.25D, (double)z * 0.25D);
