...
public class BiomeProvider
{
    ...
    private BiomeProvider(long seed, WorldType worldTypeIn, String options)
    {
        ...
        {
            field_190945_a = ChunkGeneratorSettings.Factory.jsonToFactory(options).build();
        }

        GenLayer[] agenlayer = GenLayer.initializeAllBiomeGenerators(seed, worldTypeIn, field_190945_a);
    ...
    {
        return field_190945_a != null && field_190945_a.fixedBiome >= 0;
    }

    public Biome func_190943_d()
    {
        return field_190945_a != null && field_190945_a.fixedBiome >= 0 ? Biome.getBiomeForId(field_190945_a.fixedBiome) : null;
    }
}
