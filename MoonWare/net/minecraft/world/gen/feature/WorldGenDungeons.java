...
public class WorldGenDungeons extends WorldGenerator
{
    ...
    private static final Namespaced[] SPAWNERTYPES = {EntityList.getKey(EntitySkeleton.class), EntityList.getKey(EntityZombie.class), EntityList.getKey(EntityZombie.class), EntityList.getKey(EntitySpider.class)};
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (j2 >= 1 && j2 <= 5)
        {
            ...
            {
                ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().func_190894_a(pickMobSpawner(rand));
            }
            else
            {
     ...
     */
    private Namespaced pickMobSpawner(Random rand)
    {
