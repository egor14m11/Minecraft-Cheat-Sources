...
public class StructureEndCityPieces
{
    ...
    private static final StructureEndCityPieces.IGenerator HOUSE_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator()
    {
        ...
        public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_)
        {
            ...
            else
            {
                ...
                StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, p_191086_3_, p_191086_4_, "base_floor", rotation, true));
    ...
    private static final StructureEndCityPieces.IGenerator TOWER_GENERATOR = new StructureEndCityPieces.IGenerator()
    {
        ...
        {
            Rotation rotation = p_191086_3_.placeSettings.getRotation();
            StructureEndCityPieces.CityTemplate lvt_8_1_ = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, p_191086_3_, new BlockPos(3 + p_191086_6_.nextInt(2), -3, 3 + p_191086_6_.nextInt(2)), "tower_base", rotation, true));
            ...
            if (structureendcitypieces$citytemplate1 != null)
            {
                for (Tuple<Rotation, BlockPos> tuple : TOWER_BRIDGES)
                {
                    ...
                    {
                        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate2 = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, structureendcitypieces$citytemplate1, tuple.getSecond(), "bridge_end", rotation.add(tuple.getFirst()), true));
    ...
    private static final StructureEndCityPieces.IGenerator TOWER_BRIDGE_GENERATOR = new StructureEndCityPieces.IGenerator()
    {
        ...
        public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_)
        {
            ...
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, p_191086_3_, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
            ...
            else if (!func_191088_b(p_191086_1_, HOUSE_TOWER_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate, new BlockPos(-3, j + 1, -11), p_191086_5_, p_191086_6_))
            {
                return false;
            }
    ...
    private static final StructureEndCityPieces.IGenerator FAT_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator()
    {
        ...
        {
            Rotation rotation = p_191086_3_.placeSettings.getRotation();
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, p_191086_3_, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
            ...
            for (int i = 0; i < 2 && p_191086_6_.nextInt(3) != 0; ++i)
            {
                ...
                for (Tuple<Rotation, BlockPos> tuple : FAT_TOWER_BRIDGES)
                {
                    if (p_191086_6_.nextBoolean())
                    {
                        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1 = func_189935_b(p_191086_5_, func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, tuple.getSecond(), "bridge_end", rotation.add(tuple.getFirst()), true));
                        func_191088_b(p_191086_1_, TOWER_BRIDGE_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate1, null, p_191086_5_, p_191086_6_);
                    }
                }
            }
    ...
    public static class CityTemplate extends StructureComponentTemplate
    {
        ...
        public CityTemplate(TemplateManager p_i47214_1_, String p_i47214_2_, BlockPos p_i47214_3_, Rotation p_i47214_4_, boolean p_i47214_5_)
        {
            ...
            overwrite = p_i47214_5_;
            func_191085_a(p_i47214_1_);
        }

        private void func_191085_a(TemplateManager p_191085_1_)
        {
            Template template = p_191085_1_.getTemplate(null, new Namespaced("endcity/" + pieceName));
            PlacementSettings placementsettings = (overwrite ? OVERWRITE : INSERT).copy().setRotation(rotation);
        ...
        protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_)
        {
            ...
            {
                EntityItemFrame entityitemframe = new EntityItemFrame(p_186175_3_, p_186175_2_, rotation.rotate(EnumFacing.SOUTH));
