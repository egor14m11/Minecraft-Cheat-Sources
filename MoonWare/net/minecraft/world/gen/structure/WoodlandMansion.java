...
public class WoodlandMansion extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ)
    {
        ...
        int k = i / 80;
        int l = j / 80;
        Random random = worldObj.setRandomSeed(k, l, 10387319);
        k = k * 80;
        l = l * 80;
        ...
        {
            boolean flag = worldObj.getBiomeProvider().areBiomesViable(chunkX * 16 + 8, chunkZ * 16 + 8, 32, field_191072_a);
    ...
    {
        return new WoodlandMansion.Start(worldObj, field_191075_h, rand, chunkX, chunkZ);
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World p_i47235_1_, ChunkGeneratorOverworld p_i47235_2_, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_)
        {
            ...
            func_191092_a(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
        }
