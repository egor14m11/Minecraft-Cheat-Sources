...
public class Template
{
    ...
    {
        if ((!blocks.isEmpty() || !p_189960_4_.getIgnoreEntities() && !entities.isEmpty()) && size.getX() >= 1 && size.getY() >= 1 && size.getZ() >= 1)
        {
            ...
            {
                addEntitiesToWorld(p_189960_1_, p_189960_2_, p_189960_4_.getMirror(), p_189960_4_.getRotation(), structureboundingbox);
            }
        }
    }
    ...
    {
        return func_191157_a(p_189961_1_, p_189961_2_, p_189961_3_, getSize().getX(), getSize().getZ());
    }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt)
    {
        ...
        for (Template.EntityInfo template$entityinfo : entities)
        {
            ...
            nbttagcompound1.setTag("pos", writeDoubles(template$entityinfo.pos.xCoord, template$entityinfo.pos.yCoord, template$entityinfo.pos.zCoord));
    ...
    static class BasicPalette implements Iterable<IBlockState>
    {
        ...
        {
            int i = ids.get(p_189954_1_);

            if (i == -1)
            {
                i = lastId++;
                ids.put(p_189954_1_, i);
            }
        ...
        {
            IBlockState iblockstate = ids.getByValue(p_189955_1_);
