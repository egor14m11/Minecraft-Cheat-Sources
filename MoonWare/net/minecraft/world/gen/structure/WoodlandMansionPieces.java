...
public class WoodlandMansionPieces
{
    ...
    static class Grid
    {
        ...
        {
            field_191117_a = p_i47362_1_;
            int i = 11;
            field_191121_e = 7;
            field_191122_f = 4;
            field_191118_b = new WoodlandMansionPieces.SimpleGrid(11, 11, 5);
            field_191118_b.func_191142_a(field_191121_e, field_191122_f, field_191121_e + 1, field_191122_f + 1, 3);
            field_191118_b.func_191142_a(field_191121_e - 1, field_191122_f, field_191121_e - 1, field_191122_f + 1, 2);
            field_191118_b.func_191142_a(field_191121_e + 2, field_191122_f - 2, field_191121_e + 3, field_191122_f + 3, 5);
            field_191118_b.func_191142_a(field_191121_e + 1, field_191122_f - 2, field_191121_e + 1, field_191122_f - 1, 1);
            field_191118_b.func_191142_a(field_191121_e + 1, field_191122_f + 2, field_191121_e + 1, field_191122_f + 3, 1);
            field_191118_b.func_191144_a(field_191121_e - 1, field_191122_f - 1, 1);
            field_191118_b.func_191144_a(field_191121_e - 1, field_191122_f + 2, 1);
            field_191118_b.func_191142_a(0, 0, 11, 1, 5);
            field_191118_b.func_191142_a(0, 9, 11, 11, 5);
            func_191110_a(field_191118_b, field_191121_e, field_191122_f - 2, EnumFacing.WEST, 6);
            func_191110_a(field_191118_b, field_191121_e, field_191122_f + 3, EnumFacing.WEST, 6);
            func_191110_a(field_191118_b, field_191121_e - 2, field_191122_f - 1, EnumFacing.WEST, 3);
            func_191110_a(field_191118_b, field_191121_e - 2, field_191122_f + 2, EnumFacing.WEST, 3);

            while (func_191111_a(field_191118_b))
            {
            }

            field_191120_d = new WoodlandMansionPieces.SimpleGrid[3];
            field_191120_d[0] = new WoodlandMansionPieces.SimpleGrid(11, 11, 5);
            field_191120_d[1] = new WoodlandMansionPieces.SimpleGrid(11, 11, 5);
            field_191120_d[2] = new WoodlandMansionPieces.SimpleGrid(11, 11, 5);
            func_191116_a(field_191118_b, field_191120_d[0]);
            func_191116_a(field_191118_b, field_191120_d[1]);
            field_191120_d[0].func_191142_a(field_191121_e + 1, field_191122_f, field_191121_e + 1, field_191122_f + 1, 8388608);
            field_191120_d[1].func_191142_a(field_191121_e + 1, field_191122_f, field_191121_e + 1, field_191122_f + 1, 8388608);
            field_191119_c = new WoodlandMansionPieces.SimpleGrid(field_191118_b.field_191149_b, field_191118_b.field_191150_c, 5);
            func_191115_b();
            func_191116_a(field_191119_c, field_191120_d[2]);
        }
        ...
        {
            return (field_191120_d[p_191114_4_].func_191145_a(p_191114_2_, p_191114_3_) & 65535) == p_191114_5_;
        }
        ...
        public EnumFacing func_191113_b(WoodlandMansionPieces.SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_)
        {
            ...
            {
                if (func_191114_a(p_191113_1_, p_191113_2_ + enumfacing.getFrontOffsetX(), p_191113_3_ + enumfacing.getFrontOffsetZ(), p_191113_4_, p_191113_5_))
                {
                    return enumfacing;
                }
            }
        ...
        private void func_191110_a(WoodlandMansionPieces.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_)
        {
            if (p_191110_5_ > 0)
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    EnumFacing enumfacing = EnumFacing.getHorizontal(field_191117_a.nextInt(4));

                    if (enumfacing != p_191110_4_.getOpposite() && (enumfacing != EnumFacing.EAST || !field_191117_a.nextBoolean()))
                    {
                        ...
                        {
                            func_191110_a(p_191110_1_, p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing.getFrontOffsetX(), p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing.getFrontOffsetZ(), enumfacing, p_191110_5_ - 1);
                            break;
                        }
                    }
                }
        ...
        private void func_191115_b()
        {
            ...
            WoodlandMansionPieces.SimpleGrid woodlandmansionpieces$simplegrid = field_191120_d[1];

            for (int i = 0; i < field_191119_c.field_191150_c; ++i)
            {
                for (int j = 0; j < field_191119_c.field_191149_b; ++j)
                {
            ...
            if (list.isEmpty())
            {
                field_191119_c.func_191142_a(0, 0, field_191119_c.field_191149_b, field_191119_c.field_191150_c, 5);
            }
            else
            {
                Tuple<Integer, Integer> tuple = list.get(field_191117_a.nextInt(list.size()));
                ...
                EnumFacing enumfacing1 = func_191113_b(field_191118_b, tuple.getFirst().intValue(), tuple.getSecond().intValue(), 1, l1 & 65535);
                int i2 = tuple.getFirst().intValue() + enumfacing1.getFrontOffsetX();
                int i1 = tuple.getSecond().intValue() + enumfacing1.getFrontOffsetZ();

                for (int j1 = 0; j1 < field_191119_c.field_191150_c; ++j1)
                {
                    for (int k1 = 0; k1 < field_191119_c.field_191149_b; ++k1)
                    {
                        if (!func_191109_a(field_191118_b, k1, j1))
                        {
                            field_191119_c.func_191144_a(k1, j1, 5);
                        }
                        else if (k1 == tuple.getFirst().intValue() && j1 == tuple.getSecond().intValue())
                        {
                            field_191119_c.func_191144_a(k1, j1, 3);
                        }
                        else if (k1 == i2 && j1 == i1)
                        {
                            field_191119_c.func_191144_a(k1, j1, 3);
                            field_191120_d[2].func_191144_a(k1, j1, 8388608);
                        }
                    }
                }
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings())
                {
                    if (field_191119_c.func_191145_a(i2 + enumfacing.getFrontOffsetX(), i1 + enumfacing.getFrontOffsetZ()) == 0)
                    {
                ...
                {
                    EnumFacing enumfacing2 = list1.get(field_191117_a.nextInt(list1.size()));
                    func_191110_a(field_191119_c, i2 + enumfacing2.getFrontOffsetX(), i1 + enumfacing2.getFrontOffsetZ(), enumfacing2, 4);

                    while (func_191111_a(field_191119_c))
                    {
                    }
                }
            }
        ...
        private void func_191116_a(WoodlandMansionPieces.SimpleGrid p_191116_1_, WoodlandMansionPieces.SimpleGrid p_191116_2_)
        {
            ...
            Collections.shuffle(list, field_191117_a);
            int k3 = 10;
            ...
            for (Tuple<Integer, Integer> tuple : list)
            {
                ...
                if (p_191116_2_.func_191145_a(k, l) == 0)
                {
                    ...
                    int j2 = field_191117_a.nextBoolean() ? i1 : j1;
                    int k2 = field_191117_a.nextBoolean() ? k1 : l1;
                    int l2 = 2097152;
    ...
    public static class MansionTemplate extends StructureComponentTemplate
    {
        ...
        {
            super(0);
            field_191082_d = p_i47356_2_;
            templatePosition = p_i47356_3_;
            field_191083_e = p_i47356_4_;
            field_191084_f = p_i47356_5_;
            func_191081_a(p_i47356_1_);
        }

        private void func_191081_a(TemplateManager p_191081_1_)
        {
            Template template = p_191081_1_.getTemplate(null, new Namespaced("mansion/" + field_191082_d));
            PlacementSettings placementsettings = (new PlacementSettings()).setIgnoreEntities(true).setRotation(field_191083_e).setMirror(field_191084_f);
        ...
        protected void writeStructureToNBT(NBTTagCompound tagCompound)
        {
            ...
            tagCompound.setString("Template", field_191082_d);
        ...
        protected void readStructureFromNBT(NBTTagCompound tagCompound, TemplateManager p_143011_2_)
        {
            ...
            field_191082_d = tagCompound.getString("Template");
            field_191083_e = Rotation.valueOf(tagCompound.getString("Rot"));
            field_191084_f = Mirror.valueOf(tagCompound.getString("Mi"));
            func_191081_a(p_143011_2_);
        }
        ...
        protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, World p_186175_3_, Random p_186175_4_, StructureBoundingBox p_186175_5_)
        {
            if (p_186175_1_.startsWith("Chest"))
            {
                ...
                func_191080_a(p_186175_3_, p_186175_5_, p_186175_4_, p_186175_2_, LootTableList.field_191192_o, iblockstate);
            }
    ...
    static class Placer
    {
        ...
        {
            field_191134_a = p_i47361_1_;
            field_191135_b = p_i47361_2_;
        }
        ...
        public void func_191125_a(BlockPos p_191125_1_, Rotation p_191125_2_, List<WoodlandMansionPieces.MansionTemplate> p_191125_3_, WoodlandMansionPieces.Grid p_191125_4_)
        {
            ...
            func_191133_a(p_191125_3_, woodlandmansionpieces$placementdata);
            ...
            field_191136_c = p_191125_4_.field_191121_e + 1;
            field_191137_d = p_191125_4_.field_191122_f + 1;
            int i = p_191125_4_.field_191121_e + 1;
            int j = p_191125_4_.field_191122_f;
            func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, field_191136_c, field_191137_d, i, j);
            func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata1, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, field_191136_c, field_191137_d, i, j);
            ...
            for (int k = 0; k < woodlandmansionpieces$simplegrid1.field_191150_c && !flag; ++k)
            {
                for (int l = woodlandmansionpieces$simplegrid1.field_191149_b - 1; l >= 0 && !flag; --l)
                {
                    ...
                    {
                        woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata2.field_191139_b.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k - field_191137_d) * 8);
                        woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata2.field_191139_b.offset(p_191125_2_.rotate(EnumFacing.EAST), (l - field_191136_c) * 8);
                        func_191131_b(p_191125_3_, woodlandmansionpieces$placementdata2);
                        func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata2, woodlandmansionpieces$simplegrid1, EnumFacing.SOUTH, l, k, l, k);
                        flag = true;
                    }
                }
            }

            func_191123_a(p_191125_3_, p_191125_1_.up(16), p_191125_2_, woodlandmansionpieces$simplegrid, woodlandmansionpieces$simplegrid1);
            func_191123_a(p_191125_3_, p_191125_1_.up(27), p_191125_2_, woodlandmansionpieces$simplegrid1, null);
            ...
            for (int l2 = 0; l2 < 3; ++l2)
            {
                ...
                for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.field_191150_c; ++i1)
                {
                    for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++j1)
                    {
                        ...
                        {
                            BlockPos blockpos1 = blockpos.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (i1 - field_191137_d) * 8);
                            blockpos1 = blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), (j1 - field_191136_c) * 8);
                            p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "corridor_floor", blockpos1, p_191125_2_));
                            ...
                            {
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "carpet_north", blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), 1).up(), p_191125_2_));
                            }
                            ...
                            {
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "carpet_east", blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 1).offset(p_191125_2_.rotate(EnumFacing.EAST), 5).up(), p_191125_2_));
                            }

                            if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 + 1) == 1 || (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 + 1) & 8388608) == 8388608)
                            {
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, s, blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 5).offset(p_191125_2_.rotate(EnumFacing.WEST), 1), p_191125_2_));
                            }

                            if (woodlandmansionpieces$simplegrid3.func_191145_a(j1 - 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.func_191145_a(j1 - 1, i1) & 8388608) == 8388608)
                            {
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, s1, blockpos1.offset(p_191125_2_.rotate(EnumFacing.WEST), 1).offset(p_191125_2_.rotate(EnumFacing.NORTH), 1), p_191125_2_));
                            }
                        }
                    }
                }
                ...
                for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.field_191150_c; ++k1)
                {
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++l1)
                    {
                        ...
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 2 || flag1)
                        {
                            ...
                            if (!list.isEmpty())
                            {
                                enumfacing1 = list.get(field_191135_b.nextInt(list.size()));
                            }
                            ...
                            BlockPos blockpos2 = blockpos.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k1 - field_191137_d) * 8);
                            blockpos2 = blockpos2.offset(p_191125_2_.rotate(EnumFacing.EAST), -1 + (l1 - field_191136_c) * 8);
                            ...
                            {
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, enumfacing1 == EnumFacing.WEST ? s3 : s2, blockpos2, p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.func_191145_a(l1 + 1, k1) == 1 && !flag1)
                            {
                                ...
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, enumfacing1 == EnumFacing.EAST ? s3 : s2, blockpos3, p_191125_2_));
                            }
                            ...
                            if (WoodlandMansionPieces.Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2))
                            {
                                ...
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, enumfacing1 == EnumFacing.SOUTH ? s3 : s2, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1 - 1) == 1 && !flag1)
                            {
                                ...
                                p_191125_3_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, enumfacing1 == EnumFacing.NORTH ? s3 : s2, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }

                            if (j2 == 65536)
                            {
                                func_191129_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing1, awoodlandmansionpieces$roomcollection[l2]);
                            }
                            else if (j2 == 131072 && enumfacing1 != null)
                            {
                                ...
                                func_191132_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing3, enumfacing1, awoodlandmansionpieces$roomcollection[l2], flag2);
                            }
                            else if (j2 == 262144 && enumfacing1 != null && enumfacing1 != EnumFacing.UP)
                            {
                                ...
                                func_191127_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing2, enumfacing1, awoodlandmansionpieces$roomcollection[l2]);
                            }
                            else if (j2 == 262144 && enumfacing1 == EnumFacing.UP)
                            {
                                func_191128_a(p_191125_3_, blockpos2, p_191125_2_, awoodlandmansionpieces$roomcollection[l2]);
                            }
                        }
                    }
                }
        ...
        private void func_191130_a(List<WoodlandMansionPieces.MansionTemplate> p_191130_1_, WoodlandMansionPieces.PlacementData p_191130_2_, WoodlandMansionPieces.SimpleGrid p_191130_3_, EnumFacing p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_)
        {
            ...
            while (true)
            {
                ...
                {
                    func_191126_d(p_191130_1_, p_191130_2_);
        ...
        private void func_191123_a(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, WoodlandMansionPieces.SimpleGrid p_191123_4_, @Nullable WoodlandMansionPieces.SimpleGrid p_191123_5_)
        {
            for (int i = 0; i < p_191123_4_.field_191150_c; ++i)
            {
                ...
                {
                    BlockPos lvt_8_3_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (i - field_191137_d) * 8);
                    lvt_8_3_ = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), (j - field_191136_c) * 8);
                    ...
                    {
                        p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof", lvt_8_3_.up(3), p_191123_3_));
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j + 1, i))
                        {
                            ...
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_front", blockpos1, p_191123_3_));
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j - 1, i))
                        {
                            ...
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_front", blockpos5, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i - 1))
                        {
                            ...
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_front", blockpos6, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i + 1))
                        {
                            ...
                            p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_front", blockpos7, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                        }
                    }
                }
            }
            ...
            if (p_191123_5_ != null)
            {
                for (int k = 0; k < p_191123_4_.field_191150_c; ++k)
                {
                    ...
                    {
                        BlockPos blockpos3 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k - field_191137_d) * 8);
                        blockpos3 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), (i1 - field_191136_c) * 8);
                        ...
                        if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k) && flag1)
                        {
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall", blockpos8, p_191123_3_));
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall", blockpos9, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall", blockpos10, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall", blockpos11, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k))
                            {
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall_corner", blockpos12, p_191123_3_));
                                }
                                ...
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall_corner", blockpos13, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                                }
                            }
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k))
                            {
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall_corner", blockpos14, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                                }
                                ...
                                if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1))
                                {
                                    ...
                                    p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "small_wall_corner", blockpos15, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                                }
                            }
                        }
                    }
            ...
            for (int l = 0; l < p_191123_4_.field_191150_c; ++l)
            {
                ...
                {
                    BlockPos blockpos4 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (l - field_191137_d) * 8);
                    blockpos4 = blockpos4.offset(p_191123_3_.rotate(EnumFacing.EAST), (j1 - field_191136_c) * 8);
                    ...
                    if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l) && !flag2)
                    {
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l))
                        {
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_corner", blockpos2, p_191123_3_));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_inner_corner", blockpos18, p_191123_3_));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1))
                            {
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_corner", blockpos16, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 + 1, l - 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_inner_corner", blockpos19, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l))
                        {
                            ...
                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_corner", blockpos20, p_191123_3_.add(Rotation.CLOCKWISE_90)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l + 1))
                            {
                                ...
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_inner_corner", blockpos21, p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                            }

                            if (!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1, l - 1))
                            {
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_corner", blockpos17, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }
                            else if (WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j1 - 1, l - 1))
                            {
                                BlockPos blockpos22 = blockpos17.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 1);
                                p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "roof_inner_corner", blockpos22, p_191123_3_.add(Rotation.CLOCKWISE_180)));
                            }
                        }
                    }
                }
        ...
        private void func_191133_a(List<WoodlandMansionPieces.MansionTemplate> p_191133_1_, WoodlandMansionPieces.PlacementData p_191133_2_)
        {
            ...
            p_191133_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "entrance", p_191133_2_.field_191139_b.offset(enumfacing, 9), p_191133_2_.field_191138_a));
        ...
        {
            p_191131_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191131_2_.field_191140_c, p_191131_2_.field_191139_b.offset(p_191131_2_.field_191138_a.rotate(EnumFacing.EAST), 7), p_191131_2_.field_191138_a));
        ...
        private void func_191124_c(List<WoodlandMansionPieces.MansionTemplate> p_191124_1_, WoodlandMansionPieces.PlacementData p_191124_2_)
        {
            ...
            p_191124_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, "wall_corner", p_191124_2_.field_191139_b, p_191124_2_.field_191138_a));
        ...
        private void func_191129_a(List<WoodlandMansionPieces.MansionTemplate> p_191129_1_, BlockPos p_191129_2_, Rotation p_191129_3_, EnumFacing p_191129_4_, WoodlandMansionPieces.RoomCollection p_191129_5_)
        {
            ...
            String s = p_191129_5_.func_191104_a(field_191135_b);
            ...
            if (p_191129_4_ != EnumFacing.EAST)
            {
                ...
                {
                    s = p_191129_5_.func_191099_b(field_191135_b);
                }
            }
            ...
            p_191129_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, s, blockpos1, rotation));
        }
        ...
        private void func_191132_a(List<WoodlandMansionPieces.MansionTemplate> p_191132_1_, BlockPos p_191132_2_, Rotation p_191132_3_, EnumFacing p_191132_4_, EnumFacing p_191132_5_, WoodlandMansionPieces.RoomCollection p_191132_6_, boolean p_191132_7_)
        {
            if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos13, p_191132_3_));
            }
            else if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.NORTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos12, p_191132_3_, Mirror.LEFT_RIGHT));
            }
            else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.NORTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos11, p_191132_3_.add(Rotation.CLOCKWISE_180)));
            }
            else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.SOUTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos10, p_191132_3_, Mirror.FRONT_BACK));
            }
            else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos9, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
            }
            else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos8, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos7, p_191132_3_.add(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
            }
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191100_a(field_191135_b, p_191132_7_), blockpos6, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.SOUTH && p_191132_4_ == EnumFacing.NORTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191098_b(field_191135_b, p_191132_7_), blockpos5, p_191132_3_));
            }
            else if (p_191132_5_ == EnumFacing.NORTH && p_191132_4_ == EnumFacing.SOUTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191098_b(field_191135_b, p_191132_7_), blockpos4, p_191132_3_.add(Rotation.CLOCKWISE_180)));
            }
            else if (p_191132_5_ == EnumFacing.WEST && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191098_b(field_191135_b, p_191132_7_), blockpos3, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.WEST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191098_b(field_191135_b, p_191132_7_), blockpos2, p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.EAST)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191102_c(field_191135_b), blockpos1, p_191132_3_.add(Rotation.CLOCKWISE_90)));
            }
            else if (p_191132_5_ == EnumFacing.UP && p_191132_4_ == EnumFacing.SOUTH)
            {
                ...
                p_191132_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191132_6_.func_191102_c(field_191135_b), blockpos, p_191132_3_));
            }
        }
        ...
        private void func_191127_a(List<WoodlandMansionPieces.MansionTemplate> p_191127_1_, BlockPos p_191127_2_, Rotation p_191127_3_, EnumFacing p_191127_4_, EnumFacing p_191127_5_, WoodlandMansionPieces.RoomCollection p_191127_6_)
        {
            ...
            p_191127_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191127_6_.func_191101_d(field_191135_b), blockpos, rotation, mirror));
        }
        ...
        private void func_191128_a(List<WoodlandMansionPieces.MansionTemplate> p_191128_1_, BlockPos p_191128_2_, Rotation p_191128_3_, WoodlandMansionPieces.RoomCollection p_191128_4_)
        {
            ...
            p_191128_1_.add(new WoodlandMansionPieces.MansionTemplate(field_191134_a, p_191128_4_.func_191103_e(field_191135_b), blockpos, p_191128_3_, Mirror.NONE));
        }
    }
    ...
    static class SimpleGrid
    {
        ...
        {
            field_191149_b = p_i47358_1_;
            field_191150_c = p_i47358_2_;
            field_191151_d = p_i47358_3_;
            field_191148_a = new int[p_i47358_1_][p_i47358_2_];
        }

        public void func_191144_a(int p_191144_1_, int p_191144_2_, int p_191144_3_)
        {
            if (p_191144_1_ >= 0 && p_191144_1_ < field_191149_b && p_191144_2_ >= 0 && p_191144_2_ < field_191150_c)
            {
                field_191148_a[p_191144_1_][p_191144_2_] = p_191144_3_;
            }
        }
        ...
        {
            return p_191145_1_ >= 0 && p_191145_1_ < field_191149_b && p_191145_2_ >= 0 && p_191145_2_ < field_191150_c ? field_191148_a[p_191145_1_][p_191145_2_] : field_191151_d;
        }

        public void func_191141_a(int p_191141_1_, int p_191141_2_, int p_191141_3_, int p_191141_4_)
        {
            if (func_191145_a(p_191141_1_, p_191141_2_) == p_191141_3_)
            {
                func_191144_a(p_191141_1_, p_191141_2_, p_191141_4_);
            }
        }

        public boolean func_191147_b(int p_191147_1_, int p_191147_2_, int p_191147_3_)
        {
            return func_191145_a(p_191147_1_ - 1, p_191147_2_) == p_191147_3_ || func_191145_a(p_191147_1_ + 1, p_191147_2_) == p_191147_3_ || func_191145_a(p_191147_1_, p_191147_2_ + 1) == p_191147_3_ || func_191145_a(p_191147_1_, p_191147_2_ - 1) == p_191147_3_;
        }
    }
