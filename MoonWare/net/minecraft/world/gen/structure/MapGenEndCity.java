...
public class MapGenEndCity extends MapGenStructure
{
    ...
    {
        return new MapGenEndCity.Start(worldObj, endProvider, rand, chunkX, chunkZ);
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        private void create(World worldIn, ChunkGeneratorEnd chunkProvider, Random rnd, int chunkX, int chunkZ)
        {
            ...
            Rotation rotation = Rotation.values()[random.nextInt(Rotation.values().length)];
            int i = func_191070_b(chunkX, chunkZ, chunkProvider);
            ...
            else
            {
                ...
                StructureEndCityPieces.func_191087_a(worldIn.getSaveHandler().getStructureTemplateManager(), blockpos, rotation, components, rnd);
                updateBoundingBox();
                isSizeable = true;
            }
        }
