...
public class StructureMineshaftPieces
{
    ...
    public static class Corridor extends StructureMineshaftPieces.Peice
    {
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    ...
                    default:
                        if (j <= 1)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ - 1, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ, EnumFacing.WEST, i);
                        }
                        else
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ, EnumFacing.EAST, i);
                        }
                    ...
                    case SOUTH:
                        if (j <= 1)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.maxZ + 1, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.maxZ - 3, EnumFacing.WEST, i);
                        }
                        else
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.maxZ - 3, EnumFacing.EAST, i);
                        }
                    ...
                    case WEST:
                        if (j <= 1)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        }
                        else
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                    ...
                    case EAST:
                        if (j <= 1)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ, enumfacing, i);
                        }
                        else if (j == 2)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX - 3, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        }
                        else
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX - 3, boundingBox.minY - 1 + rand.nextInt(3), boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                }
            }
            ...
            if (i < 8)
            {
                if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH)
                {
                    for (int i1 = boundingBox.minX + 3; i1 + 3 <= boundingBox.maxX; i1 += 5)
                    {
                        ...
                        if (j1 == 0)
                        {
                            func_189938_b(componentIn, listIn, rand, i1, boundingBox.minY, boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                        }
                        else if (j1 == 1)
                        {
                            func_189938_b(componentIn, listIn, rand, i1, boundingBox.minY, boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                        }
                    }
                }
                else
                {
                    for (int k = boundingBox.minZ + 3; k + 3 <= boundingBox.maxZ; k += 5)
                    {
                        ...
                        if (l == 0)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY, k, EnumFacing.WEST, i + 1);
                        }
                        else if (l == 1)
                        {
                            func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY, k, EnumFacing.EAST, i + 1);
                        }
                    }
                }
            }
        ...
        protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, Random randomIn, int x, int y, int z, Namespaced loot)
        {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            else
            {
                ...
                IBlockState iblockstate = func_189917_F_();
                fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 2, 1, i1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                func_189914_a(worldIn, structureBoundingBoxIn, randomIn, 0.8F, 0, 2, 0, 2, 2, i1, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);

                if (hasSpiders)
                {
                    func_189914_a(worldIn, structureBoundingBoxIn, randomIn, 0.6F, 0, 0, 0, 2, 1, i1, Blocks.WEB.getDefaultState(), Blocks.AIR.getDefaultState(), false, 8);
                }

                for (int j1 = 0; j1 < sectionCount; ++j1)
                {
                    int k1 = 2 + j1 * 5;
                    func_189921_a(worldIn, structureBoundingBoxIn, 0, 0, k1, 2, 2, randomIn);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 0, 2, k1 - 1);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 2, 2, k1 - 1);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 0, 2, k1 + 1);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1F, 2, 2, k1 + 1);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 0, 2, k1 - 2);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 2, 2, k1 - 2);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 0, 2, k1 + 2);
                    func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05F, 2, 2, k1 + 2);
                    ...
                    if (hasSpiders && !spawnerPlaced)
                    {
                        ...
                        if (structureBoundingBoxIn.isVecInside(blockpos) && func_189916_b(worldIn, 1, 0, i2, structureBoundingBoxIn) < 8)
                        {
                            spawnerPlaced = true;
                ...
                for (int l2 = 0; l2 <= 2; ++l2)
                {
                    for (int i3 = 0; i3 <= i1; ++i3)
                    {
                        ...
                        if (iblockstate3.getMaterial() == Material.AIR && func_189916_b(worldIn, l2, -1, i3, structureBoundingBoxIn) < 8)
                        {
                            int l3 = -1;
                ...
                if (hasRails)
                {
                    ...
                    for (int j3 = 0; j3 <= i1; ++j3)
                    {
                        ...
                        {
                            float f = func_189916_b(worldIn, 1, 0, j3, structureBoundingBoxIn) > 8 ? 0.9F : 0.7F;
        ...
        {
            if (func_189918_a(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_7_, p_189921_6_, p_189921_5_))
            {
                IBlockState iblockstate = func_189917_F_();
                IBlockState iblockstate1 = func_189919_b();
        ...
        {
            if (func_189916_b(p_189922_1_, p_189922_5_, p_189922_6_, p_189922_7_, p_189922_2_) < 8)
            {
    ...
    public static class Cross extends StructureMineshaftPieces.Peice
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            switch (corridorDirection)
            {
                case NORTH:
                default:
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX + 1, boundingBox.minY, boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY, boundingBox.minZ + 1, EnumFacing.WEST, i);
                    func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY, boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;

                case SOUTH:
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX + 1, boundingBox.minY, boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY, boundingBox.minZ + 1, EnumFacing.WEST, i);
                    func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY, boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
            ...
            if (isMultipleFloors)
            {
                if (rand.nextBoolean())
                {
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX + 1, boundingBox.minY + 3 + 1, boundingBox.minZ - 1, EnumFacing.NORTH, i);
                }

                if (rand.nextBoolean())
                {
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY + 3 + 1, boundingBox.minZ + 1, EnumFacing.WEST, i);
                }

                if (rand.nextBoolean())
                {
                    func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY + 3 + 1, boundingBox.minZ + 1, EnumFacing.EAST, i);
                }

                if (rand.nextBoolean())
                {
                    func_189938_b(componentIn, listIn, rand, boundingBox.minX + 1, boundingBox.minY + 3 + 1, boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                }
            }
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            else
            {
                ...
                func_189923_b(worldIn, structureBoundingBoxIn, boundingBox.minX + 1, boundingBox.minY, boundingBox.minZ + 1, boundingBox.maxY);
                func_189923_b(worldIn, structureBoundingBoxIn, boundingBox.minX + 1, boundingBox.minY, boundingBox.maxZ - 1, boundingBox.maxY);
                func_189923_b(worldIn, structureBoundingBoxIn, boundingBox.maxX - 1, boundingBox.minY, boundingBox.minZ + 1, boundingBox.maxY);
                func_189923_b(worldIn, structureBoundingBoxIn, boundingBox.maxX - 1, boundingBox.minY, boundingBox.maxZ - 1, boundingBox.maxY);

                for (int i = boundingBox.minX; i <= boundingBox.maxX; ++i)
                {
                    for (int j = boundingBox.minZ; j <= boundingBox.maxZ; ++j)
                    {
                        if (getBlockStateFromPos(worldIn, i, boundingBox.minY - 1, j, structureBoundingBoxIn).getMaterial() == Material.AIR && func_189916_b(worldIn, i, boundingBox.minY - 1, j, structureBoundingBoxIn) < 8)
                        {
        ...
        private void func_189923_b(World p_189923_1_, StructureBoundingBox p_189923_2_, int p_189923_3_, int p_189923_4_, int p_189923_5_, int p_189923_6_)
        {
            ...
            {
                fillWithBlocks(p_189923_1_, p_189923_2_, p_189923_3_, p_189923_4_, p_189923_5_, p_189923_3_, p_189923_6_, p_189923_5_, func_189917_F_(), Blocks.AIR.getDefaultState(), false);
            }
        }
    }
    ...
    public static class Room extends StructureMineshaftPieces.Peice
    {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            for (k = 0; k < boundingBox.getXSize(); k = k + 4)
            {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice = func_189938_b(componentIn, listIn, rand, boundingBox.minX + k, boundingBox.minY + rand.nextInt(j) + 1, boundingBox.minZ - 1, EnumFacing.NORTH, i);
            ...
            for (k = 0; k < boundingBox.getXSize(); k = k + 4)
            {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice1 = func_189938_b(componentIn, listIn, rand, boundingBox.minX + k, boundingBox.minY + rand.nextInt(j) + 1, boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            ...
            for (k = 0; k < boundingBox.getZSize(); k = k + 4)
            {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice2 = func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY + rand.nextInt(j) + 1, boundingBox.minZ + k, EnumFacing.WEST, i);
            ...
            for (k = 0; k < boundingBox.getZSize(); k = k + 4)
            {
                ...
                StructureComponent structurecomponent = func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY + rand.nextInt(j) + 1, boundingBox.minZ + k, EnumFacing.EAST, i);
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
        {
            ...
            if (enumfacing != null)
            {
                switch (enumfacing)
                {
                    case NORTH:
                    default:
                        func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY, boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        break;

                    case SOUTH:
                        func_189938_b(componentIn, listIn, rand, boundingBox.minX, boundingBox.minY, boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;

                    case WEST:
                        func_189938_b(componentIn, listIn, rand, boundingBox.minX - 1, boundingBox.minY, boundingBox.minZ, EnumFacing.WEST, i);
                        break;

                    case EAST:
                        func_189938_b(componentIn, listIn, rand, boundingBox.maxX + 1, boundingBox.minY, boundingBox.minZ, EnumFacing.EAST, i);
                }
            }
        }
