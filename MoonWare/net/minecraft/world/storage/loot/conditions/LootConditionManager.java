...
{
    private static final Map <Namespaced, LootCondition.Serializer<? >> NAME_TO_SERIALIZER_MAP = Maps.newHashMap();
    ...
    {
        Namespaced resourcelocation = condition.getLootTableLocation();
    ...
    public static LootCondition.Serializer<?> getSerializerForName(Namespaced location)
    {
    ...
    public static class Serializer implements JsonDeserializer<LootCondition>, JsonSerializer<LootCondition>
    {
        public LootCondition deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            Namespaced resourcelocation = new Namespaced(JsonUtils.getString(jsonobject, "condition"));
            LootCondition.Serializer<?> serializer;

            try
            {
                serializer = getSerializerForName(resourcelocation);
            }
        ...
        {
            LootCondition.Serializer<LootCondition> serializer = getSerializerFor(p_serialize_1_);
