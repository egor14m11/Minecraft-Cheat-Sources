...
{
    private static final Map <Namespaced, LootFunction.Serializer<? >> NAME_TO_SERIALIZER_MAP = Maps.newHashMap();
    ...
    {
        Namespaced resourcelocation = p_186582_0_.getFunctionName();
    ...
    public static LootFunction.Serializer<?> getSerializerForName(Namespaced location)
    {
    ...
    public static class Serializer implements JsonDeserializer<LootFunction>, JsonSerializer<LootFunction>
    {
        public LootFunction deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            Namespaced resourcelocation = new Namespaced(JsonUtils.getString(jsonobject, "function"));
        ...
        {
            LootFunction.Serializer<LootFunction> serializer = getSerializerFor(p_serialize_1_);
