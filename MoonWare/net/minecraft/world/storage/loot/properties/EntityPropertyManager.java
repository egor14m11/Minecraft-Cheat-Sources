...
{
    private static final Map <Namespaced, EntityProperty.Serializer<? >> NAME_TO_SERIALIZER_MAP = Maps.newHashMap();
    ...
    {
        Namespaced resourcelocation = p_186644_0_.getName();
    ...
    public static EntityProperty.Serializer<?> getSerializerForName(Namespaced p_186646_0_)
    {
