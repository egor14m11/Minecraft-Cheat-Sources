...
public class ItemMonsterPlacer extends Item
{
    ...
    public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY)
    {
        ...
        else
        {
            ...
            double d0 = func_190909_a(playerIn, blockpos);
     ...
     */
    public static Entity spawnCreature(World worldIn, @Nullable Namespaced entityID, double x, double y, double z)
    {
     ...
     */
    public static void applyEntityIdToItemStack(ItemStack stack, Namespaced entityId)
    {
    ...
    @Nullable
    public static Namespaced func_190908_h(ItemStack p_190908_0_)
    {
