...
public class ItemFishingRod extends Item
{
    public ItemFishingRod()
    {
        ...
        addPropertyOverride(new Namespaced("cast"), new IItemPropertyGetter()
        {
    ...
    public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn)
    {
        ...
        if (worldIn.fishEntity != null)
        {
            ...
            itemStackIn.playSound(null, worldIn.posX, worldIn.posY, worldIn.posZ, SoundEvents.field_193780_J, SoundCategory.NEUTRAL, 1.0F, 0.4F / (Item.itemRand.nextFloat() * 0.4F + 0.8F));
        }
        else
        {
            itemStackIn.playSound(null, worldIn.posX, worldIn.posY, worldIn.posZ, SoundEvents.ENTITY_BOBBER_THROW, SoundCategory.NEUTRAL, 0.5F, 0.4F / (Item.itemRand.nextFloat() * 0.4F + 0.8F));
