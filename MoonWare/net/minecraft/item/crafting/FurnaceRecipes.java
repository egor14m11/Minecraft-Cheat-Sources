...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        addSmelting(Items.CHAINMAIL_HELMET, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.CHAINMAIL_CHESTPLATE, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.CHAINMAIL_LEGGINGS, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.CHAINMAIL_BOOTS, new ItemStack(Items.field_191525_da), 0.1F);
        ...
        addSmelting(Items.IRON_HELMET, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.IRON_CHESTPLATE, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.IRON_LEGGINGS, new ItemStack(Items.field_191525_da), 0.1F);
        addSmelting(Items.IRON_BOOTS, new ItemStack(Items.field_191525_da), 0.1F);
