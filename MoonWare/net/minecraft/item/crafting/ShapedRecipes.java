...
public class ShapedRecipes implements IRecipe
{
    ...
    {
        field_194137_e = p_i47501_1_;
        recipeWidth = p_i47501_2_;
        recipeHeight = p_i47501_3_;
        recipeItems = p_i47501_4_;
        recipeOutput = p_i47501_5_;
    }

    public String func_193358_e()
    {
        return field_194137_e;
    }
    ...
    {
        return p_194133_1_ >= recipeWidth && p_194133_2_ >= recipeHeight;
    }
    ...
    public static ItemStack func_192405_a(JsonObject p_192405_0_, boolean p_192405_1_)
    {
        ...
        Item item = Item.REGISTRY.getObject(new Namespaced(s));
