...
public class Ingredient implements Predicate<ItemStack>
{
    ...
    {
        field_193371_b = p_i47503_1_;
    }

    public ItemStack[] func_193365_a()
    {
        return field_193371_b;
    }
    ...
    public boolean apply(@Nullable ItemStack p_apply_1_)
    {
        ...
        {
            for (ItemStack itemstack : field_193371_b)
            {
    ...
    {
        if (field_194140_c == null)
        {
            field_194140_c = new IntArrayList(field_193371_b.length);

            for (ItemStack itemstack : field_193371_b)
            {
                field_194140_c.add(RecipeItemHelper.func_194113_b(itemstack));
            }

            field_194140_c.sort(IntComparators.NATURAL_COMPARATOR);
        }

        return field_194140_c;
    }
