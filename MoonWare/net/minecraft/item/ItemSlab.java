...
public class ItemSlab extends ItemBlock
{
    ...
    public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY)
    {
        ...
        if (!itemstack.isEmpty() && stack.canPlayerEdit(worldIn.offset(hand), hand, itemstack))
        {
            ...
            return tryPlace(stack, itemstack, playerIn, worldIn.offset(hand), comparable) ? EnumActionResult.SUCCESS : super.onItemUse(stack, playerIn, worldIn, pos, hand, facing, hitX, hitY);
        }
        else
        {
