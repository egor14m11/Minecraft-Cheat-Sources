...
public class Item
{
    public static final RegistryNamespaced<Namespaced, Item> REGISTRY = new RegistryNamespaced<Namespaced, Item>();
    ...
    private final IRegistry<Namespaced, IItemPropertyGetter> properties = new RegistrySimple<Namespaced, IItemPropertyGetter>();
    ...
    {
        Item item = REGISTRY.getObject(new Namespaced(id));
     ...
     */
    public final void addPropertyOverride(Namespaced key, IItemPropertyGetter getter)
    {
        properties.putObject(key, getter);
    }

    @Nullable
    public IItemPropertyGetter getPropertyGetter(Namespaced key)
    {
    ...
    public Item()
    {
        addPropertyOverride(new Namespaced("lefthanded"), LEFTHANDED_GETTER);
        addPropertyOverride(new Namespaced("cooldown"), COOLDOWN_GETTER);
    }
    ...
    protected Item setMaxDamage(int maxDamageIn)
    {
        ...
        if (maxDamageIn > 0)
        {
            addPropertyOverride(new Namespaced("damaged"), DAMAGED_GETTER);
            addPropertyOverride(new Namespaced("damage"), DAMAGE_GETTER);
        }
    ...
    {
        registerItem(id, new Namespaced(textualID), itemIn);
    }

    private static void registerItem(int id, Namespaced textualID, Item itemIn)
    {
    ...
    public enum ToolMaterial
    {
        ...
        public Item getRepairItem()
        {
            if (this == WOOD)
            {
                return getItemFromBlock(Blocks.PLANKS);
            }
            else if (this == STONE)
            {
                return getItemFromBlock(Blocks.COBBLESTONE);
            }
            else if (this == GOLD)
            {
