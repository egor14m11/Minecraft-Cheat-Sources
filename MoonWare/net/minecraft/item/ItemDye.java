    ...
    public static void spawnBonemealParticles(World worldIn, BlockPos pos, int amount)
    {
        ...
        if (iblockstate.getMaterial() != Material.AIR)
        {
            for (int i = 0; i < amount; ++i)
            {
                ...
                worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, (float)pos.getX() + Item.itemRand.nextFloat(), (double)pos.getY() + (double) Item.itemRand.nextFloat() * iblockstate.getBoundingBox(worldIn, pos).maxY, (float)pos.getZ() + Item.itemRand.nextFloat(), d0, d1, d2);
            }
        }
    }
