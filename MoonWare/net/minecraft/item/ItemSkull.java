...
{
    private static final String[] SKULL_TYPES = {"skeleton", "wither", "zombie", "char", "creeper", "dragon"};
    ...
    public String getUnlocalizedName(ItemStack stack)
    {
        ...
        return getUnlocalizedName() + "." + SKULL_TYPES[i];
    }
    ...
    public boolean updateItemStackNBT(NBTTagCompound nbt)
    {
        ...
        if (nbt.hasKey("SkullOwner", 8) && !Strings.isNullOrEmpty(nbt.getString("SkullOwner")))
        {
