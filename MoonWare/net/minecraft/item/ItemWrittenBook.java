...
public class ItemWrittenBook extends Item
{
    ...
    public void addInformation(ItemStack stack, @Nullable World playerIn, List<String> tooltip, ITooltipFlag advanced)
    {
        if (stack.hasTagCompound())
        {
            ...
            if (!StringUtils.isNullOrEmpty(s))
            {
                tooltip.add(Formatting.GRAY + I18n.translateToLocalFormatted("book.byAuthor", s));
            }

            tooltip.add(Formatting.GRAY + I18n.translateToLocal("book.generation." + nbttagcompound.getInteger("generation")));
        }
    }
                ...
                if (validBookTagContents(nbttagcompound))
                {
                    ...
                    for (int i = 0; i < nbttaglist.tagCount(); ++i)
                    {
                        ...
                        try
                        {
                            ...
                            itextcomponent = Components.processComponent(player, itextcomponent, player);
                        }
