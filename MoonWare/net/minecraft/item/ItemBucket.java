...
public class ItemBucket extends Item
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn)
    {
        ...
        RayTraceResult raytraceresult = rayTrace(itemStackIn, worldIn, flag);
        ...
        else
        {
            ...
            else if (flag)
            {
                ...
                else
                {
                    ...
                    if (material == Material.WATER && iblockstate.getValue(BlockLiquid.LEVEL).intValue() == 0)
                    {
                        ...
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, fillBucket(itemstack, worldIn, Items.WATER_BUCKET));
                    }
                    else if (material == Material.LAVA && iblockstate.getValue(BlockLiquid.LEVEL).intValue() == 0)
                    {
                        ...
                        itemStackIn.setBlockState(blockpos, Blocks.AIR.getDefaultState(), 11);
                        worldIn.addStat(StatList.getObjectUseStats(this));
                        return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, fillBucket(itemstack, worldIn, Items.LAVA_BUCKET));
                    }
                    else
                    {
                        return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
            ...
            else
            {
                ...
                else if (tryPlaceContainedLiquid(worldIn, itemStackIn, blockpos1))
                {
