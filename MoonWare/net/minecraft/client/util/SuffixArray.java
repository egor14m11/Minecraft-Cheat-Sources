...
public class SuffixArray<T>
{
    ...
    {
        field_194069_i = Math.max(field_194069_i, p_194057_2_.length());
        int i = field_194061_a.size();
        field_194061_a.add(p_194057_1_);
        field_194066_f.add(field_194065_e.size());

        for (int j = 0; j < p_194057_2_.length(); ++j)
        {
            field_194067_g.add(i);
            field_194068_h.add(j);
            field_194065_e.add(p_194057_2_.charAt(j));
        }

        field_194067_g.add(i);
        field_194068_h.add(p_194057_2_.length());
        field_194065_e.add(-1);
    }

    public void func_194058_a()
    {
        int i = field_194065_e.size();
        int[] aint = new int[i];
        int[] aint1 = new int[i];
        int[] aint2 = new int[i];
        int[] aint3 = new int[i];
        ...
        for (int j = 0; j < i; ++j)
        {
            aint[j] = field_194065_e.getInt(j);
        }

        int k1 = 1;

        for (int k = Math.min(i, field_194069_i); k1 * 2 < k; k1 *= 2)
        {
        ...
        IntList intlist1 = field_194067_g;
        IntList intlist = field_194068_h;
        field_194067_g = new IntArrayList(intlist1.size());
        field_194068_h = new IntArrayList(intlist.size());

        for (int i1 = 0; i1 < i; ++i1)
        {
            int j1 = aint3[i1];
            field_194067_g.add(intlist1.getInt(j1));
            field_194068_h.add(intlist.getInt(j1));
        }
    ...
    {
        for (int i2 = 0; i2 < field_194067_g.size(); ++i2)
        {
            field_194064_d.debug("{} {}", Integer.valueOf(i2), func_194059_a(i2));
        }
    ...
    {
        int i2 = field_194068_h.getInt(p_194059_1_);
        int j2 = field_194066_f.getInt(field_194067_g.getInt(p_194059_1_));
        StringBuilder stringbuilder = new StringBuilder();

        for (int k2 = 0; j2 + k2 < field_194065_e.size(); ++k2)
        {
            if (k2 == i2)
            {
            ...
            int l2 = field_194065_e.get(j2 + k2).intValue();
    ...
    {
        int i2 = field_194066_f.getInt(field_194067_g.getInt(p_194056_2_));
        int j2 = field_194068_h.getInt(p_194056_2_);

        for (int k2 = 0; k2 < p_194056_1_.length(); ++k2)
        {
            int l2 = field_194065_e.getInt(i2 + j2 + k2);
    ...
    public List<T> func_194055_a(String p_194055_1_)
    {
        ...
        {
            int l2 = j2 + (k2 - j2) / 2;
            int i3 = func_194056_a(p_194055_1_, l2);

            if (field_194062_b)
            {
                field_194064_d.debug("comparing lower \"{}\" with {} \"{}\": {}", p_194055_1_, Integer.valueOf(l2), func_194059_a(l2), Integer.valueOf(i3));
            }
        ...
        if (j2 >= 0 && j2 < i2)
        {
            ...
            {
                int j4 = j2 + (k2 - j2) / 2;
                int j3 = func_194056_a(p_194055_1_, j4);

                if (field_194062_b)
                {
                    field_194064_d.debug("comparing upper \"{}\" with {} \"{}\": {}", p_194055_1_, Integer.valueOf(j4), func_194059_a(j4), Integer.valueOf(j3));
                }
            ...
            {
                intset.add(field_194067_g.getInt(k3));
            }
