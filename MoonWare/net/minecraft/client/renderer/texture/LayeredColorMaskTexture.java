...
public class LayeredColorMaskTexture extends AbstractTexture
{
    ...
    private final Namespaced textureLocation;
    private final List<String> listTextures;
    private final List<EnumDyeColor> listDyeColors;

    public LayeredColorMaskTexture(Namespaced textureLocationIn, List<String> p_i46101_2_, List<EnumDyeColor> p_i46101_3_)
    {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        int k = listDyeColors.get(j).func_193350_e();

                        if (s != null)
                        {
                            iresource1 = resourceManager.getResource(new Namespaced(s));
