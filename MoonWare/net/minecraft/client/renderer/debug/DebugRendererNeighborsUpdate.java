...
public class DebugRendererNeighborsUpdate implements DebugRenderer.IDebugRenderer
{
    ...
    {
        field_191554_a = p_i47365_1_;
    }

    public void func_191553_a(long p_191553_1_, BlockPos p_191553_3_)
    {
        Map<BlockPos, Integer> map = field_191555_b.get(Long.valueOf(p_191553_1_));

        if (map == null)
        {
            map = Maps.newHashMap();
            field_191555_b.put(Long.valueOf(p_191553_1_), map);
        }
    ...
    public void render(float p_190060_1_, long p_190060_2_)
    {
        ...
        Iterator<Map.Entry<Long, Map<BlockPos, Integer>>> iterator = field_191555_b.entrySet().iterator();
