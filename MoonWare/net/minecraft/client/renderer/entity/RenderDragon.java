...
{
    public static final Namespaced ENDERCRYSTAL_BEAM_TEXTURES = new Namespaced("textures/entity/endercrystal/endercrystal_beam.png");
    private static final Namespaced DRAGON_EXPLODING_TEXTURES = new Namespaced("textures/entity/enderdragon/dragon_exploding.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityDragon entity)
    {
