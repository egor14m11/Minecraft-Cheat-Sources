...
public class LayerEntityOnShoulder implements LayerRenderer<EntityPlayer>
{
    ...
    private Namespaced field_192869_e;
    ...
    public void doRenderLayer(EntityPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        if (entitylivingbaseIn.func_192023_dk() != null || entitylivingbaseIn.func_192025_dl() != null)
        {
            ...
            {
                LayerEntityOnShoulder.DataHolder layerentityonshoulder$dataholder = func_192864_a(entitylivingbaseIn, field_192870_f, nbttagcompound, field_192865_a, field_192868_d, field_192869_e, field_192871_g, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale, true);
                field_192870_f = layerentityonshoulder$dataholder.field_192882_a;
                field_192865_a = layerentityonshoulder$dataholder.field_192883_b;
                field_192869_e = layerentityonshoulder$dataholder.field_192885_d;
                field_192868_d = layerentityonshoulder$dataholder.field_192884_c;
                field_192871_g = layerentityonshoulder$dataholder.field_192886_e;
            }
            ...
            {
                LayerEntityOnShoulder.DataHolder layerentityonshoulder$dataholder1 = func_192864_a(entitylivingbaseIn, field_192874_j, nbttagcompound1, field_192866_b, field_192872_h, field_192873_i, field_192875_k, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale, false);
                field_192874_j = layerentityonshoulder$dataholder1.field_192882_a;
                field_192866_b = layerentityonshoulder$dataholder1.field_192883_b;
                field_192873_i = layerentityonshoulder$dataholder1.field_192885_d;
                field_192872_h = layerentityonshoulder$dataholder1.field_192884_c;
                field_192875_k = layerentityonshoulder$dataholder1.field_192886_e;
            }
    ...
    private LayerEntityOnShoulder.DataHolder func_192864_a(EntityPlayer p_192864_1_, @Nullable UUID p_192864_2_, NBTTagCompound p_192864_3_, RenderLivingBase <? extends EntityLivingBase > p_192864_4_, ModelBase p_192864_5_, Namespaced p_192864_6_, Class<?> p_192864_7_, float p_192864_8_, float p_192864_9_, float p_192864_10_, float p_192864_11_, float p_192864_12_, float p_192864_13_, float p_192864_14_, boolean p_192864_15_)
    {
        if (p_192864_2_ == null || !p_192864_2_.equals(p_192864_3_.getUniqueId("UUID")))
        {
            ...
            {
                p_192864_4_ = new RenderParrot(field_192867_c);
    ...
    class DataHolder
    {
        ...
        public Namespaced field_192885_d;
        public Class<?> field_192886_e;

        public DataHolder(UUID p_i47463_2_, RenderLivingBase <? extends EntityLivingBase > p_i47463_3_, ModelBase p_i47463_4_, Namespaced p_i47463_5_, Class<?> p_i47463_6_)
        {
            field_192882_a = p_i47463_2_;
            field_192883_b = p_i47463_3_;
            field_192884_c = p_i47463_4_;
            field_192885_d = p_i47463_5_;
            field_192886_e = p_i47463_6_;
        }
    }
}
