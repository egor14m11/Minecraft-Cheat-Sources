...
{
    private static final Namespaced MINECART_TEXTURES = new Namespaced("textures/entity/minecart.png");
    ...
    {
        GlStateManager.pushMatrix();
        Minecraft.getBlockRenderDispatcher().renderBlockBrightness(p_188319_3_, p_188319_1_.getBrightness());
        GlStateManager.popMatrix();
    }
}
