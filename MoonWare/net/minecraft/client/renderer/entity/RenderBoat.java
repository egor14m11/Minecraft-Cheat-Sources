...
{
    private static final Namespaced[] BOAT_TEXTURES = {new Namespaced("textures/entity/boat/boat_oak.png"), new Namespaced("textures/entity/boat/boat_spruce.png"), new Namespaced("textures/entity/boat/boat_birch.png"), new Namespaced("textures/entity/boat/boat_jungle.png"), new Namespaced("textures/entity/boat/boat_acacia.png"), new Namespaced("textures/entity/boat/boat_darkoak.png")};
     ...
     */
    protected Namespaced getEntityTexture(EntityBoat entity)
    {
