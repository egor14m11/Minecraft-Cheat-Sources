...
{
    private static final Namespaced GHAST_TEXTURES = new Namespaced("textures/entity/ghast/ghast.png");
    private static final Namespaced GHAST_SHOOTING_TEXTURES = new Namespaced("textures/entity/ghast/ghast_shooting.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityGhast entity)
    {
