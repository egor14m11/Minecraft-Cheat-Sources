...
{
    private static final Namespaced field_191329_a = new Namespaced("textures/entity/illager/fangs.png");
    ...
    public void doRender(EntityEvokerFangs entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (f != 0.0F)
        {
            ...
            field_191330_f.render(entity, f, 0.0F, 0.0F, entity.rotationYaw, entity.rotationPitch, 0.03125F);
     ...
     */
    protected Namespaced getEntityTexture(EntityEvokerFangs entity)
    {
