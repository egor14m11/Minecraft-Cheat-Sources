...
import org.moonware.client.feature.impl.visual.NameTagi;
...
{
    private static final Namespaced SHADOW_TEXTURES = new Namespaced("textures/misc/shadow.png");
    ...
    protected int getTeamColor(T entityIn)
    {
        ...
        {
            String s = Font.getFormatFromString(scoreplayerteam.getColorPrefix());
    ...
    protected void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            renderLivingLabel(entity, entity.getDisplayName().asFormattedString(), x, y, z, 64);
        }
    }
     ...
     */
    protected abstract Namespaced getEntityTexture(T entity);

    protected boolean bindEntityTexture(T entity)
    {
        Namespaced resourcelocation = getEntityTexture(entity);
    ...
    public void bindTexture(Namespaced location)
    {
     ...
     */
    public Font getFontRendererFromRenderManager()
    {
    ...
    {
        if(MoonWare.featureManager.getFeatureByClass(NameTagi.class).getState()) {
            return;
        }
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            GameRenderer.drawNameplate(getFontRendererFromRenderManager(), str, (float)x, (float)y + f2, (float)z, i, f, f1, flag1, flag);
        }
    }
