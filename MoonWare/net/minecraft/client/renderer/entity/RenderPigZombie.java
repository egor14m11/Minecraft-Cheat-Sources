...
{
    private static final Namespaced ZOMBIE_PIGMAN_TEXTURE = new Namespaced("textures/entity/zombie_pigman.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityPigZombie entity)
    {
