...
{
    private static final Namespaced KRISTOFFER_PAINTING_TEXTURE = new Namespaced("textures/painting/paintings_kristoffer_zetterstrand.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityPainting entity)
    {
