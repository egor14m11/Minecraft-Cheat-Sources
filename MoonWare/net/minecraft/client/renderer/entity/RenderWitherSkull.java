...
{
    private static final Namespaced INVULNERABLE_WITHER_TEXTURES = new Namespaced("textures/entity/wither/wither_invulnerable.png");
    private static final Namespaced WITHER_TEXTURES = new Namespaced("textures/entity/wither/wither.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityWitherSkull entity)
    {
