...
{
    private static final Namespaced EXPERIENCE_ORB_TEXTURES = new Namespaced("textures/entity/experience_orb.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityXPOrb entity)
    {
