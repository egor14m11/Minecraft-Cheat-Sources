...
{
    private static final Namespaced POLAR_BEAR_TEXTURE = new Namespaced("textures/entity/bear/polarbear.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityPolarBear entity)
    {
