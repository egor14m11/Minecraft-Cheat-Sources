...
{
    private static final Namespaced FISH_PARTICLES = new Namespaced("textures/particle/particles.png");
    ...
    public void doRender(EntityFishHook entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entityplayer != null && !renderOutlines)
        {
            ...
            if ((renderManager.options == null || renderManager.options.thirdPersonView <= 0) && entityplayer == Minecraft.player)
            {
                float f10 = renderManager.options.fov;
                f10 = f10 / 100.0F;
     ...
     */
    protected Namespaced getEntityTexture(EntityFishHook entity)
    {
