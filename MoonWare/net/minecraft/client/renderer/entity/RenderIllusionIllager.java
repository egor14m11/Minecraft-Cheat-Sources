...
{
    private static final Namespaced field_193121_a = new Namespaced("textures/entity/illager/illusionist.png");
    ...
    public RenderIllusionIllager(RenderManager p_i47477_1_)
    {
        ...
        addLayer(new LayerHeldItem(this)
        {
            ...
            {
                ((ModelIllager) livingEntityRenderer.getMainModel()).func_191216_a(p_191361_1_).postRender(0.0625F);
            }
        });
     ...
     */
    protected Namespaced getEntityTexture(EntityMob entity)
    {
