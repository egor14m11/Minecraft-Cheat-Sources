...
{
    private static final Namespaced IRON_GOLEM_TEXTURES = new Namespaced("textures/entity/iron_golem.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityIronGolem entity)
    {
