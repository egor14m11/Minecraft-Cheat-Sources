...
{
    public static final Namespaced[] field_192862_a = {new Namespaced("textures/entity/parrot/parrot_red_blue.png"), new Namespaced("textures/entity/parrot/parrot_blue.png"), new Namespaced("textures/entity/parrot/parrot_green.png"), new Namespaced("textures/entity/parrot/parrot_yellow_blue.png"), new Namespaced("textures/entity/parrot/parrot_grey.png")};
     ...
     */
    protected Namespaced getEntityTexture(EntityParrot entity)
    {
