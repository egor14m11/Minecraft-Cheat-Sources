...
{
    private static final Namespaced CAVE_SPIDER_TEXTURES = new Namespaced("textures/entity/spider/cave_spider.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityCaveSpider entity)
    {
