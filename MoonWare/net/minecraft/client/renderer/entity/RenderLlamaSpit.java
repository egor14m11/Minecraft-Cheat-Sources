...
{
    private static final Namespaced field_191333_a = new Namespaced("textures/entity/llama/spit.png");
    ...
    public void doRender(EntityLlamaSpit entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        field_191334_f.render(entity, partialTicks, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
     ...
     */
    protected Namespaced getEntityTexture(EntityLlamaSpit entity)
    {
