...
{
    private static final Namespaced SHULKER_SPARK_TEXTURE = new Namespaced("textures/entity/shulker/spark.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityShulkerBullet entity)
    {
