...
{
    public static final Namespaced[] SHULKER_ENDERGOLEM_TEXTURE = {new Namespaced("textures/entity/shulker/shulker_white.png"), new Namespaced("textures/entity/shulker/shulker_orange.png"), new Namespaced("textures/entity/shulker/shulker_magenta.png"), new Namespaced("textures/entity/shulker/shulker_light_blue.png"), new Namespaced("textures/entity/shulker/shulker_yellow.png"), new Namespaced("textures/entity/shulker/shulker_lime.png"), new Namespaced("textures/entity/shulker/shulker_pink.png"), new Namespaced("textures/entity/shulker/shulker_gray.png"), new Namespaced("textures/entity/shulker/shulker_silver.png"), new Namespaced("textures/entity/shulker/shulker_cyan.png"), new Namespaced("textures/entity/shulker/shulker_purple.png"), new Namespaced("textures/entity/shulker/shulker_blue.png"), new Namespaced("textures/entity/shulker/shulker_brown.png"), new Namespaced("textures/entity/shulker/shulker_green.png"), new Namespaced("textures/entity/shulker/shulker_red.png"), new Namespaced("textures/entity/shulker/shulker_black.png")};
     ...
     */
    protected Namespaced getEntityTexture(EntityShulker entity)
    {
    ...
    class HeadLayer implements LayerRenderer<EntityShulker>
    {
        ...
        public void doRenderLayer(EntityShulker entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
        {
            ...
            bindTexture(SHULKER_ENDERGOLEM_TEXTURE[entitylivingbaseIn.func_190769_dn().getMetadata()]);
