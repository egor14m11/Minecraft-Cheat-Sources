...
{
    private static final Namespaced MAGMA_CUBE_TEXTURES = new Namespaced("textures/entity/slime/magmacube.png");
     ...
     */
    protected Namespaced getEntityTexture(EntityMagmaCube entity)
    {
