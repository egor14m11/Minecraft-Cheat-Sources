...
public class TileEntityBedRenderer extends TileEntitySpecialRenderer<TileEntityBed>
{
    ...
    {
        if (field_193850_e != field_193849_d.func_193770_a())
        {
            field_193849_d = new ModelBed();
            field_193850_e = field_193849_d.func_193770_a();
        }
        ...
        {
            Namespaced resourcelocation = field_193848_a[enumdyecolor.getMetadata()];
        ...
        if (flag)
        {
            func_193847_a(flag1, p_192841_2_, p_192841_4_, p_192841_6_, i, p_192841_10_);
        }
        else
        {
            GlStateManager.pushMatrix();
            func_193847_a(true, p_192841_2_, p_192841_4_, p_192841_6_, i, p_192841_10_);
            func_193847_a(false, p_192841_2_, p_192841_4_, p_192841_6_ - 1.0D, i, p_192841_10_);
    ...
    {
        field_193849_d.func_193769_a(p_193847_1_);
        GlStateManager.pushMatrix();
        float f = 0.0F;
        float f1 = 0.0F;
        float f2 = 0.0F;
    ...
    static
    {
        ...
        field_193848_a = new Namespaced[aenumdyecolor.length];

        for (EnumDyeColor enumdyecolor : aenumdyecolor)
        {
            field_193848_a[enumdyecolor.getMetadata()] = new Namespaced("textures/entity/bed/" + enumdyecolor.func_192396_c() + ".png");
        }
    }
}
