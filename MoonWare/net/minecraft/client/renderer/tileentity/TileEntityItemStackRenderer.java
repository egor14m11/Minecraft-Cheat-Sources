...
public class TileEntityItemStackRenderer
{
    ...
    public void func_192838_a(ItemStack p_192838_1_, float p_192838_2_)
    {
        ...
        if (item == Items.BANNER)
        {
            ...
            TileEntityRendererDispatcher.instance.func_192855_a(banner, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Items.BED)
        {
            field_193843_g.func_193051_a(p_192838_1_);
            TileEntityRendererDispatcher.instance.renderTileEntityAt(field_193843_g, 0.0D, 0.0D, 0.0D, 0.0F);
        }
        else if (item == Items.SHIELD)
        {
            if (p_192838_1_.getSubCompound("BlockEntityTag") != null)
            {
                ...
                Minecraft.getTextureManager().bindTexture(BannerTextures.SHIELD_DESIGNS.getResourceLocation(banner.getPatternResourceLocation(), banner.getPatternList(), banner.getColorList()));
            }
            else
            {
                Minecraft.getTextureManager().bindTexture(BannerTextures.SHIELD_BASE_TEXTURE);
            }
        ...
        else if (item == Items.SKULL)
        {
            ...
            if (p_192838_1_.hasTagCompound())
            {
                ...
                else if (nbttagcompound.hasKey("SkullOwner", 8) && !Strings.isNullOrEmpty(nbttagcompound.getString("SkullOwner")))
                {
        ...
        {
            TileEntityRendererDispatcher.instance.func_192855_a(enderChest, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        else if (item == Item.getItemFromBlock(Blocks.TRAPPED_CHEST))
        {
            TileEntityRendererDispatcher.instance.func_192855_a(chestTrap, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
        ...
        {
            TileEntityRendererDispatcher.instance.func_192855_a(chestBasic, 0.0D, 0.0D, 0.0D, 0.0F, p_192838_2_);
        }
    }
