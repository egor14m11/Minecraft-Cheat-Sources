...
{
    private static final Namespaced END_SKY_TEXTURE = new Namespaced("textures/environment/end_sky.png");
    private static final Namespaced END_PORTAL_TEXTURE = new Namespaced("textures/entity/end_portal.png");
    ...
    {
        if (!Config.isShaders() || !ShadersRender.renderEndPortal(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, p_192841_8_, p_192841_9_, func_191287_c()))
        {
