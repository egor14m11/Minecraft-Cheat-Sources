...
public class TileEntityStructureRenderer extends TileEntitySpecialRenderer<TileEntityStructure>
{
    ...
    {
        if (Minecraft.player.canUseCommandBlock() || Minecraft.player.isSpectator())
        {
            ...
            if (blockpos1.getX() >= 1 && blockpos1.getY() >= 1 && blockpos1.getZ() >= 1)
            {
                if (p_192841_1_.getMode() == TileEntityStructure.Mode.SAVE || p_192841_1_.getMode() == TileEntityStructure.Mode.LOAD)
                {
                    ...
                    {
                        renderInvisibleBlocks(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, blockpos, tessellator, bufferbuilder, true);
                        renderInvisibleBlocks(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, blockpos, tessellator, bufferbuilder, false);
                    }
