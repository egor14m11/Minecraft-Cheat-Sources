...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer<TileEntityBanner>
{
    ...
    {
        if (MoonWare.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.banner.getBoolValue()) {
            return;
        }
        ...
        Namespaced resourcelocation = getBannerResourceLocation(p_192841_1_);
    ...
    @Nullable
    private Namespaced getBannerResourceLocation(TileEntityBanner bannerObj)
    {
