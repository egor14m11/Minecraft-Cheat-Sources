...
public class CreativeSettings
{
    ...
    {
        field_192565_a = p_i47395_1_;
        field_192567_c = new File(p_i47395_2_, "hotbar.nbt");

        for (int i = 0; i < 9; ++i)
        {
            field_192568_d[i] = new HotbarSnapshot();
        }
    ...
    public void func_192562_a()
    {
        try
        {
            NBTTagCompound nbttagcompound = CompressedStreamTools.read(field_192567_c);
            ...
            for (int i = 0; i < 9; ++i)
            {
                field_192568_d[i].func_192833_a(nbttagcompound.getTagList(String.valueOf(i), 10));
            }
        }
    ...
    public void func_192564_b()
    {
        try
        {
            ...
            for (int i = 0; i < 9; ++i)
            {
                nbttagcompound.setTag(String.valueOf(i), field_192568_d[i].func_192834_a());
            }

            CompressedStreamTools.write(nbttagcompound, field_192567_c);
        }
        catch (Exception exception)
        {
    ...
    {
        return field_192568_d[p_192563_1_];
    }
}
