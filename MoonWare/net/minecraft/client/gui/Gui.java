...
public class Gui {
    public static final Namespaced OPTIONS_BACKGROUND = new Namespaced("textures/gui/options_background.png");
    public static final Namespaced STAT_ICONS = new Namespaced("textures/gui/container/stats_icons.png");
    public static final Namespaced ICONS = new Namespaced("textures/gui/icons.png");
    public float zLevel;
    public static float zLevell;
    ...
    public static void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height,
        ...
        bufferbuilder.pos(x + width, y + height, zlevel)
                .tex((float) (textureX + width) * 0.00390625F,
    ...
    public void drawGradientRectSideways(double left, double top, double right, double bottom, int startColor, int endColor) {
    ...
    public void drawGradientRectSideways2(double x, double y, double width, double height, int startColor, int endColor) {
     ...
     */
    public void drawCenteredString(Font fontIn, String text, int x, int y, int color) {
        fontIn.drawStringWithShadow(text, (float) (x - fontIn.getStringWidth(text) / 2), (float) y, color);
    }

    /**
     * Renders the specified text to the screen. Args : renderer, string, x, y, color
     */
    public void drawString(Font fontIn, String text, int x, int y, int color) {
        fontIn.drawStringWithShadow(text, (float) x, (float) y, color);
    }
    ...
    public static void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
        bufferbuilder.pos(x + 0, y + height, zLevell).tex((float) (textureX + 0) * 0.00390625F, (float) (textureY + height) * 0.00390625F).endVertex();
        bufferbuilder.pos(x + width, y + height, zLevell).tex((float) (textureX + width) * 0.00390625F, (float) (textureY + height) * 0.00390625F).endVertex();
        bufferbuilder.pos(x + width, y + 0, zLevell).tex((float) (textureX + width) * 0.00390625F, (float) (textureY + 0) * 0.00390625F).endVertex();
        bufferbuilder.pos(x + 0, y + 0, zLevell).tex((float) (textureX + 0) * 0.00390625F, (float) (textureY + 0) * 0.00390625F).endVertex();
        tessellator.draw();
    }
    ...
    public void drawGradientRect2(double x, double y, double width, double height, int startColor, int endColor) {
