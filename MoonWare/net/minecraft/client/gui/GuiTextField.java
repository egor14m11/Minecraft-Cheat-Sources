...
public class GuiTextField extends Gui {
    ...
    public GuiTextField(int componentId, Font fontrendererObj, int x, int y, int par5Width, int par6Height) {
        id = componentId;
    ...
    public void drawTextBox() {
        if (getVisible()) {
            if (getEnableBackgroundDrawing()) {
                ...
                RectHelper.drawGradientRect(xPosition, yPosition, xPosition + width, yPosition + height, new Color(1, 1, 1, 255).getRGB(), new Color(5, 5, 5, 255).getRGB());
            }
            int i = -1;
    ...
    public void drawCelestialTextBox(CustomFont font,Color color) {
        if (getVisible()) {
            if (getEnableBackgroundDrawing()) {
                //RectHelper.drawRect(xPosition, yPosition, xPosition + width, yPosition + height, new Color(30, 30, 30, 185).getRGB());
                //RectHelper.drawGradientRect(xPosition, yPosition, xPosition + width, yPosition + height, new Color(1, 1, 1, 255).getRGB(), new Color(5, 5, 5, 255).getRGB());
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) font.drawShadow(s1, (float) l, (float) i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = (int) font.drawShadow(s.substring(j), (float) j1, (float) i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    font.drawShadow("_", (float) k1, (float) i1, i);
                }
            }
