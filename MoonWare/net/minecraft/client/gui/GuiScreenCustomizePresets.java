...
public class GuiScreenCustomizePresets extends Screen
{
    ...
    public void init()
    {
        ...
        select = addButton(new ButtonWidget(0, width / 2 - 102, height - 27, 100, 20, I18n.format("createWorld.customize.presets.select")));
        widgets.add(new ButtonWidget(1, width / 2 + 3, height - 27, 100, 20, I18n.format("gui.cancel")));
    ...
    public void draw(int mouseX, int mouseY, float partialTick)
    {
        ...
        drawCenteredString(font, title, width / 2, 8, 16777215);
        drawString(font, shareText, 50, 30, 10526880);
    ...
    static
    {
        ...
        Namespaced resourcelocation = new Namespaced("textures/gui/presets/water.png");
        ...
        resourcelocation = new Namespaced("textures/gui/presets/isles.png");
        ...
        resourcelocation = new Namespaced("textures/gui/presets/delight.png");
        ...
        resourcelocation = new Namespaced("textures/gui/presets/madness.png");
        ...
        resourcelocation = new Namespaced("textures/gui/presets/drought.png");
        ...
        resourcelocation = new Namespaced("textures/gui/presets/chaos.png");
        ...
        chunkgeneratorsettings$factory = ChunkGeneratorSettings.Factory.jsonToFactory("{\"coordinateScale\":684.412, \"heightScale\":684.412, \"upperLimitScale\":512.0, \"lowerLimitScale\":512.0, \"depthNoiseScaleX\":200.0, \"depthNoiseScaleZ\":200.0, \"depthNoiseScaleExponent\":0.5, \"mainNoiseScaleX\":80.0, \"mainNoiseScaleY\":160.0, \"mainNoiseScaleZ\":80.0, \"baseSize\":8.5, \"stretchY\":12.0, \"biomeDepthWeight\":1.0, \"biomeDepthOffset\":0.0, \"biomeScaleWeight\":1.0, \"biomeScaleOffset\":0.0, \"useCaves\":true, \"useDungeons\":true, \"dungeonChance\":8, \"useStrongholds\":true, \"useVillages\":true, \"useMineShafts\":true, \"useTemples\":true, \"useRavines\":true, \"useWaterLakes\":true, \"waterLakeChance\":4, \"useLavaLakes\":true, \"lavaLakeChance\":80, \"useLavaOceans\":true, \"seaLevel\":40 }");
        resourcelocation = new Namespaced("textures/gui/presets/luck.png");
    ...
    {
        public String name;
        public Namespaced texture;
        public ChunkGeneratorSettings.Factory settings;

        public Info(String nameIn, Namespaced textureIn, ChunkGeneratorSettings.Factory settingsIn)
        {
            name = nameIn;
            texture = textureIn;
            settings = settingsIn;
    ...
    class ListPreset extends GuiSlot
    {
        ...
        public ListPreset()
        {
            super(minecraft, GuiScreenCustomizePresets.this.width, GuiScreenCustomizePresets.this.height, 80, GuiScreenCustomizePresets.this.height - 32, 38);
        }
        ...
        protected void elementClicked(int i, boolean doubleClick, int mouseX, int mouseY)
        {
            selected = i;
            updateButtonValidity();
            export.setText((PRESETS.get(list.selected)).settings.toString());
        }
        ...
        private void blitIcon(int p_178051_1_, int p_178051_2_, Namespaced p_178051_3_)
        {
            int i = p_178051_1_ + 5;
        ...
        {
            GuiScreenCustomizePresets.Info guiscreencustomizepresets$info = PRESETS.get(p_192637_1_);
            blitIcon(p_192637_2_, p_192637_3_, guiscreencustomizepresets$info.texture);
            font.drawString(guiscreencustomizepresets$info.name, p_192637_2_ + 32 + 10, p_192637_3_ + 14, 16777215);
        }
    }
}
