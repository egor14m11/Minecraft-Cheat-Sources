...
public abstract class GuiListExtended extends GuiSlot {
    ...
    protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
        getListEntry(p_192637_1_).draw(p_192637_1_, p_192637_2_, p_192637_3_, getListWidth(), p_192637_4_, p_192637_5_, p_192637_6_, isMouseYWithinSlotBounds(p_192637_6_) && getSlotIndexFromScreenCoords(p_192637_5_, p_192637_6_) == p_192637_1_, p_192637_7_);
    }
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseEvent) {
        if (isMouseYWithinSlotBounds(mouseY)) {
            ...
            if (i >= 0) {
                ...
                int k = top + 4 - getAmountScrolled() + i * entryHeight + headerPadding;
                int l = mouseX - j;
                int i1 = mouseY - k;
    ...
    public interface IGuiListEntry {
        ...
        void draw(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_);
