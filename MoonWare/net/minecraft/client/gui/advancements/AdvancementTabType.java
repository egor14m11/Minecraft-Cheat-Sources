...
enum AdvancementTabType
{
    ...
    {
        field_192660_f = p_i47386_3_;
        field_192661_g = p_i47386_4_;
        field_192662_h = p_i47386_5_;
        field_192663_i = p_i47386_6_;
        field_192664_j = p_i47386_7_;
    }

    public int func_192650_a()
    {
        return field_192664_j;
    }

    public void func_192651_a(Gui p_192651_1_, int p_192651_2_, int p_192651_3_, boolean p_192651_4_, int p_192651_5_)
    {
        int i = field_192660_f;
        ...
        if (p_192651_5_ == field_192664_j - 1)
        {
            i += field_192662_h;
        }

        int j = p_192651_4_ ? field_192661_g + field_192663_i : field_192661_g;
        p_192651_1_.drawTexturedModalRect(p_192651_2_ + func_192648_a(p_192651_5_), p_192651_3_ + func_192653_b(p_192651_5_), i, j, field_192662_h, field_192663_i);
    }

    public void func_192652_a(int p_192652_1_, int p_192652_2_, int p_192652_3_, RenderItem p_192652_4_, ItemStack p_192652_5_)
    {
        int i = p_192652_1_ + func_192648_a(p_192652_3_);
        int j = p_192652_2_ + func_192653_b(p_192652_3_);
    ...
    public int func_192648_a(int p_192648_1_)
    {
        ...
        {
            case ABOVE:
                return (field_192662_h + 4) * p_192648_1_;

            case BELOW:
                return (field_192662_h + 4) * p_192648_1_;

            case LEFT:
                return -field_192662_h + 4;
    ...
    public int func_192653_b(int p_192653_1_)
    {
        ...
        {
            case ABOVE:
                return -field_192663_i + 4;

            case BELOW:
                return 136;

            case LEFT:
                return field_192663_i * p_192653_1_;
    ...
    {
        int i = p_192654_1_ + func_192648_a(p_192654_3_);
        int j = p_192654_2_ + func_192653_b(p_192654_3_);
        return p_192654_4_ > i && p_192654_4_ < i + field_192662_h && p_192654_5_ > j && p_192654_5_ < j + field_192663_i;
    }
