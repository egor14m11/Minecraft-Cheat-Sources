...
public class PositionedSoundRecord extends PositionedSound {
    ...
    public PositionedSoundRecord(Namespaced soundId, SoundCategory categoryIn, float volumeIn, float pitchIn, boolean repeatIn, int repeatDelayIn, ISound.AttenuationType attenuationTypeIn, float xIn, float yIn, float zIn) {
