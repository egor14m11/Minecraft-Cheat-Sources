...
public class EntitySelector
{
    ...
    @Nullable
    public static Component matchEntitiesToTextComponent(ICommandSender sender, String token) throws CommandException
    {
    ...
    private static <T extends Entity> boolean isEntityTypeValid(ICommandSender commandSender, Map<String, String> params)
    {
        ...
        {
            Namespaced resourcelocation = new Namespaced(s.startsWith("!") ? s.substring(1) : s);
            ...
            {
                TranslatableComponent textcomponenttranslation = new TranslatableComponent("commands.generic.entity.invalidType", resourcelocation);
    ...
    private static List<Predicate<Entity>> getTypePredicates(Map<String, String> params, String type)
    {
        ...
        else
        {
            ...
            Namespaced resourcelocation = new Namespaced(flag ? s.substring(1) : s);
    ...
    private static List<Predicate<Entity>> getXpLevelPredicates(Map<String, String> params)
    {
        ...
        int i = getInt(params, field_190834_h, -1);
        int j = getInt(params, field_190833_g, -1);
    ...
    private static List<Predicate<Entity>> getRotationsPredicates(Map<String, String> params)
    {
        ...
        {
            int i = MathHelper.clampAngle(getInt(params, field_190844_r, 0));
            int j = MathHelper.clampAngle(getInt(params, field_190843_q, 359));
            list.add(new Predicate<Entity>()
            {
                public boolean apply(@Nullable Entity p_apply_1_)
                {
        ...
        {
            int k = MathHelper.clampAngle(getInt(params, field_190842_p, 0));
            int l = MathHelper.clampAngle(getInt(params, field_190841_o, 359));
            list.add(new Predicate<Entity>()
            {
                public boolean apply(@Nullable Entity p_apply_1_)
                {
