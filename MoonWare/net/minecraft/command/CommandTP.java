        ...
        else
        {
            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                else if (entity.world != null)
                {
                    ...
                    CommandBase.CoordinateArg commandbase$coordinatearg1 = CommandBase.parseCoordinate(entity.posY, args[k++], -4096, 4096, false);
                    CommandBase.CoordinateArg commandbase$coordinatearg2 = CommandBase.parseCoordinate(entity.posZ, args[k++], true);
                    CommandBase.CoordinateArg commandbase$coordinatearg3 = CommandBase.parseCoordinate(entity.rotationYaw, args.length > k ? args[k++] : "~", false);
                    CommandBase.CoordinateArg commandbase$coordinatearg4 = CommandBase.parseCoordinate(entity.rotationPitch, args.length > k ? args[k] : "~", false);
                    ...
                    CommandBase.notifyCommandListener(sender, this, "commands.tp.success.coordinates", entity.getName(), commandbase$coordinatearg.getResult(), commandbase$coordinatearg1.getResult(), commandbase$coordinatearg2.getResult());
                }
            }
            else
            {
                Entity entity1 = CommandBase.getEntity(server, sender, args[args.length - 1]);
                ...
                else
                {
                    ...
                    CommandBase.notifyCommandListener(sender, this, "commands.tp.success", entity.getName(), entity1.getName());
                }
            }
        }
    }
