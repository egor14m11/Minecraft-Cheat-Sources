...
public class AdvancementCommand extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            if (advancementcommand$actiontype != null)
            {
                ...
                EntityPlayerMP entityplayermp = CommandBase.getPlayer(server, sender, args[1]);
            ...
            else
            {
                ...
                if (args.length == 3)
                {
                    func_192552_c(sender, CommandBase.getPlayer(server, sender, args[1]), func_192551_a(server, args[2]));
                }
                else
                {
                    if (args.length != 4)
                    ...
                    func_192554_c(sender, CommandBase.getPlayer(server, sender, args[1]), func_192551_a(server, args[2]), args[3]);
                }
            }
        }
    }
    ...
    private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, AdvancementCommand.ActionType p_193516_5_, AdvancementCommand.Mode p_193516_6_) throws CommandException
    {
        ...
        else
        {
            ...
            if (p_193516_6_ == AdvancementCommand.Mode.ONLY && p_193516_3_.length == 5)
            {
                ...
                {
                    throw new CommandException("commands.advancement.criterionNotFound", advancement.getId(), p_193516_3_[4]);
                }

                if (!p_193516_5_.func_193535_a(p_193516_4_, advancement, s))
                {
                    throw new CommandException(p_193516_5_.field_193541_d + ".criterion.failed", advancement.getId(), p_193516_4_.getName(), s);
                }

                CommandBase.notifyCommandListener(p_193516_2_, this, p_193516_5_.field_193541_d + ".criterion.success", advancement.getId(), p_193516_4_.getName(), s);
            }
            else
            {
                ...
                if (i == 0)
                {
                    throw p_193516_6_.func_193543_a(p_193516_5_, advancement.getId(), p_193516_4_.getName());
                }

                p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, advancement.getId(), p_193516_4_.getName(), i);
            }
        }
    }
    ...
    public List<String> getTabCompletionOptions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos)
    {
        ...
        else
        {
            ...
            if (advancementcommand$actiontype != null)
            {
                ...
                if (args.length == 3)
                {
                    return CommandBase.getListOfStringsMatchingLastWord(args, AdvancementCommand.Mode.field_193553_f);
                }
                ...
                if (advancementcommand$mode != null && advancementcommand$mode != AdvancementCommand.Mode.EVERYTHING)
                {
                    if (args.length == 4)
                    {
                        return CommandBase.getListOfStringsMatchingLastWord(args, func_193517_a(server));
                    }

                    if (args.length == 5 && advancementcommand$mode == AdvancementCommand.Mode.ONLY)
                    {
                        Advancement advancement = server.func_191949_aK().func_192778_a(new Namespaced(args[3]));
            ...
            if ("test".equals(args[0]))
            {
                ...
                if (args.length == 4)
                {
                    Advancement advancement1 = server.func_191949_aK().func_192778_a(new Namespaced(args[2]));

                    if (advancement1 != null)
                    {
                        return CommandBase.getListOfStringsMatchingLastWord(args, advancement1.getCriteria().keySet());
                    }
                }
            }
    ...
    private List<Namespaced> func_193517_a(MinecraftServer p_193517_1_)
    {
        List<Namespaced> list = Lists.newArrayList();
    ...
    {
        Advancement advancement = p_192551_0_.func_191949_aK().func_192778_a(new Namespaced(p_192551_1_));
    ...
    enum ActionType
    {
        ...
        {
            field_193540_c = p_i47557_3_;
            field_193541_d = "commands.advancement." + p_i47557_3_;
        }
        ...
        {
            return new CommandException(field_193541_d + ".usage");
        }
    ...
    enum Mode
    {
        ...
        {
            field_193554_g = p_i47556_3_;
            field_193555_h = p_i47556_4_;
            field_193556_i = p_i47556_5_;
        }

        CommandException func_193543_a(AdvancementCommand.ActionType p_193543_1_, Object... p_193543_2_)
        {
            return new CommandException(p_193543_1_.field_193541_d + "." + field_193554_g + ".failed", p_193543_2_);
        }

        CommandException func_193544_a(AdvancementCommand.ActionType p_193544_1_)
        {
            return new CommandException(p_193544_1_.field_193541_d + "." + field_193554_g + ".usage");
        }
        ...
        {
            CommandBase.notifyCommandListener(p_193546_1_, p_193546_2_, p_193546_3_.field_193541_d + "." + field_193554_g + ".success", p_193546_4_);
        }
