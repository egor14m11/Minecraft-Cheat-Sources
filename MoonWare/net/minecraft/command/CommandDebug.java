    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            if ("start".equals(args[0]))
            {
                ...
                CommandBase.notifyCommandListener(sender, this, "commands.debug.start");
            ...
            else
            {
                ...
                CommandBase.notifyCommandListener(sender, this, "commands.debug.stop", String.format("%.2f", (float)k / 1000.0F), l);
            }
        }
    }
        ...
        if (list != null && list.size() >= 3)
        {
            for (int i = 1; i < list.size(); ++i)
            {
                ...
                if (!"unspecified".equals(profiler$result.profilerName))
                {
                    try
                    {
                        appendProfilerResults(p_184895_1_ + 1, sectionName + "." + profiler$result.profilerName, builder, server);
                    }
