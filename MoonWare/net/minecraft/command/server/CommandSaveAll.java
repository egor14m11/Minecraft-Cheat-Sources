...
public class CommandSaveAll extends CommandBase
{
    ...
    {
        sender.addChatMessage(new TranslatableComponent("commands.save.start"));
        ...
        try
        {
            ...
            {
                sender.addChatMessage(new TranslatableComponent("commands.save.flushStart"));
                ...
                sender.addChatMessage(new TranslatableComponent("commands.save.flushEnd"));
            }
        }
        ...
        CommandBase.notifyCommandListener(sender, this, "commands.save.success");
    }
