...
public abstract class CommandBase implements ICommand
{
    ...
    public static Component getChatComponentFromNthArg(ICommandSender sender, String[] args, int index) throws CommandException {
        return getChatComponentFromNthArg(sender, args, index, false);
    }

    public static Component getChatComponentFromNthArg(ICommandSender sender, String[] args, int index, boolean p_147176_3_) throws CommandException
    {
        ...
        for (int i = index; i < args.length; ++i)
        {
            ...
            Component itextcomponent1 = new TextComponent(args[i]);

            if (p_147176_3_)
            {
                Component itextcomponent2 = EntitySelector.matchEntitiesToTextComponent(sender, args[i]);
    ...
    {
        Namespaced resourcelocation = new Namespaced(id);
    ...
    public static Predicate<IBlockState> func_190791_b(Block p_190791_0_, String p_190791_1_) throws InvalidBlockStateException
    {
        if (!"*".equals(p_190791_1_) && !"-1".equals(p_190791_1_))
        {
            ...
            {
                Map < IProperty<?>, Comparable<? >> map = func_190795_c(p_190791_0_, p_190791_1_);
                return new Predicate<IBlockState>()
                {
                    public boolean apply(@Nullable IBlockState p_apply_1_)
                    {
    ...
    public static Component join(List<Component> components)
    {
        ...
        for (int i = 0; i < components.size(); ++i)
        {
            ...
            itextcomponent.append(components.get(i));
        }
    ...
    public static List<String> getListOfStringsMatchingLastWord(String[] inputArgs, Collection<?> possibleCompletions)
    {
        ...
        if (!possibleCompletions.isEmpty())
        {
            ...
            if (list.isEmpty())
            {
                ...
                {
                    if (object instanceof Namespaced && doesStringStartWith(s, ((Namespaced)object).getPath()))
                    {
