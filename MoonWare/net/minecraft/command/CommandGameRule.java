...
public class CommandGameRule extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        String s1 = args.length > 1 ? CommandBase.buildString(args, 1) : "";

        switch (args.length)
        {
            case 0:
                sender.addChatMessage(new TextComponent(CommandBase.joinNiceString(gamerules.getRules())));
                break;
            ...
            case 1:
                ...
                sender.addChatMessage((new TextComponent(s)).append(" = ").append(s2));
            ...
            default:
                ...
                CommandBase.notifyCommandListener(sender, this, "commands.gamerule.success", s, s1);
        }
    }
    ...
    public List<String> getTabCompletionOptions(MinecraftServer server, ICommandSender sender, String[] args, @Nullable BlockPos pos)
    {
        if (args.length == 1)
        {
            return CommandBase.getListOfStringsMatchingLastWord(args, getOverWorldGameRules(server).getRules());
        }
        else
        {
            if (args.length == 2)
