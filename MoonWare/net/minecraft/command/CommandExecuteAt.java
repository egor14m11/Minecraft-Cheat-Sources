...
public class CommandExecuteAt extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        {
            Entity entity = CommandBase.getEntity(server, sender, args[0], Entity.class);
            double d0 = CommandBase.parseDouble(entity.posX, args[1], false);
            double d1 = CommandBase.parseDouble(entity.posY, args[2], false);
            double d2 = CommandBase.parseDouble(entity.posZ, args[3], false);
