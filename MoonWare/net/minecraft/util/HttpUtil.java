...
public class HttpUtil
{
    ...
    public static ListenableFuture<Object> downloadResourcePack(File saveFile, String packUrl, Map<String, String> p_180192_2_, int maxSize, @Nullable Progress p_180192_4_, Proxy p_180192_5_)
    {
        ListenableFuture<?> listenablefuture = DOWNLOADER_EXECUTOR.submit(new Runnable()
        {
            public void run()
            {
                ...
                if (p_180192_4_ != null)
                {
                    p_180192_4_.setTitle(I18n.translateToLocal("resourcepack.downloading"));
                    p_180192_4_.setText(I18n.translateToLocal("resourcepack.requesting"));
                }
                ...
                try
                {
                    try
                    {
                        ...
                        for (Map.Entry<String, String> entry : p_180192_2_.entrySet())
                        {
                            ...
                            if (p_180192_4_ != null)
                            {
                                p_180192_4_.setProgress((int)(++f / f1 * 100.0F));
                            }
                        }
                        ...
                        if (p_180192_4_ != null)
                        {
                            p_180192_4_.setText(I18n.translateToLocalFormatted("resourcepack.progress", String.format("%.2f", f1 / 1000.0F / 1000.0F)));
                        }
                        ...
                        if (saveFile.exists())
                        {
                            ...
                            LOGGER.warn("Deleting {} as it does not match what we currently have ({} vs our {}).", saveFile, Integer.valueOf(i), Long.valueOf(j));
