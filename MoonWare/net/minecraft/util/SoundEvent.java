...
{
    public static final RegistryNamespaced<Namespaced, SoundEvent> REGISTRY = new RegistryNamespaced<Namespaced, SoundEvent>();
    private final Namespaced soundName;
    private static int soundEventId;

    public SoundEvent(Namespaced soundNameIn)
    {
        soundName = soundNameIn;
    }

    public Namespaced getSoundName()
    {
        return soundName;
    }
    ...
    {
        Namespaced resourcelocation = new Namespaced(soundNameIn);
