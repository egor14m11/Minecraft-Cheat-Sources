...
public class BlockPos extends Vec3i
{
    ...
    public static Iterable<BlockPos> func_191532_a(int p_191532_0_, int p_191532_1_, int p_191532_2_, int p_191532_3_, int p_191532_4_, int p_191532_5_)
    {
            ...
            public Iterator<BlockPos> iterator()
            {
                return new AbstractIterator<BlockPos>()
                {
                    ...
                    protected BlockPos computeNext()
                    {
                        if (field_191534_b)
                        {
                            field_191534_b = false;
                            field_191535_c = p_191532_0_;
                            field_191536_d = p_191532_1_;
                            field_191537_e = p_191532_2_;
                            return new BlockPos(p_191532_0_, p_191532_1_, p_191532_2_);
                        }
                        else if (field_191535_c == p_191532_3_ && field_191536_d == p_191532_4_ && field_191537_e == p_191532_5_)
                        {
                            return endOfData();
                        }
                        else
                        {
                            if (field_191535_c < p_191532_3_)
                            {
                                ++field_191535_c;
                            }
                            else if (field_191536_d < p_191532_4_)
                            {
                                field_191535_c = p_191532_0_;
                                ++field_191536_d;
                            }
                            else if (field_191537_e < p_191532_5_)
                            {
                                field_191535_c = p_191532_0_;
                                field_191536_d = p_191532_1_;
                                ++field_191537_e;
                            ...
                            return new BlockPos(field_191535_c, field_191536_d, field_191537_e);
                        }
                    }
                };
            }
    ...
    public static Iterable<BlockPos.MutableBlockPos> func_191531_b(int p_191531_0_, int p_191531_1_, int p_191531_2_, int p_191531_3_, int p_191531_4_, int p_191531_5_)
    {
            ...
            public Iterator<BlockPos.MutableBlockPos> iterator()
            {
                return new AbstractIterator<BlockPos.MutableBlockPos>()
                {
                    ...
                    protected BlockPos.MutableBlockPos computeNext()
                    {
                        if (theBlockPos == null)
                        {
                            theBlockPos = new BlockPos.MutableBlockPos(p_191531_0_, p_191531_1_, p_191531_2_);
                            return theBlockPos;
                        }
                        else if (theBlockPos.x == p_191531_3_ && theBlockPos.y == p_191531_4_ && theBlockPos.z == p_191531_5_)
                        {
                            return endOfData();
                        }
                        else
                        {
                            if (theBlockPos.x < p_191531_3_)
                            {
                                ++theBlockPos.x;
                            }
                            else if (theBlockPos.y < p_191531_4_)
                            {
                                theBlockPos.x = p_191531_0_;
                                ++theBlockPos.y;
                            }
                            else if (theBlockPos.z < p_191531_5_)
                            {
                                theBlockPos.x = p_191531_0_;
                                theBlockPos.y = p_191531_1_;
                                ++theBlockPos.z;
                            }
    ...
    public static class MutableBlockPos extends BlockPos
    {
        ...
        {
            return setPos(x + facing.getFrontOffsetX() * p_189534_2_, y + facing.getFrontOffsetY() * p_189534_2_, z + facing.getFrontOffsetZ() * p_189534_2_);
        }
