...
public class NonNullList<E> extends AbstractList<E>
{
    ...
    {
        Preconditions.checkNotNull(p_191197_1_);
    ...
    {
        field_191198_a = p_i47327_1_;
        field_191199_b = p_i47327_2_;
    }

    @Nonnull
    public E get(int p_get_1_)
    {
        return field_191198_a.get(p_get_1_);
    }

    public E set(int p_set_1_, E p_set_2_)
    {
        Preconditions.checkNotNull(p_set_2_);
        return field_191198_a.set(p_set_1_, p_set_2_);
    }

    public void add(int p_add_1_, E p_add_2_)
    {
        Preconditions.checkNotNull(p_add_2_);
        field_191198_a.add(p_add_1_, p_add_2_);
    }

    public E remove(int p_remove_1_)
    {
        return field_191198_a.remove(p_remove_1_);
    }

    public int size()
    {
        return field_191198_a.size();
    }

    public void clear()
    {
        if (field_191199_b == null)
        {
            super.clear();
        }
        else
