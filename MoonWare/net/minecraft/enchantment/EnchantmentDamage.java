...
public class EnchantmentDamage extends Enchantment
{
    ...
    private static final String[] PROTECTION_NAME = {"all", "undead", "arthropods"};

    /**
     * Holds the base factor of enchantability needed to be able to use the enchant.
     */
    private static final int[] BASE_ENCHANTABILITY = {1, 5, 5};

    /**
     * Holds how much each level increased the enchantability factor to be able to use this enchant.
     */
    private static final int[] LEVEL_ENCHANTABILITY = {11, 8, 8};

    /**
     * Used on the formula of base enchantability, this is the 'window' factor of values to be able to use thing
     * enchant.
     */
    private static final int[] THRESHOLD_ENCHANTABILITY = {20, 20, 20};
    ...
    {
        return BASE_ENCHANTABILITY[damageType] + (enchantmentLevel - 1) * LEVEL_ENCHANTABILITY[damageType];
    }
    ...
    {
        return getMinEnchantability(enchantmentLevel) + THRESHOLD_ENCHANTABILITY[damageType];
    }
    ...
    {
        return "enchantment.damage." + PROTECTION_NAME[damageType];
    }
