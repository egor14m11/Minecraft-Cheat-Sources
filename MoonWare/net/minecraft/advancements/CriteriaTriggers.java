...
{
    private static final Map <Namespaced, ICriterionTrigger<? >> field_192139_s = Maps.newHashMap();
    public static final ImpossibleTrigger field_192121_a = func_192118_a(new ImpossibleTrigger());
    public static final KilledTrigger field_192122_b = func_192118_a(new KilledTrigger(new Namespaced("player_killed_entity")));
    public static final KilledTrigger field_192123_c = func_192118_a(new KilledTrigger(new Namespaced("entity_killed_player")));
    ...
    public static final PositionTrigger field_192135_o = func_192118_a(new PositionTrigger(new Namespaced("location")));
    public static final PositionTrigger field_192136_p = func_192118_a(new PositionTrigger(new Namespaced("slept_in_bed")));
    ...
    @Nullable
    public static <T extends ICriterionInstance> ICriterionTrigger<T> func_192119_a(Namespaced p_192119_0_)
    {
