...
public class AdvancementProgress implements Comparable<AdvancementProgress>
{
    ...
    public void func_192099_a(Map<String, Criterion> p_192099_1_, String[][] p_192099_2_)
    {
        ...
        Iterator<Map.Entry<String, CriterionProgress>> iterator = field_192110_a.entrySet().iterator();
        ...
        for (String s : set)
        {
            if (!field_192110_a.containsKey(s))
            {
                field_192110_a.put(s, new CriterionProgress(this));
            }
        }

        field_192111_b = p_192099_2_;
    }

    public boolean func_192105_a()
    {
        if (field_192111_b.length == 0)
        {
            return false;
        }
        else
        {
            for (String[] astring : field_192111_b)
            {
                boolean flag = false;
    ...
    {
        for (CriterionProgress criterionprogress : field_192110_a.values())
        {
    ...
    {
        CriterionProgress criterionprogress = field_192110_a.get(p_192109_1_);
    ...
    {
        CriterionProgress criterionprogress = field_192110_a.get(p_192101_1_);
    ...
    {
        return "AdvancementProgress{criteria=" + field_192110_a + ", requirements=" + Arrays.deepToString(field_192111_b) + '}';
    }

    public void func_192104_a(PacketBuffer p_192104_1_)
    {
        p_192104_1_.writeVarIntToBuffer(field_192110_a.size());

        for (Map.Entry<String, CriterionProgress> entry : field_192110_a.entrySet())
        {
    ...
    {
        return field_192110_a.get(p_192106_1_);
    }

    public float func_192103_c()
    {
        if (field_192110_a.isEmpty())
        {
            return 0.0F;
        }
        else
        {
            float f = (float) field_192111_b.length;
            float f1 = (float) func_194032_h();
            return f1 / f;
        }
    }
