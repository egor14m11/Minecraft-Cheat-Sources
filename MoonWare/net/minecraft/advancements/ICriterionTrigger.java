...
public interface ICriterionTrigger<T extends ICriterionInstance>
{
    ...
    class Listener<T extends ICriterionInstance>
    {
        ...
        {
            field_192160_a = p_i47405_1_;
            field_192161_b = p_i47405_2_;
            field_192162_c = p_i47405_3_;
        }

        public T func_192158_a()
        {
            return field_192160_a;
        }

        public void func_192159_a(PlayerAdvancements p_192159_1_)
        {
            p_192159_1_.func_192750_a(field_192161_b, field_192162_c);
        }
        ...
        public boolean equals(Object p_equals_1_)
        {
            ...
            else if (p_equals_1_ != null && getClass() == p_equals_1_.getClass())
            {
                ...
                if (!field_192160_a.equals(listener.field_192160_a))
                {
                    return false;
                }
                else
                {
                    return field_192161_b.equals(listener.field_192161_b) && field_192162_c.equals(listener.field_192162_c);
                }
            }
            else
            {
        ...
        public int hashCode()
        {
            int i = field_192160_a.hashCode();
            i = 31 * i + field_192161_b.hashCode();
            i = 31 * i + field_192162_c.hashCode();
            return i;
        }
    }
}
