...
{
    private static final Namespaced field_192181_a = new Namespaced("construct_beacon");
    ...
    {
        ConstructBeaconTrigger.Listeners constructbeacontrigger$listeners = field_192182_b.get(p_192165_1_);
        ...
        if (constructbeacontrigger$listeners == null)
        {
            ...
            field_192182_b.put(p_192165_1_, constructbeacontrigger$listeners);
        }
    ...
    {
        ConstructBeaconTrigger.Listeners constructbeacontrigger$listeners = field_192182_b.get(p_192164_1_);
        ...
        if (constructbeacontrigger$listeners != null)
        {
            ...
            {
                field_192182_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192182_b.remove(p_192167_1_);
    }
    ...
    {
        ConstructBeaconTrigger.Listeners constructbeacontrigger$listeners = field_192182_b.get(p_192180_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(MinMaxBounds p_i47373_1_)
        {
            ...
            field_192253_a = p_i47373_1_;
        }

        public boolean func_192252_a(TileEntityBeacon p_192252_1_)
        {
            return field_192253_a.func_192514_a((float)p_192252_1_.func_191979_s());
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192352_a(TileEntityBeacon p_192352_1_)
        {
            ...
            for (ICriterionTrigger.Listener<ConstructBeaconTrigger.Instance> listener : field_192357_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192356_a);
                }
            }
        }
    }
