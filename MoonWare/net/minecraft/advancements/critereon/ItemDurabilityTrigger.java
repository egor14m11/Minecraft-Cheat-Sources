...
{
    private static final Namespaced field_193159_a = new Namespaced("item_durability_changed");
    ...
    {
        ItemDurabilityTrigger.Listeners itemdurabilitytrigger$listeners = field_193160_b.get(p_192165_1_);

        if (itemdurabilitytrigger$listeners == null)
        {
            itemdurabilitytrigger$listeners = new ItemDurabilityTrigger.Listeners(p_192165_1_);
            field_193160_b.put(p_192165_1_, itemdurabilitytrigger$listeners);
        }
    ...
    {
        ItemDurabilityTrigger.Listeners itemdurabilitytrigger$listeners = field_193160_b.get(p_192164_1_);
        ...
        if (itemdurabilitytrigger$listeners != null)
        {
            ...
            {
                field_193160_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193160_b.remove(p_192167_1_);
    }
    ...
    {
        ItemDurabilityTrigger.Listeners itemdurabilitytrigger$listeners = field_193160_b.get(p_193158_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(ItemPredicate p_i47511_1_, MinMaxBounds p_i47511_2_, MinMaxBounds p_i47511_3_)
        {
            ...
            field_193198_a = p_i47511_1_;
            field_193199_b = p_i47511_2_;
            field_193200_c = p_i47511_3_;
        }

        public boolean func_193197_a(ItemStack p_193197_1_, int p_193197_2_)
        {
            if (!field_193198_a.func_192493_a(p_193197_1_))
            {
                return false;
            }
            else if (!field_193199_b.func_192514_a((float)(p_193197_1_.getMaxDamage() - p_193197_2_)))
            {
                return false;
            }
            else
            {
                return field_193200_c.func_192514_a((float)(p_193197_1_.getItemDamage() - p_193197_2_));
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193441_a(ItemStack p_193441_1_, int p_193441_2_)
        {
            ...
            for (ICriterionTrigger.Listener<ItemDurabilityTrigger.Instance> listener : field_193443_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193442_a);
                }
            }
        }
    }
