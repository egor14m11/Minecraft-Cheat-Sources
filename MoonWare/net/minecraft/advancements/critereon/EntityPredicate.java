...
public class EntityPredicate
{
    ...
    private final Namespaced field_192484_b;
    ...
    public EntityPredicate(@Nullable Namespaced p_i47541_1_, DistancePredicate p_i47541_2_, LocationPredicate p_i47541_3_, MobEffectsPredicate p_i47541_4_, NBTPredicate p_i47541_5_)
    {
        field_192484_b = p_i47541_1_;
        field_192485_c = p_i47541_2_;
        field_193435_d = p_i47541_3_;
        field_193436_e = p_i47541_4_;
        field_193437_f = p_i47541_5_;
    }
    ...
    public boolean func_192482_a(EntityPlayerMP p_192482_1_, @Nullable Entity p_192482_2_)
    {
        ...
        else if (field_192484_b != null && !EntityList.isStringEntityName(p_192482_2_, field_192484_b))
        {
            return false;
        }
        else if (!field_192485_c.func_193422_a(p_192482_1_.posX, p_192482_1_.posY, p_192482_1_.posZ, p_192482_2_.posX, p_192482_2_.posY, p_192482_2_.posZ))
        {
            return false;
        }
        else if (!field_193435_d.func_193452_a(p_192482_1_.getServerWorld(), p_192482_2_.posX, p_192482_2_.posY, p_192482_2_.posZ))
        {
            return false;
        }
        else if (!field_193436_e.func_193469_a(p_192482_2_))
        {
            return false;
        }
        else
        {
            return field_193437_f.func_193475_a(p_192482_2_);
        }
    }
    ...
    public static EntityPredicate func_192481_a(@Nullable JsonElement p_192481_0_)
    {
        if (p_192481_0_ != null && !p_192481_0_.isJsonNull())
        {
            ...
            Namespaced resourcelocation = null;

            if (jsonobject.has("type"))
            {
                resourcelocation = new Namespaced(JsonUtils.getString(jsonobject, "type"));
