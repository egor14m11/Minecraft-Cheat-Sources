...
{
    private static final Namespaced field_192227_a = new Namespaced("recipe_unlocked");
    ...
    {
        RecipeUnlockedTrigger.Listeners recipeunlockedtrigger$listeners = field_192228_b.get(p_192165_1_);

        if (recipeunlockedtrigger$listeners == null)
        {
            recipeunlockedtrigger$listeners = new RecipeUnlockedTrigger.Listeners(p_192165_1_);
            field_192228_b.put(p_192165_1_, recipeunlockedtrigger$listeners);
        }
    ...
    {
        RecipeUnlockedTrigger.Listeners recipeunlockedtrigger$listeners = field_192228_b.get(p_192164_1_);
        ...
        if (recipeunlockedtrigger$listeners != null)
        {
            ...
            {
                field_192228_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192228_b.remove(p_192167_1_);
    }

    public RecipeUnlockedTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_)
    {
        Namespaced resourcelocation = new Namespaced(JsonUtils.getString(p_192166_1_, "recipe"));
    ...
    {
        RecipeUnlockedTrigger.Listeners recipeunlockedtrigger$listeners = field_192228_b.get(p_192225_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(IRecipe p_i47526_1_)
        {
            ...
            field_192282_a = p_i47526_1_;
        }

        public boolean func_193215_a(IRecipe p_193215_1_)
        {
            return field_192282_a == p_193215_1_;
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193493_a(IRecipe p_193493_1_)
        {
            ...
            for (ICriterionTrigger.Listener<RecipeUnlockedTrigger.Instance> listener : field_192530_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192529_a);
                }
            }
        }
    }
