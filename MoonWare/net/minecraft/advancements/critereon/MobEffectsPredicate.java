...
public class MobEffectsPredicate
{
    ...
    public boolean func_193469_a(Entity p_193469_1_)
    {
        ...
        {
            return p_193469_1_ instanceof EntityLivingBase && func_193470_a(((EntityLivingBase) p_193469_1_).func_193076_bZ());
        }
    }

    public boolean func_193472_a(EntityLivingBase p_193472_1_)
    {
        return this == field_193473_a || func_193470_a(p_193472_1_.func_193076_bZ());
    }
    ...
    public boolean func_193470_a(Map<Potion, PotionEffect> p_193470_1_)
    {
        ...
        {
            for (Map.Entry<Potion, MobEffectsPredicate.InstancePredicate> entry : field_193474_b.entrySet())
            {
    ...
    public static MobEffectsPredicate func_193471_a(@Nullable JsonElement p_193471_0_)
    {
        if (p_193471_0_ != null && !p_193471_0_.isJsonNull())
        {
            ...
            {
                Namespaced resourcelocation = new Namespaced(entry.getKey());
    ...
    public static class InstancePredicate
    {
        ...
        {
            field_193465_a = p_i47497_1_;
            field_193466_b = p_i47497_2_;
            field_193467_c = p_i47497_3_;
            field_193468_d = p_i47497_4_;
        }
        ...
        public boolean func_193463_a(@Nullable PotionEffect p_193463_1_)
        {
            ...
            else if (!field_193465_a.func_192514_a((float)p_193463_1_.getAmplifier()))
            {
                return false;
            }
            else if (!field_193466_b.func_192514_a((float)p_193463_1_.getDuration()))
            {
                return false;
            }
            else if (field_193467_c != null && field_193467_c.booleanValue() != p_193463_1_.getIsAmbient())
            {
                return false;
            }
            else
            {
                return field_193468_d == null || field_193468_d.booleanValue() == p_193463_1_.doesShowParticles();
            }
        }
