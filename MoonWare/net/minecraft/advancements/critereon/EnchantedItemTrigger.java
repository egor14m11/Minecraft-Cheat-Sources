...
{
    private static final Namespaced field_192191_a = new Namespaced("enchanted_item");
    ...
    {
        EnchantedItemTrigger.Listeners enchanteditemtrigger$listeners = field_192192_b.get(p_192165_1_);

        if (enchanteditemtrigger$listeners == null)
        {
            enchanteditemtrigger$listeners = new EnchantedItemTrigger.Listeners(p_192165_1_);
            field_192192_b.put(p_192165_1_, enchanteditemtrigger$listeners);
        }
    ...
    {
        EnchantedItemTrigger.Listeners enchanteditemtrigger$listeners = field_192192_b.get(p_192164_1_);
        ...
        if (enchanteditemtrigger$listeners != null)
        {
            ...
            {
                field_192192_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192192_b.remove(p_192167_1_);
    }
    ...
    {
        EnchantedItemTrigger.Listeners enchanteditemtrigger$listeners = field_192192_b.get(p_192190_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(ItemPredicate p_i47376_1_, MinMaxBounds p_i47376_2_)
        {
            ...
            field_192258_a = p_i47376_1_;
            field_192259_b = p_i47376_2_;
        }

        public boolean func_192257_a(ItemStack p_192257_1_, int p_192257_2_)
        {
            if (!field_192258_a.func_192493_a(p_192257_1_))
            {
                return false;
            }
            else
            {
                return field_192259_b.func_192514_a((float)p_192257_2_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192459_a(ItemStack p_192459_1_, int p_192459_2_)
        {
            ...
            for (ICriterionTrigger.Listener<EnchantedItemTrigger.Instance> listener : field_192462_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192461_a);
                }
            }
        }
    }
