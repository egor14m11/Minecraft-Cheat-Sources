...
{
    public static final Namespaced field_193183_a = new Namespaced("tick");
    ...
    {
        TickTrigger.Listeners ticktrigger$listeners = field_193184_b.get(p_192165_1_);

        if (ticktrigger$listeners == null)
        {
            ticktrigger$listeners = new TickTrigger.Listeners(p_192165_1_);
            field_193184_b.put(p_192165_1_, ticktrigger$listeners);
        }
    ...
    {
        TickTrigger.Listeners ticktrigger$listeners = field_193184_b.get(p_192164_1_);
        ...
        if (ticktrigger$listeners != null)
        {
            ...
            {
                field_193184_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193184_b.remove(p_192167_1_);
    }
    ...
    {
        TickTrigger.Listeners ticktrigger$listeners = field_193184_b.get(p_193182_1_.func_192039_O());
    ...
    static class Listeners
    {
        ...
        {
            field_193504_a = p_i47496_1_;
        }

        public boolean func_193501_a()
        {
            return field_193505_b.isEmpty();
        }

        public void func_193502_a(ICriterionTrigger.Listener<TickTrigger.Instance> p_193502_1_)
        {
            field_193505_b.add(p_193502_1_);
        }

        public void func_193500_b(ICriterionTrigger.Listener<TickTrigger.Instance> p_193500_1_)
        {
            field_193505_b.remove(p_193500_1_);
        }

        public void func_193503_b()
        {
            for (ICriterionTrigger.Listener<TickTrigger.Instance> listener : Lists.newArrayList(field_193505_b))
            {
                listener.func_192159_a(field_193504_a);
            }
        }
    }
}
