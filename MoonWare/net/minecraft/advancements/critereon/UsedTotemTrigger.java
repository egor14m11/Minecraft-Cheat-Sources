...
{
    private static final Namespaced field_193188_a = new Namespaced("used_totem");
    ...
    {
        UsedTotemTrigger.Listeners usedtotemtrigger$listeners = field_193189_b.get(p_192165_1_);

        if (usedtotemtrigger$listeners == null)
        {
            usedtotemtrigger$listeners = new UsedTotemTrigger.Listeners(p_192165_1_);
            field_193189_b.put(p_192165_1_, usedtotemtrigger$listeners);
        }
    ...
    {
        UsedTotemTrigger.Listeners usedtotemtrigger$listeners = field_193189_b.get(p_192164_1_);
        ...
        if (usedtotemtrigger$listeners != null)
        {
            ...
            {
                field_193189_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193189_b.remove(p_192167_1_);
    }
    ...
    {
        UsedTotemTrigger.Listeners usedtotemtrigger$listeners = field_193189_b.get(p_193187_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(ItemPredicate p_i47564_1_)
        {
            ...
            field_193219_a = p_i47564_1_;
        }

        public boolean func_193218_a(ItemStack p_193218_1_)
        {
            return field_193219_a.func_192493_a(p_193218_1_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193509_a(ItemStack p_193509_1_)
        {
            ...
            for (ICriterionTrigger.Listener<UsedTotemTrigger.Instance> listener : field_193511_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193510_a);
                }
            }
        }
    }
