...
public class NBTPredicate
{
    ...
    {
        field_193480_b = p_i47536_1_;
    }

    public boolean func_193478_a(ItemStack p_193478_1_)
    {
        return this == field_193479_a || func_193477_a(p_193478_1_.getTagCompound());
    }

    public boolean func_193475_a(Entity p_193475_1_)
    {
        return this == field_193479_a || func_193477_a(CommandBase.entityToNBT(p_193475_1_));
    }
    ...
    public boolean func_193477_a(@Nullable NBTBase p_193477_1_)
    {
        ...
        {
            return field_193480_b == null || NBTUtil.areNBTEquals(field_193480_b, p_193477_1_, true);
        }
    }
