...
{
    private static final Namespaced field_192209_a = new Namespaced("inventory_changed");
    ...
    {
        InventoryChangeTrigger.Listeners inventorychangetrigger$listeners = field_192210_b.get(p_192165_1_);
        ...
        if (inventorychangetrigger$listeners == null)
        {
            ...
            field_192210_b.put(p_192165_1_, inventorychangetrigger$listeners);
        }
    ...
    {
        InventoryChangeTrigger.Listeners inventorychangetrigger$listeners = field_192210_b.get(p_192164_1_);
        ...
        if (inventorychangetrigger$listeners != null)
        {
            ...
            {
                field_192210_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192210_b.remove(p_192167_1_);
    }
    ...
    {
        InventoryChangeTrigger.Listeners inventorychangetrigger$listeners = field_192210_b.get(p_192208_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(MinMaxBounds p_i47390_1_, MinMaxBounds p_i47390_2_, MinMaxBounds p_i47390_3_, ItemPredicate[] p_i47390_4_)
        {
            ...
            field_192266_a = p_i47390_1_;
            field_192267_b = p_i47390_2_;
            field_192268_c = p_i47390_3_;
            field_192269_d = p_i47390_4_;
        }
        ...
        public boolean func_192265_a(InventoryPlayer p_192265_1_)
        {
            ...
            int j = 0;
            int k = 0;
            List<ItemPredicate> list = Lists.newArrayList(field_192269_d);
            ...
            if (!field_192267_b.func_192514_a((float)i))
            {
                return false;
            }
            else if (!field_192268_c.func_192514_a((float)j))
            {
                return false;
            }
            else if (!field_192266_a.func_192514_a((float)k))
            {
                return false;
            }
    ...
    static class Listeners
    {
        ...
        public void func_192486_a(InventoryPlayer p_192486_1_)
        {
            ...
            for (ICriterionTrigger.Listener<InventoryChangeTrigger.Instance> listener : field_192491_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192490_a);
                }
            }
        }
    }
