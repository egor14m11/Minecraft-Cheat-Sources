...
{
    private static final Namespaced field_192196_a = new Namespaced("enter_block");
    ...
    {
        EnterBlockTrigger.Listeners enterblocktrigger$listeners = field_192197_b.get(p_192165_1_);

        if (enterblocktrigger$listeners == null)
        {
            enterblocktrigger$listeners = new EnterBlockTrigger.Listeners(p_192165_1_);
            field_192197_b.put(p_192165_1_, enterblocktrigger$listeners);
        }
    ...
    {
        EnterBlockTrigger.Listeners enterblocktrigger$listeners = field_192197_b.get(p_192164_1_);
        ...
        if (enterblocktrigger$listeners != null)
        {
            ...
            {
                field_192197_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192197_b.remove(p_192167_1_);
    }
    ...
    {
        EnterBlockTrigger.Listeners enterblocktrigger$listeners = field_192197_b.get(p_192193_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(@Nullable Block p_i47451_1_, @Nullable Map < IProperty<?>, Object > p_i47451_2_)
        {
            ...
            field_192261_a = p_i47451_1_;
            field_192262_b = p_i47451_2_;
        }

        public boolean func_192260_a(IBlockState p_192260_1_)
        {
            if (field_192261_a != null && p_192260_1_.getBlock() != field_192261_a)
            {
                return false;
            }
            else
            {
                if (field_192262_b != null)
                {
                    for (Map.Entry < IProperty<?>, Object > entry : field_192262_b.entrySet())
                    {
    ...
    static class Listeners
    {
        ...
        public void func_192471_a(IBlockState p_192471_1_)
        {
            ...
            for (ICriterionTrigger.Listener<EnterBlockTrigger.Instance> listener : field_192474_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192473_a);
                }
            }
        }
    }
