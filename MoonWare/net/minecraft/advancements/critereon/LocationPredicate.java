...
public class LocationPredicate
{
    ...
    {
        field_193457_c = p_i47539_1_;
        field_193458_d = p_i47539_2_;
        field_193459_e = p_i47539_3_;
        field_193456_b = p_i47539_4_;
        field_193460_f = p_i47539_5_;
        field_193461_g = p_i47539_6_;
    }

    public boolean func_193452_a(WorldServer p_193452_1_, double p_193452_2_, double p_193452_4_, double p_193452_6_)
    {
        return func_193453_a(p_193452_1_, (float)p_193452_2_, (float)p_193452_4_, (float)p_193452_6_);
    }

    public boolean func_193453_a(WorldServer p_193453_1_, float p_193453_2_, float p_193453_3_, float p_193453_4_)
    {
        if (!field_193457_c.func_192514_a(p_193453_2_))
        {
            return false;
        }
        else if (!field_193458_d.func_192514_a(p_193453_3_))
        {
            return false;
        }
        else if (!field_193459_e.func_192514_a(p_193453_4_))
        {
            return false;
        }
        else if (field_193461_g != null && field_193461_g != p_193453_1_.provider.getDimensionType())
        {
            return false;
        }
        else
        {
            ...
            if (field_193456_b != null && field_193456_b != p_193453_1_.getBiome(blockpos))
            {
                return false;
            }
            else
            {
                return field_193460_f == null || p_193453_1_.getChunkProvider().func_193413_a(p_193453_1_, field_193460_f, blockpos);
            }
        }
    }
    ...
    public static LocationPredicate func_193454_a(@Nullable JsonElement p_193454_0_)
    {
        if (p_193454_0_ != null && !p_193454_0_.isJsonNull())
        {
            ...
            {
                Namespaced resourcelocation = new Namespaced(JsonUtils.getString(jsonobject, "biome"));
