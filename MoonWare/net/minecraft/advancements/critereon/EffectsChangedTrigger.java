...
{
    private static final Namespaced field_193154_a = new Namespaced("effects_changed");
    ...
    {
        EffectsChangedTrigger.Listeners effectschangedtrigger$listeners = field_193155_b.get(p_192165_1_);

        if (effectschangedtrigger$listeners == null)
        {
            effectschangedtrigger$listeners = new EffectsChangedTrigger.Listeners(p_192165_1_);
            field_193155_b.put(p_192165_1_, effectschangedtrigger$listeners);
        }
    ...
    {
        EffectsChangedTrigger.Listeners effectschangedtrigger$listeners = field_193155_b.get(p_192164_1_);
        ...
        if (effectschangedtrigger$listeners != null)
        {
            ...
            {
                field_193155_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193155_b.remove(p_192167_1_);
    }
    ...
    {
        EffectsChangedTrigger.Listeners effectschangedtrigger$listeners = field_193155_b.get(p_193153_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(MobEffectsPredicate p_i47545_1_)
        {
            ...
            field_193196_a = p_i47545_1_;
        }

        public boolean func_193195_a(EntityPlayerMP p_193195_1_)
        {
            return field_193196_a.func_193472_a(p_193195_1_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193432_a(EntityPlayerMP p_193432_1_)
        {
            ...
            for (ICriterionTrigger.Listener<EffectsChangedTrigger.Instance> listener : field_193434_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193433_a);
                }
            }
        }
    }
