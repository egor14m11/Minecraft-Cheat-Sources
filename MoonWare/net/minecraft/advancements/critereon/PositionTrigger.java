...
public class PositionTrigger implements ICriterionTrigger<PositionTrigger.Instance>
{
    ...
    {
        PositionTrigger.Listeners positiontrigger$listeners = field_192218_b.get(p_192164_1_);
        ...
        if (positiontrigger$listeners != null)
        {
            ...
            {
                field_192218_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192218_b.remove(p_192167_1_);
    }
    ...
    public PositionTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_)
    {
        ...
        return new PositionTrigger.Instance(field_192217_a, locationpredicate);
    }

    public void func_192215_a(EntityPlayerMP p_192215_1_)
    {
        PositionTrigger.Listeners positiontrigger$listeners = field_192218_b.get(p_192215_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(Namespaced p_i47544_1_, LocationPredicate p_i47544_2_)
        {
            super(p_i47544_1_);
            field_193205_a = p_i47544_2_;
        }

        public boolean func_193204_a(WorldServer p_193204_1_, double p_193204_2_, double p_193204_4_, double p_193204_6_)
        {
            return field_193205_a.func_193452_a(p_193204_1_, p_193204_2_, p_193204_4_, p_193204_6_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193462_a(WorldServer p_193462_1_, double p_193462_2_, double p_193462_4_, double p_193462_6_)
        {
            ...
            for (ICriterionTrigger.Listener<PositionTrigger.Instance> listener : field_192512_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192511_a);
                }
            }
        }
    }
