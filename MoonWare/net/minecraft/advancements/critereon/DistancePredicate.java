...
public class DistancePredicate
{
    ...
    {
        field_193424_b = p_i47542_1_;
        field_193425_c = p_i47542_2_;
        field_193426_d = p_i47542_3_;
        field_193427_e = p_i47542_4_;
        field_193428_f = p_i47542_5_;
    }
    ...
    public boolean func_193422_a(double p_193422_1_, double p_193422_3_, double p_193422_5_, double p_193422_7_, double p_193422_9_, double p_193422_11_)
    {
        ...
        if (field_193424_b.func_192514_a(MathHelper.abs(f)) && field_193425_c.func_192514_a(MathHelper.abs(f1)) && field_193426_d.func_192514_a(MathHelper.abs(f2)))
        {
            if (!field_193427_e.func_192513_a(f * f + f2 * f2))
            {
                return false;
            }
            else
            {
                return field_193428_f.func_192513_a(f * f + f1 * f1 + f2 * f2);
            }
        }
        else
        {
