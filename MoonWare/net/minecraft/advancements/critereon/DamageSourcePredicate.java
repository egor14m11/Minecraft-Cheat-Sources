...
public class DamageSourcePredicate
{
    ...
    public DamageSourcePredicate()
    {
        ...
        field_192455_g = null;
        field_192456_h = null;
        field_193419_i = EntityPredicate.field_192483_a;
        field_193420_j = EntityPredicate.field_192483_a;
    }
    ...
    {
        field_192450_b = p_i47543_1_;
        field_192451_c = p_i47543_2_;
        field_192452_d = p_i47543_3_;
        field_192453_e = p_i47543_4_;
        field_192454_f = p_i47543_5_;
        field_192455_g = p_i47543_6_;
        field_192456_h = p_i47543_7_;
        field_193419_i = p_i47543_8_;
        field_193420_j = p_i47543_9_;
    }
    ...
    public boolean func_193418_a(EntityPlayerMP p_193418_1_, DamageSource p_193418_2_)
    {
        ...
        else if (field_192450_b != null && field_192450_b.booleanValue() != p_193418_2_.isProjectile())
        {
            return false;
        }
        else if (field_192451_c != null && field_192451_c.booleanValue() != p_193418_2_.isExplosion())
        {
            return false;
        }
        else if (field_192452_d != null && field_192452_d.booleanValue() != p_193418_2_.isUnblockable())
        {
            return false;
        }
        else if (field_192453_e != null && field_192453_e.booleanValue() != p_193418_2_.canHarmInCreative())
        {
            return false;
        }
        else if (field_192454_f != null && field_192454_f.booleanValue() != p_193418_2_.isDamageAbsolute())
        {
            return false;
        }
        else if (field_192455_g != null && field_192455_g.booleanValue() != p_193418_2_.isFireDamage())
        {
            return false;
        }
        else if (field_192456_h != null && field_192456_h.booleanValue() != p_193418_2_.isMagicDamage())
        {
            return false;
        }
        else if (!field_193419_i.func_192482_a(p_193418_1_, p_193418_2_.getSourceOfDamage()))
        {
            return false;
        }
        else
        {
            return field_193420_j.func_192482_a(p_193418_1_, p_193418_2_.getEntity());
        }
    }
