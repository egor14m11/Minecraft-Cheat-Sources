...
{
    private static final Namespaced field_192176_a = new Namespaced("brewed_potion");
    ...
    {
        BrewedPotionTrigger.Listeners brewedpotiontrigger$listeners = field_192177_b.get(p_192165_1_);

        if (brewedpotiontrigger$listeners == null)
        {
            brewedpotiontrigger$listeners = new BrewedPotionTrigger.Listeners(p_192165_1_);
            field_192177_b.put(p_192165_1_, brewedpotiontrigger$listeners);
        }
    ...
    {
        BrewedPotionTrigger.Listeners brewedpotiontrigger$listeners = field_192177_b.get(p_192164_1_);
        ...
        if (brewedpotiontrigger$listeners != null)
        {
            ...
            {
                field_192177_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192177_b.remove(p_192167_1_);
    }
    ...
    public BrewedPotionTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_)
    {
        ...
        {
            Namespaced resourcelocation = new Namespaced(JsonUtils.getString(p_192166_1_, "potion"));
    ...
    {
        BrewedPotionTrigger.Listeners brewedpotiontrigger$listeners = field_192177_b.get(p_192173_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(@Nullable PotionType p_i47398_1_)
        {
            ...
            field_192251_a = p_i47398_1_;
        }

        public boolean func_192250_a(PotionType p_192250_1_)
        {
            return field_192251_a == null || field_192251_a == p_192250_1_;
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192348_a(PotionType p_192348_1_)
        {
            ...
            for (ICriterionTrigger.Listener<BrewedPotionTrigger.Instance> listener : field_192351_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192350_a);
                }
            }
        }
    }
