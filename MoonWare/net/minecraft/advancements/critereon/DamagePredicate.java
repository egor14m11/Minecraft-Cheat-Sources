...
public class DamagePredicate
{
    ...
    {
        field_192367_b = MinMaxBounds.field_192516_a;
        field_192368_c = MinMaxBounds.field_192516_a;
        field_192369_d = EntityPredicate.field_192483_a;
        field_192370_e = null;
        field_192371_f = DamageSourcePredicate.field_192449_a;
    }
    ...
    {
        field_192367_b = p_i47464_1_;
        field_192368_c = p_i47464_2_;
        field_192369_d = p_i47464_3_;
        field_192370_e = p_i47464_4_;
        field_192371_f = p_i47464_5_;
    }
    ...
    public boolean func_192365_a(EntityPlayerMP p_192365_1_, DamageSource p_192365_2_, float p_192365_3_, float p_192365_4_, boolean p_192365_5_)
    {
        ...
        else if (!field_192367_b.func_192514_a(p_192365_3_))
        {
            return false;
        }
        else if (!field_192368_c.func_192514_a(p_192365_4_))
        {
            return false;
        }
        else if (!field_192369_d.func_192482_a(p_192365_1_, p_192365_2_.getEntity()))
        {
            return false;
        }
        else if (field_192370_e != null && field_192370_e.booleanValue() != p_192365_5_)
        {
            return false;
        }
        else
        {
            return field_192371_f.func_193418_a(p_192365_1_, p_192365_2_);
        }
    }
