...
{
    private static final Namespaced field_192237_a = new Namespaced("villager_trade");
    ...
    {
        VillagerTradeTrigger.Listeners villagertradetrigger$listeners = field_192238_b.get(p_192165_1_);

        if (villagertradetrigger$listeners == null)
        {
            villagertradetrigger$listeners = new VillagerTradeTrigger.Listeners(p_192165_1_);
            field_192238_b.put(p_192165_1_, villagertradetrigger$listeners);
        }
    ...
    {
        VillagerTradeTrigger.Listeners villagertradetrigger$listeners = field_192238_b.get(p_192164_1_);
        ...
        if (villagertradetrigger$listeners != null)
        {
            ...
            {
                field_192238_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192238_b.remove(p_192167_1_);
    }
    ...
    {
        VillagerTradeTrigger.Listeners villagertradetrigger$listeners = field_192238_b.get(p_192234_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i47457_1_, ItemPredicate p_i47457_2_)
        {
            ...
            field_192286_a = p_i47457_1_;
            field_192287_b = p_i47457_2_;
        }

        public boolean func_192285_a(EntityPlayerMP p_192285_1_, EntityVillager p_192285_2_, ItemStack p_192285_3_)
        {
            if (!field_192286_a.func_192482_a(p_192285_1_, p_192285_2_))
            {
                return false;
            }
            else
            {
                return field_192287_b.func_192493_a(p_192285_3_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192537_a(EntityPlayerMP p_192537_1_, EntityVillager p_192537_2_, ItemStack p_192537_3_)
        {
            ...
            for (ICriterionTrigger.Listener<VillagerTradeTrigger.Instance> listener : field_192542_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192541_a);
                }
            }
        }
    }
