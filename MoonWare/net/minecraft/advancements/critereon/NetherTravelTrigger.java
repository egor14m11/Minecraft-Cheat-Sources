...
{
    private static final Namespaced field_193169_a = new Namespaced("nether_travel");
    ...
    {
        NetherTravelTrigger.Listeners nethertraveltrigger$listeners = field_193170_b.get(p_192165_1_);

        if (nethertraveltrigger$listeners == null)
        {
            nethertraveltrigger$listeners = new NetherTravelTrigger.Listeners(p_192165_1_);
            field_193170_b.put(p_192165_1_, nethertraveltrigger$listeners);
        }
    ...
    {
        NetherTravelTrigger.Listeners nethertraveltrigger$listeners = field_193170_b.get(p_192164_1_);
        ...
        if (nethertraveltrigger$listeners != null)
        {
            ...
            {
                field_193170_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193170_b.remove(p_192167_1_);
    }
    ...
    {
        NetherTravelTrigger.Listeners nethertraveltrigger$listeners = field_193170_b.get(p_193168_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(LocationPredicate p_i47574_1_, LocationPredicate p_i47574_2_, DistancePredicate p_i47574_3_)
        {
            ...
            field_193207_a = p_i47574_1_;
            field_193208_b = p_i47574_2_;
            field_193209_c = p_i47574_3_;
        }
        ...
        {
            if (!field_193207_a.func_193452_a(p_193206_1_, p_193206_2_.xCoord, p_193206_2_.yCoord, p_193206_2_.zCoord))
            {
                return false;
            }
            else if (!field_193208_b.func_193452_a(p_193206_1_, p_193206_3_, p_193206_5_, p_193206_7_))
            {
                return false;
            }
            else
            {
                return field_193209_c.func_193422_a(p_193206_2_.xCoord, p_193206_2_.yCoord, p_193206_2_.zCoord, p_193206_3_, p_193206_5_, p_193206_7_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193483_a(WorldServer p_193483_1_, Vec3d p_193483_2_, double p_193483_3_, double p_193483_5_, double p_193483_7_)
        {
            ...
            for (ICriterionTrigger.Listener<NetherTravelTrigger.Instance> listener : field_193486_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193485_a);
                }
            }
        }
    }
