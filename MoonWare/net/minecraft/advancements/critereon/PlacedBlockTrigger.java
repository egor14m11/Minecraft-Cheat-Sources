...
{
    private static final Namespaced field_193174_a = new Namespaced("placed_block");
    private final Map<PlayerAdvancements, PlacedBlockTrigger.Listeners> field_193175_b = Maps.newHashMap();

    public Namespaced func_192163_a()
    {
    ...
    {
        PlacedBlockTrigger.Listeners placedblocktrigger$listeners = field_193175_b.get(p_192165_1_);

        if (placedblocktrigger$listeners == null)
        {
            placedblocktrigger$listeners = new PlacedBlockTrigger.Listeners(p_192165_1_);
            field_193175_b.put(p_192165_1_, placedblocktrigger$listeners);
        }
    ...
    {
        PlacedBlockTrigger.Listeners placedblocktrigger$listeners = field_193175_b.get(p_192164_1_);
        ...
        if (placedblocktrigger$listeners != null)
        {
            ...
            {
                field_193175_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193175_b.remove(p_192167_1_);
    }
    ...
    public PlacedBlockTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_)
    {
        ...
        {
            Namespaced resourcelocation = new Namespaced(JsonUtils.getString(p_192166_1_, "block"));
    ...
    public void func_193173_a(EntityPlayerMP p_193173_1_, BlockPos p_193173_2_, ItemStack p_193173_3_)
    {
        ...
        PlacedBlockTrigger.Listeners placedblocktrigger$listeners = field_193175_b.get(p_193173_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(@Nullable Block p_i47566_1_, @Nullable Map < IProperty<?>, Object > p_i47566_2_, LocationPredicate p_i47566_3_, ItemPredicate p_i47566_4_)
        {
            ...
            field_193211_a = p_i47566_1_;
            field_193212_b = p_i47566_2_;
            field_193213_c = p_i47566_3_;
            field_193214_d = p_i47566_4_;
        }

        public boolean func_193210_a(IBlockState p_193210_1_, BlockPos p_193210_2_, WorldServer p_193210_3_, ItemStack p_193210_4_)
        {
            if (field_193211_a != null && p_193210_1_.getBlock() != field_193211_a)
            {
                return false;
            }
            else
            {
                if (field_193212_b != null)
                {
                    for (Map.Entry < IProperty<?>, Object > entry : field_193212_b.entrySet())
                    {
                ...
                if (!field_193213_c.func_193453_a(p_193210_3_, (float)p_193210_2_.getX(), (float)p_193210_2_.getY(), (float)p_193210_2_.getZ()))
                {
                    return false;
                }
                else
                {
                    return field_193214_d.func_192493_a(p_193210_4_);
                }
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193489_a(IBlockState p_193489_1_, BlockPos p_193489_2_, WorldServer p_193489_3_, ItemStack p_193489_4_)
        {
            ...
            for (ICriterionTrigger.Listener<PlacedBlockTrigger.Instance> listener : field_193492_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193491_a);
                }
            }
        }
    }
