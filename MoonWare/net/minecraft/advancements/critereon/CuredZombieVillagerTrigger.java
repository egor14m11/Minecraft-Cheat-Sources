...
{
    private static final Namespaced field_192186_a = new Namespaced("cured_zombie_villager");
    ...
    {
        CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = field_192187_b.get(p_192165_1_);
        ...
        if (curedzombievillagertrigger$listeners == null)
        {
            ...
            field_192187_b.put(p_192165_1_, curedzombievillagertrigger$listeners);
        }
    ...
    {
        CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = field_192187_b.get(p_192164_1_);
        ...
        if (curedzombievillagertrigger$listeners != null)
        {
            ...
            {
                field_192187_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192187_b.remove(p_192167_1_);
    }
    ...
    {
        CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = field_192187_b.get(p_192183_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i47459_1_, EntityPredicate p_i47459_2_)
        {
            ...
            field_192255_a = p_i47459_1_;
            field_192256_b = p_i47459_2_;
        }

        public boolean func_192254_a(EntityPlayerMP p_192254_1_, EntityZombie p_192254_2_, EntityVillager p_192254_3_)
        {
            if (!field_192255_a.func_192482_a(p_192254_1_, p_192254_2_))
            {
                return false;
            }
            else
            {
                return field_192256_b.func_192482_a(p_192254_1_, p_192254_3_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192361_a(EntityPlayerMP p_192361_1_, EntityZombie p_192361_2_, EntityVillager p_192361_3_)
        {
            ...
            for (ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> listener : field_192363_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192362_a);
                }
            }
        }
    }
