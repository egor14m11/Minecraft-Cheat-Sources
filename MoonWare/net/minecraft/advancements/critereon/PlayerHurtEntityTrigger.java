...
{
    private static final Namespaced field_192222_a = new Namespaced("player_hurt_entity");
    ...
    {
        PlayerHurtEntityTrigger.Listeners playerhurtentitytrigger$listeners = field_192223_b.get(p_192165_1_);
        ...
        if (playerhurtentitytrigger$listeners == null)
        {
            ...
            field_192223_b.put(p_192165_1_, playerhurtentitytrigger$listeners);
        }
    ...
    {
        PlayerHurtEntityTrigger.Listeners playerhurtentitytrigger$listeners = field_192223_b.get(p_192164_1_);
        ...
        if (playerhurtentitytrigger$listeners != null)
        {
            ...
            {
                field_192223_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192223_b.remove(p_192167_1_);
    }
    ...
    {
        PlayerHurtEntityTrigger.Listeners playerhurtentitytrigger$listeners = field_192223_b.get(p_192220_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(DamagePredicate p_i47406_1_, EntityPredicate p_i47406_2_)
        {
            ...
            field_192279_a = p_i47406_1_;
            field_192280_b = p_i47406_2_;
        }
        ...
        {
            if (!field_192279_a.func_192365_a(p_192278_1_, p_192278_3_, p_192278_4_, p_192278_5_, p_192278_6_))
            {
                return false;
            }
            else
            {
                return field_192280_b.func_192482_a(p_192278_1_, p_192278_2_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192521_a(EntityPlayerMP p_192521_1_, Entity p_192521_2_, DamageSource p_192521_3_, float p_192521_4_, float p_192521_5_, boolean p_192521_6_)
        {
            ...
            for (ICriterionTrigger.Listener<PlayerHurtEntityTrigger.Instance> listener : field_192524_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192523_a);
                }
            }
        }
    }
