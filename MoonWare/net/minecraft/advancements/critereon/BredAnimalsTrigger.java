...
{
    private static final Namespaced field_192171_a = new Namespaced("bred_animals");
    ...
    {
        BredAnimalsTrigger.Listeners bredanimalstrigger$listeners = field_192172_b.get(p_192165_1_);

        if (bredanimalstrigger$listeners == null)
        {
            bredanimalstrigger$listeners = new BredAnimalsTrigger.Listeners(p_192165_1_);
            field_192172_b.put(p_192165_1_, bredanimalstrigger$listeners);
        }
    ...
    {
        BredAnimalsTrigger.Listeners bredanimalstrigger$listeners = field_192172_b.get(p_192164_1_);
        ...
        if (bredanimalstrigger$listeners != null)
        {
            ...
            {
                field_192172_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192172_b.remove(p_192167_1_);
    }
    ...
    {
        BredAnimalsTrigger.Listeners bredanimalstrigger$listeners = field_192172_b.get(p_192168_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i47408_1_, EntityPredicate p_i47408_2_, EntityPredicate p_i47408_3_)
        {
            ...
            field_192247_a = p_i47408_1_;
            field_192248_b = p_i47408_2_;
            field_192249_c = p_i47408_3_;
        }
        ...
        {
            if (!field_192249_c.func_192482_a(p_192246_1_, p_192246_4_))
            {
                return false;
            }
            else
            {
                return field_192247_a.func_192482_a(p_192246_1_, p_192246_2_) && field_192248_b.func_192482_a(p_192246_1_, p_192246_3_) || field_192247_a.func_192482_a(p_192246_1_, p_192246_3_) && field_192248_b.func_192482_a(p_192246_1_, p_192246_2_);
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192342_a(EntityPlayerMP p_192342_1_, EntityAnimal p_192342_2_, EntityAnimal p_192342_3_, EntityAgeable p_192342_4_)
        {
            ...
            for (ICriterionTrigger.Listener<BredAnimalsTrigger.Instance> listener : field_192345_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192344_a);
                }
            }
        }
    }
