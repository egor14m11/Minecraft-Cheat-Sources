...
{
    private static final Namespaced field_192232_a = new Namespaced("summoned_entity");
    ...
    {
        SummonedEntityTrigger.Listeners summonedentitytrigger$listeners = field_192233_b.get(p_192165_1_);

        if (summonedentitytrigger$listeners == null)
        {
            summonedentitytrigger$listeners = new SummonedEntityTrigger.Listeners(p_192165_1_);
            field_192233_b.put(p_192165_1_, summonedentitytrigger$listeners);
        }
    ...
    {
        SummonedEntityTrigger.Listeners summonedentitytrigger$listeners = field_192233_b.get(p_192164_1_);
        ...
        if (summonedentitytrigger$listeners != null)
        {
            ...
            {
                field_192233_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192233_b.remove(p_192167_1_);
    }
    ...
    {
        SummonedEntityTrigger.Listeners summonedentitytrigger$listeners = field_192233_b.get(p_192229_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i47371_1_)
        {
            ...
            field_192284_a = p_i47371_1_;
        }

        public boolean func_192283_a(EntityPlayerMP p_192283_1_, Entity p_192283_2_)
        {
            return field_192284_a.func_192482_a(p_192283_1_, p_192283_2_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192533_a(EntityPlayerMP p_192533_1_, Entity p_192533_2_)
        {
            ...
            for (ICriterionTrigger.Listener<SummonedEntityTrigger.Instance> listener : field_192536_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192535_a);
                }
            }
        }
    }
