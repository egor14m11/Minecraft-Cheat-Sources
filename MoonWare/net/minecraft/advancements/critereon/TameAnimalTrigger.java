...
{
    private static final Namespaced field_193179_a = new Namespaced("tame_animal");
    ...
    {
        TameAnimalTrigger.Listeners tameanimaltrigger$listeners = field_193180_b.get(p_192165_1_);

        if (tameanimaltrigger$listeners == null)
        {
            tameanimaltrigger$listeners = new TameAnimalTrigger.Listeners(p_192165_1_);
            field_193180_b.put(p_192165_1_, tameanimaltrigger$listeners);
        }
    ...
    {
        TameAnimalTrigger.Listeners tameanimaltrigger$listeners = field_193180_b.get(p_192164_1_);
        ...
        if (tameanimaltrigger$listeners != null)
        {
            ...
            {
                field_193180_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193180_b.remove(p_192167_1_);
    }
    ...
    {
        TameAnimalTrigger.Listeners tameanimaltrigger$listeners = field_193180_b.get(p_193178_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(EntityPredicate p_i47513_1_)
        {
            ...
            field_193217_a = p_i47513_1_;
        }

        public boolean func_193216_a(EntityPlayerMP p_193216_1_, EntityAnimal p_193216_2_)
        {
            return field_193217_a.func_192482_a(p_193216_1_, p_193216_2_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193497_a(EntityPlayerMP p_193497_1_, EntityAnimal p_193497_2_)
        {
            ...
            for (ICriterionTrigger.Listener<TameAnimalTrigger.Instance> listener : field_193499_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193498_a);
                }
            }
        }
    }
