...
{
    private static final Namespaced field_192201_a = new Namespaced("entity_hurt_player");
    ...
    {
        EntityHurtPlayerTrigger.Listeners entityhurtplayertrigger$listeners = field_192202_b.get(p_192165_1_);
        ...
        if (entityhurtplayertrigger$listeners == null)
        {
            ...
            field_192202_b.put(p_192165_1_, entityhurtplayertrigger$listeners);
        }
    ...
    {
        EntityHurtPlayerTrigger.Listeners entityhurtplayertrigger$listeners = field_192202_b.get(p_192164_1_);
        ...
        if (entityhurtplayertrigger$listeners != null)
        {
            ...
            {
                field_192202_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192202_b.remove(p_192167_1_);
    }
    ...
    {
        EntityHurtPlayerTrigger.Listeners entityhurtplayertrigger$listeners = field_192202_b.get(p_192200_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        {
            return field_192264_a.func_192365_a(p_192263_1_, p_192263_2_, p_192263_3_, p_192263_4_, p_192263_5_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192478_a(EntityPlayerMP p_192478_1_, DamageSource p_192478_2_, float p_192478_3_, float p_192478_4_, boolean p_192478_5_)
        {
            ...
            for (ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> listener : field_192480_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192479_a);
                }
            }
        }
    }
