...
{
    private static final Namespaced field_193149_a = new Namespaced("consume_item");
    ...
    {
        ConsumeItemTrigger.Listeners consumeitemtrigger$listeners = field_193150_b.get(p_192165_1_);

        if (consumeitemtrigger$listeners == null)
        {
            consumeitemtrigger$listeners = new ConsumeItemTrigger.Listeners(p_192165_1_);
            field_193150_b.put(p_192165_1_, consumeitemtrigger$listeners);
        }
    ...
    {
        ConsumeItemTrigger.Listeners consumeitemtrigger$listeners = field_193150_b.get(p_192164_1_);
        ...
        if (consumeitemtrigger$listeners != null)
        {
            ...
            {
                field_193150_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193150_b.remove(p_192167_1_);
    }
    ...
    {
        ConsumeItemTrigger.Listeners consumeitemtrigger$listeners = field_193150_b.get(p_193148_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(ItemPredicate p_i47562_1_)
        {
            ...
            field_193194_a = p_i47562_1_;
        }

        public boolean func_193193_a(ItemStack p_193193_1_)
        {
            return field_193194_a.func_192493_a(p_193193_1_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193240_a(ItemStack p_193240_1_)
        {
            ...
            for (ICriterionTrigger.Listener<ConsumeItemTrigger.Instance> listener : field_193242_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193241_a);
                }
            }
        }
    }
