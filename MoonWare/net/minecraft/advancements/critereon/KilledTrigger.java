...
public class KilledTrigger implements ICriterionTrigger<KilledTrigger.Instance>
{
    ...
    private final Namespaced field_192214_b;

    public KilledTrigger(Namespaced p_i47433_1_)
    {
        field_192214_b = p_i47433_1_;
    }

    public Namespaced func_192163_a()
    {
        return field_192214_b;
    }

    public void func_192165_a(PlayerAdvancements p_192165_1_, ICriterionTrigger.Listener<KilledTrigger.Instance> p_192165_2_)
    {
        KilledTrigger.Listeners killedtrigger$listeners = field_192213_a.get(p_192165_1_);

        if (killedtrigger$listeners == null)
        {
            killedtrigger$listeners = new KilledTrigger.Listeners(p_192165_1_);
            field_192213_a.put(p_192165_1_, killedtrigger$listeners);
        }
    ...
    {
        KilledTrigger.Listeners killedtrigger$listeners = field_192213_a.get(p_192164_1_);
        ...
        if (killedtrigger$listeners != null)
        {
            ...
            {
                field_192213_a.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_192213_a.remove(p_192167_1_);
    }

    public KilledTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_)
    {
        return new KilledTrigger.Instance(field_192214_b, EntityPredicate.func_192481_a(p_192166_1_.get("entity")), DamageSourcePredicate.func_192447_a(p_192166_1_.get("killing_blow")));
    }

    public void func_192211_a(EntityPlayerMP p_192211_1_, Entity p_192211_2_, DamageSource p_192211_3_)
    {
        KilledTrigger.Listeners killedtrigger$listeners = field_192213_a.get(p_192211_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(Namespaced p_i47454_1_, EntityPredicate p_i47454_2_, DamageSourcePredicate p_i47454_3_)
        {
            super(p_i47454_1_);
            field_192271_a = p_i47454_2_;
            field_192272_b = p_i47454_3_;
        }

        public boolean func_192270_a(EntityPlayerMP p_192270_1_, Entity p_192270_2_, DamageSource p_192270_3_)
        {
            return field_192272_b.func_193418_a(p_192270_1_, p_192270_3_) && field_192271_a.func_192482_a(p_192270_1_, p_192270_2_);
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_192503_a(EntityPlayerMP p_192503_1_, Entity p_192503_2_, DamageSource p_192503_3_)
        {
            ...
            for (ICriterionTrigger.Listener<KilledTrigger.Instance> listener : field_192506_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_192505_a);
                }
            }
        }
    }
