...
{
    private static final Namespaced field_193144_a = new Namespaced("changed_dimension");
    ...
    {
        ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = field_193145_b.get(p_192165_1_);
        ...
        if (changedimensiontrigger$listeners == null)
        {
            ...
            field_193145_b.put(p_192165_1_, changedimensiontrigger$listeners);
        }
    ...
    {
        ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = field_193145_b.get(p_192164_1_);
        ...
        if (changedimensiontrigger$listeners != null)
        {
            ...
            {
                field_193145_b.remove(p_192164_1_);
            }
        }
    }
    ...
    {
        field_193145_b.remove(p_192167_1_);
    }
    ...
    {
        ChangeDimensionTrigger.Listeners changedimensiontrigger$listeners = field_193145_b.get(p_193143_1_.func_192039_O());
    ...
    public static class Instance extends AbstractCriterionInstance
    {
        ...
        public Instance(@Nullable DimensionType p_i47475_1_, @Nullable DimensionType p_i47475_2_)
        {
            ...
            field_193191_a = p_i47475_1_;
            field_193192_b = p_i47475_2_;
        }

        public boolean func_193190_a(DimensionType p_193190_1_, DimensionType p_193190_2_)
        {
            if (field_193191_a != null && field_193191_a != p_193190_1_)
            {
                return false;
            }
            else
            {
                return field_193192_b == null || field_193192_b == p_193190_2_;
            }
        }
    }
    ...
    static class Listeners
    {
        ...
        public void func_193234_a(DimensionType p_193234_1_, DimensionType p_193234_2_)
        {
            ...
            for (ICriterionTrigger.Listener<ChangeDimensionTrigger.Instance> listener : field_193236_b)
            {
            ...
            if (list != null)
            {
                ...
                {
                    listener1.func_192159_a(field_193235_a);
                }
            }
        }
    }
