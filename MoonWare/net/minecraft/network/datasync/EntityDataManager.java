...
public class EntityDataManager
{
    ...
    public <T> void set(DataParameter<T> key, T value)
    {
        ...
        if (!Objects.equal(value, dataentry.getValue()))
        {
    ...
    public void setEntryValues(List < EntityDataManager.DataEntry<? >> entriesIn)
    {
        ...
        {
            EntityDataManager.DataEntry<?> dataentry1 = entries.get(Integer.valueOf(dataentry.getKey().getId()));
    ...
    public static class DataEntry<T>
    {
        ...
        {
            return new EntityDataManager.DataEntry<T>(key, key.getSerializer().func_192717_a(value));
        }
    }
}
