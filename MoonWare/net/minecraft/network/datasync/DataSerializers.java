...
public class DataSerializers
{
    ...
    public static final DataSerializer<Component> TEXT_COMPONENT = new DataSerializer<Component>()
    {
        public void write(PacketBuffer buf, Component value)
        {
            buf.writeTextComponent(value);
        }
        public Component read(PacketBuffer buf) throws IOException
        {
            return buf.readTextComponent();
        }
        public DataParameter<Component> createKey(int id)
        {
            return new DataParameter<Component>(id, this);
        }
        public Component func_192717_a(Component p_192717_1_)
        {
