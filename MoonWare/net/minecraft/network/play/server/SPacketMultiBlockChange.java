...
public class SPacketMultiBlockChange implements Packet<INetHandlerPlayClient>
{
    ...
    {
        chunkPos = new ChunkPos(p_i46959_3_.xPosition, p_i46959_3_.zPosition);
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        changedBlocks = new SPacketMultiBlockChange.BlockUpdateData[buf.readVarIntFromBuffer()];

        for (int i = 0; i < changedBlocks.length; ++i)
        {
            changedBlocks[i] = new SPacketMultiBlockChange.BlockUpdateData(buf.readShort(), Block.BLOCK_STATE_IDS.getByValue(buf.readVarIntFromBuffer()));
        }
    }
