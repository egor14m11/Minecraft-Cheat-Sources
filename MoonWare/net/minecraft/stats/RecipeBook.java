...
public class RecipeBook
{
    ...
    {
        field_194077_a.clear();
        field_194078_b.clear();
        field_194077_a.or(p_193824_1_.field_194077_a);
        field_194078_b.or(p_193824_1_.field_194078_b);
    }
    ...
    public void func_194073_a(IRecipe p_194073_1_)
    {
        ...
        {
            field_194077_a.set(func_194075_d(p_194073_1_));
        }
    }

    public boolean func_193830_f(@Nullable IRecipe p_193830_1_)
    {
        return field_194077_a.get(func_194075_d(p_193830_1_));
    }

    public void func_193831_b(IRecipe p_193831_1_)
    {
        int i = func_194075_d(p_193831_1_);
        field_194077_a.clear(i);
        field_194078_b.clear(i);
    }
