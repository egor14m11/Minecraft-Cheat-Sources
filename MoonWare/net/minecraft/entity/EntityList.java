...
{
    public static final Namespaced field_191307_a = new Namespaced("lightning_bolt");
    private static final Namespaced field_191310_e = new Namespaced("player");
    private static final Logger LOGGER = LogManager.getLogger();
    public static final RegistryNamespaced <Namespaced, Class <? extends Entity >> REGISTRY = new RegistryNamespaced <Namespaced, Class <? extends Entity >> ();
    public static final Map<Namespaced, EntityList.EntityEggInfo> ENTITY_EGGS = Maps.newLinkedHashMap();
    public static final Set<Namespaced> field_191309_d = Sets.newHashSet();
    private static final List<String> field_191311_g = Lists.newArrayList();

    @Nullable
    public static Namespaced func_191301_a(Entity p_191301_0_)
    {
        return getKey(p_191301_0_.getClass());
    }

    @Nullable
    public static Namespaced getKey(Class <? extends Entity > p_191306_0_)
    {
    ...
    @Nullable
    public static String func_191302_a(@Nullable Namespaced p_191302_0_)
    {
    ...
    {
        return REGISTRY.getObject(new Namespaced(p_192839_0_));
    }
    ...
    @Nullable
    public static Entity createEntityByIDFromName(Namespaced name, World worldIn)
    {
    ...
    {
        Namespaced resourcelocation = new Namespaced(nbt.getString("id"));
    ...
    public static Set<Namespaced> getEntityNameList()
    {
        return field_191309_d;
    }

    public static boolean isStringEntityName(Entity entityIn, Namespaced entityName)
    {
        Namespaced resourcelocation = getKey(entityIn.getClass());
    ...
    public static boolean isStringValidEntityName(Namespaced entityName)
    {
    ...
    public static String func_192840_b()
    {
        ...
        for (Namespaced resourcelocation : getEntityNameList())
        {
    ...
    private static void func_191303_a(int p_191303_0_, String p_191303_1_, Class <? extends Entity > p_191303_2_, String p_191303_3_)
    {
        ...
        {
            Namespaced resourcelocation = new Namespaced(p_191303_1_);
    ...
    {
        Namespaced resourcelocation = new Namespaced(p_191305_0_);
        return ENTITY_EGGS.put(resourcelocation, new EntityList.EntityEggInfo(resourcelocation, p_191305_1_, p_191305_2_));
    }

    public static class EntityEggInfo
    {
        public final Namespaced spawnedID;
        public final int primaryColor;
        public final int secondaryColor;
        public final StatBase killEntityStat;
        public final StatBase entityKilledByStat;

        public EntityEggInfo(Namespaced p_i47341_1_, int p_i47341_2_, int p_i47341_3_)
        {
            spawnedID = p_i47341_1_;
            primaryColor = p_i47341_2_;
            secondaryColor = p_i47341_3_;
