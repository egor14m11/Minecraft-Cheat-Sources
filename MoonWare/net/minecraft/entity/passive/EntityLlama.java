...
public class EntityLlama extends AbstractChestHorse implements IRangedAttackMob
{
    ...
    {
        dataManager.set(field_190720_bG, Integer.valueOf(Math.max(1, Math.min(5, p_190706_1_))));
    }

    private void func_190705_dT()
    {
        int i = rand.nextFloat() < 0.04F ? 5 : 3;
        func_190706_p(1 + rand.nextInt(i));
    }

    public int func_190707_dL()
    {
        return dataManager.get(field_190720_bG).intValue();
    }
    ...
    {
        super.entityInit();
        dataManager.register(field_190720_bG, Integer.valueOf(0));
        dataManager.register(field_190721_bH, Integer.valueOf(-1));
        dataManager.register(field_190722_bI, Integer.valueOf(0));
    }

    public int func_190719_dM()
    {
        return MathHelper.clamp(dataManager.get(field_190722_bI).intValue(), 0, 3);
    }

    public void func_190710_o(int p_190710_1_)
    {
        dataManager.set(field_190722_bI, Integer.valueOf(p_190710_1_));
    }
    ...
    protected boolean func_190678_b(EntityPlayer p_190678_1_, ItemStack p_190678_2_)
    {
        ...
        if (flag && !isSilent())
        {
            world.playSound(null, posX, posY, posZ, SoundEvents.field_191253_dD, getSoundCategory(), 1.0F, 1.0F + (rand.nextFloat() - rand.nextFloat()) * 0.2F);
        }
    ...
    {
        playSound(SoundEvents.field_191251_dB, 1.0F, (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F);
    }
    ...
    protected void updateHorseSlots()
    {
        if (!world.isRemote)
        {
            ...
            func_190702_g(horseChest.getStackInSlot(1));
        }
    }

    private void func_190711_a(@Nullable EnumDyeColor p_190711_1_)
    {
        dataManager.set(field_190721_bH, Integer.valueOf(p_190711_1_ == null ? -1 : p_190711_1_.getMetadata()));
    }
    ...
    {
        int i = dataManager.get(field_190721_bH).intValue();
    ...
    public EntityLlama createChild(EntityAgeable ageable)
    {
        ...
        int i = rand.nextInt(Math.max(func_190707_dL(), entityllama1.func_190707_dL())) + 1;
        ...
        entityllama.func_190710_o(rand.nextBoolean() ? func_190719_dM() : entityllama1.func_190719_dM());
        return entityllama;
    }
    ...
    private void func_190713_e(EntityLivingBase p_190713_1_)
    {
        ...
        double d0 = p_190713_1_.posX - posX;
        double d1 = p_190713_1_.getEntityBoundingBox().minY + (double)(p_190713_1_.height / 3.0F) - entityllamaspit.posY;
        double d2 = p_190713_1_.posZ - posZ;
        float f = MathHelper.sqrt(d0 * d0 + d2 * d2) * 0.2F;
        entityllamaspit.setThrowableHeading(d0, d1 + (double)f, d2, 1.5F, 10.0F);
        world.playSound(null, posX, posY, posZ, SoundEvents.field_191255_dF, getSoundCategory(), 1.0F, 1.0F + (rand.nextFloat() - rand.nextFloat()) * 0.2F);
        world.spawnEntityInWorld(entityllamaspit);
        field_190723_bJ = true;
    }

    private void func_190714_x(boolean p_190714_1_)
    {
        field_190723_bJ = p_190714_1_;
    }
    ...
    {
        if (field_190724_bK != null)
        {
            field_190724_bK.field_190725_bL = null;
        }

        field_190724_bK = null;
    }

    public void func_190715_a(EntityLlama p_190715_1_)
    {
        field_190724_bK = p_190715_1_;
        field_190724_bK.field_190725_bL = this;
    }

    public boolean func_190712_dQ()
    {
        return field_190725_bL != null;
    }

    public boolean func_190718_dR()
    {
        return field_190724_bK != null;
    }

    @Nullable
    public EntityLlama func_190716_dS()
    {
        return field_190724_bK;
    }
