...
public class EntityAIFollowOwner extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        if (!thePet.isSitting())
        {
            if (--timeToRecalcPath <= 0)
            {
                ...
                {
                    if (!thePet.getLeashed() && !thePet.isRiding())
                    {
    ...
    protected boolean func_192381_a(int p_192381_1_, int p_192381_2_, int p_192381_3_, int p_192381_4_, int p_192381_5_)
    {
        ...
        return iblockstate.func_193401_d(theWorld, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID && iblockstate.canEntitySpawn(thePet) && theWorld.isAirBlock(blockpos.up()) && theWorld.isAirBlock(blockpos.up(2));
    }
}
