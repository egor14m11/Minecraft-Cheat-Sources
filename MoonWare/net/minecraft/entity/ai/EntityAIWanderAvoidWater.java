...
public class EntityAIWanderAvoidWater extends EntityAIWander
{
    ...
    protected Vec3d func_190864_f()
    {
        if (entity.isInWater())
        {
            Vec3d vec3d = RandomPositionGenerator.func_191377_b(entity, 15, 7);
            return vec3d == null ? super.func_190864_f() : vec3d;
        }
        else
        {
            return entity.getRNG().nextFloat() >= field_190865_h ? RandomPositionGenerator.func_191377_b(entity, 10, 7) : super.func_190864_f();
        }
    }
}
