...
public class EntityAIPanic extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            if (theEntityCreature.isBurning())
            {
                BlockPos blockpos = getRandPos(theEntityCreature.world, theEntityCreature, 5, 4);
    ...
    {
        Vec3d vec3d = RandomPositionGenerator.findRandomTarget(theEntityCreature, 5, 4);
