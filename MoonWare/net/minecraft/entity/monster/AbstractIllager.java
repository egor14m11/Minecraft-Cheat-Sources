...
public abstract class AbstractIllager extends EntityMob
{
    ...
    {
        super.entityInit();
        dataManager.register(field_193080_a, Byte.valueOf((byte)0));
    }

    protected boolean func_193078_a(int p_193078_1_)
    {
        int i = dataManager.get(field_193080_a).byteValue();
    ...
    protected void func_193079_a(int p_193079_1_, boolean p_193079_2_)
    {
        ...
        dataManager.set(field_193080_a, Byte.valueOf((byte)(i & 255)));
    }
