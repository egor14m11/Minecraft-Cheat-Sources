...
public class EntityVindicator extends AbstractIllager
{
    ...
    {
        return func_190639_o() ? AbstractIllager.IllagerArmPose.ATTACKING : AbstractIllager.IllagerArmPose.CROSSED;
    }
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            field_190643_b = compound.getBoolean("Johnny");
        }
    }
    ...
    {
        super.updateAITasks();
        func_190636_a(getAttackTarget() != null);
    }
    ...
    public void setCustomNameTag(String name)
    {
        ...
        if (!field_190643_b && "Johnny".equals(name))
        {
            field_190643_b = true;
        }
    }
    ...
    static class AIJohnnyAttack extends EntityAINearestAttackableTarget<EntityLivingBase>
    {
        ...
        {
            return ((EntityVindicator) taskOwner).field_190643_b && super.shouldExecute();
        }
    }
}
