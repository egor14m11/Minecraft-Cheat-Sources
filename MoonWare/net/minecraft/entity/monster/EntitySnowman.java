...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (!world.isRemote)
        {
            ...
            if (world.getBiome(new BlockPos(i, 0, k)).getFloatTemperature(new BlockPos(i, j, k)) > 1.0F)
            {
            ...
            for (int l = 0; l < 4; ++l)
            {
                ...
                if (world.getBlockState(blockpos).getMaterial() == Material.AIR && world.getBiome(blockpos).getFloatTemperature(blockpos) < 0.8F && Blocks.SNOW_LAYER.canPlaceBlockAt(world, blockpos))
                {
