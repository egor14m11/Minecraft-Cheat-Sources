...
public enum BannerPattern
{
    ...
    {
        field_191016_P = new String[3];
        field_191017_Q = ItemStack.EMPTY;
        field_191014_N = p_i47245_3_;
        field_191015_O = p_i47245_4_;
    }

    BannerPattern(String p_i47246_3_, String p_i47246_4_, ItemStack p_i47246_5_)
    {
        this(p_i47246_3_, p_i47246_4_);
        field_191017_Q = p_i47246_5_;
    }
    ...
    BannerPattern(String p_i47247_3_, String p_i47247_4_, String p_i47247_5_, String p_i47247_6_, String p_i47247_7_)
    {
        ...
        field_191016_P[0] = p_i47247_5_;
        field_191016_P[1] = p_i47247_6_;
        field_191016_P[2] = p_i47247_7_;
    }

    public String func_190997_a()
    {
        return field_191014_N;
    }

    public String func_190993_b()
    {
        return field_191015_O;
    }

    public String[] func_190996_c()
    {
        return field_191016_P;
    }

    public boolean func_191000_d()
    {
        return !field_191017_Q.isEmpty() || field_191016_P[0] != null;
    }

    public boolean func_190999_e()
    {
        return !field_191017_Q.isEmpty();
    }

    public ItemStack func_190998_f()
    {
        return field_191017_Q;
    }
