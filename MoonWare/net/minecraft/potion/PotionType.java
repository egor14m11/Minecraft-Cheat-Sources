...
{
    private static final Namespaced WATER = new Namespaced("empty");
    public static final RegistryNamespacedDefaultedByKey<Namespaced, PotionType> REGISTRY = new RegistryNamespacedDefaultedByKey<Namespaced, PotionType>(WATER);
    ...
    {
        return REGISTRY.getObject(new Namespaced(p_185168_0_));
    }
    ...
    {
        return baseName == null ? p_185174_1_ + REGISTRY.getNameForObject(this).getPath() : p_185174_1_ + baseName;
    }
    ...
    {
        REGISTRY.register(nextPotionTypeId++, new Namespaced(p_185173_0_), p_185173_1_);
    }
