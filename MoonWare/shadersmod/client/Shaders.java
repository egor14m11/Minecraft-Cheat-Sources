...
public class Shaders
{
    ...
    private static final String[] formatNames = {"R8", "RG8", "RGB8", "RGBA8", "R8_SNORM", "RG8_SNORM", "RGB8_SNORM", "RGBA8_SNORM", "R16", "RG16", "RGB16", "RGBA16", "R16_SNORM", "RG16_SNORM", "RGB16_SNORM", "RGBA16_SNORM", "R16F", "RG16F", "RGB16F", "RGBA16F", "R32F", "RG32F", "RGB32F", "RGBA32F", "R32I", "RG32I", "RGB32I", "RGBA32I", "R32UI", "RG32UI", "RGB32UI", "RGBA32UI", "R3_G3_B2", "RGB5_A1", "RGB10_A2", "R11F_G11F_B10F", "RGB9_E5"};
    private static final int[] formatIds = {33321, 33323, 32849, 32856, 36756, 36757, 36758, 36759, 33322, 33324, 32852, 32859, 36760, 36761, 36762, 36763, 33325, 33327, 34843, 34842, 33326, 33328, 34837, 34836, 33333, 33339, 36227, 36226, 33334, 33340, 36209, 36208, 10768, 32855, 32857, 35898, 35901};
    ...
    public static void loadShaderPack()
    {
        ...
        if (flag4 || flag3)
        {
            ...
            mc.addScheduledTask(() -> Minecraft.refreshResources());
        }
    }
        ...
        else
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    simpleshadertexture.loadTexture(Minecraft.getResourceManager());
    ...
    private static void saveOptionProperties(IShaderPack sp, Properties props) throws IOException
    {
        ...
        File file1 = new File(Minecraft.gameDir, s);
    ...
    {
        Minecraft.ingameGUI.getChatGUI().printChatMessage(new TextComponent(str));
    }
    ...
    public static void resetDisplayListModels()
    {
        if (needResetModels)
        {
            ...
            for (Render render : Minecraft.getRenderManager().getEntityRenderMap().values())
            {
    ...
    public static void useProgram(int program)
    {
        ...
        if (activeProgram != program)
        {
            ...
            else
            {
                ...
                setProgramUniform1f("far", (float)(Minecraft.gameSettings.renderDistance * 16));
                ...
                setProgramUniform1f("screenBrightness", Minecraft.gameSettings.gamma);
    ...
    private static void loadEntityDataMap()
    {
        ...
        {
            for (Namespaced resourcelocation : Block.REGISTRY.getKeys())
            {
    ...
    {
        renderDisplayWidth = Minecraft.width;
        renderDisplayHeight = Minecraft.height;
    ...
    public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano)
    {
        ...
        checkWorldChanged(Minecraft.world);
        mc = minecraft;
        Minecraft.profiler.startSection("init");
        ...
        if (Minecraft.width != renderDisplayWidth || Minecraft.height != renderDisplayHeight)
        {
            resize();
        }
        ...
        worldTime = Minecraft.world.getWorldTime();
        ...
        moonPhase = Minecraft.world.getMoonPhase();
        ++frameCounter;
        ...
        if (entity != null)
        {
            ...
            if (Minecraft.gameSettings.thirdPersonView == 0 && !isSleeping)
            {
            ...
            if (Minecraft.player != null)
            {
                ...
                {
                    nightVision = Minecraft.gameRenderer.getNightVisionBrightness(Minecraft.player, partialTicks);
                }
            ...
            Vec3d vec3d = Minecraft.world.getSkyColor(entity, partialTicks);
        ...
        ShadersRender.renderShadowMap(gameRenderer, 0, partialTicks, finishTimeNano);
    ...
    public static void setCameraShadow(float partialTicks)
    {
        ...
        celestialAngle = Minecraft.world.getCelestialAngle(partialTicks);
    ...
    public static void renderCompositeFinal()
    {
        if (!isShadowPass)
        {
            ...
            OpenGlHelper.glFramebufferTexture2D(OpenGlHelper.GL_FRAMEBUFFER, OpenGlHelper.GL_COLOR_ATTACHMENT0, 3553, Minecraft.getFramebuffer().framebufferTexture, 0);
            GL11.glViewport(0, 0, Minecraft.width, Minecraft.height);

            if (GameRenderer.anaglyphEnable)
            {
                boolean flag1 = GameRenderer.anaglyphField != 0;
    ...
    public static void drawHorizon()
    {
        ...
        float f = (float)(Minecraft.gameSettings.renderDistance * 16);
...
//        fogMode = fogMode.capabilityId;
    ...
    static
    {
        ...
        shadersdir = new File(Minecraft.gameDir, "shaders");
        shaderpacksdir = new File(Minecraft.gameDir, shaderpacksdirname);
        configFile = new File(Minecraft.gameDir, optionsfilename);
