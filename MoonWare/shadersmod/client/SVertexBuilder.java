...
public class SVertexBuilder
{
    ...
    public void calcNormal(BufferBuilder wrr, int baseIndex)
    {
        ...
        float f = floatbuffer.get(baseIndex + 0 * vertexSize);
        float f1 = floatbuffer.get(baseIndex + 0 * vertexSize + 1);
        float f2 = floatbuffer.get(baseIndex + 0 * vertexSize + 2);
        float f3 = floatbuffer.get(baseIndex + 0 * vertexSize + offsetUV);
        float f4 = floatbuffer.get(baseIndex + 0 * vertexSize + offsetUV + 1);
        float f5 = floatbuffer.get(baseIndex + 1 * vertexSize);
        float f6 = floatbuffer.get(baseIndex + 1 * vertexSize + 1);
        float f7 = floatbuffer.get(baseIndex + 1 * vertexSize + 2);
        float f8 = floatbuffer.get(baseIndex + 1 * vertexSize + offsetUV);
        float f9 = floatbuffer.get(baseIndex + 1 * vertexSize + offsetUV + 1);
        ...
        int i1 = (l << 16) + (k << 8) + j;
        intbuffer.put(baseIndex + 0 * vertexSize + offsetNormal, i1);
        intbuffer.put(baseIndex + 1 * vertexSize + offsetNormal, i1);
        ...
        intbuffer.put(baseIndex + 0 * vertexSize + 10, j1);
        intbuffer.put(baseIndex + 0 * vertexSize + 10 + 1, k1);
        intbuffer.put(baseIndex + 1 * vertexSize + 10, j1);
        intbuffer.put(baseIndex + 1 * vertexSize + 10 + 1, k1);
        ...
        floatbuffer.put(baseIndex + 0 * vertexSize + 8, f47);
        floatbuffer.put(baseIndex + 0 * vertexSize + 8 + 1, f48);
        floatbuffer.put(baseIndex + 1 * vertexSize + 8, f47);
        floatbuffer.put(baseIndex + 1 * vertexSize + 8 + 1, f48);
