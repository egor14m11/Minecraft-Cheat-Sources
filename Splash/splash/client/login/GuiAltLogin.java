...
import splash.client.managers.GuiSXAlts;
...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, width / 2 - 100, var3 + 72 + 12 + 88, "Back"));
        this.buttonList.add(new GuiButton(2, width / 2 - 100, var3 + 72 + 34, "Import User:Pass"));
        this.buttonList.add(new GuiButton(3, width / 2 - 100, var3 + 72 + 56, "Authentication"));
        this.buttonList.add(new GuiButton(4, width / 2 - 100, var3 + 72 + 78, "SX Alts"));
