    ...
    public void executeCommand(String[] commandArguments) {
        ...
        if(commandArguments.length == 2) {
            ...
            String arg2 = commandArguments[1];
                ...
                if(Splash.getInstance().getModuleManager().getModuleByDisplayName(arg1.replaceAll("_", " ")) != null) {
                    Module module = Splash.getInstance().getModuleManager().getModuleByDisplayName(arg1.replaceAll("_", " "));
