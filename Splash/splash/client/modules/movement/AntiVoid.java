        ...
        if(!isBlockUnder()) {
            if(mc.thePlayer.fallDistance > 2.9f) {
            	if (motion) {
                    ...
                    mc.thePlayer.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(lastGroundPosition.getX(), lastGroundPosition.getY(), lastGroundPosition.getZ(), true));
