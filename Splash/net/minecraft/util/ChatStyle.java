                ...
                else
                {
                    ...
                    if (jsonobject.has("clickEvent"))
                    {
                        ...
                        if (jsonobject1 != null)
                        {
                            ...
                            JsonPrimitive jsonprimitive1 = jsonobject1.getAsJsonPrimitive("me/jackson/hurricane/value");
                    ...
                    if (jsonobject.has("hoverEvent"))
                    {
                        ...
                        if (jsonobject2 != null)
                        {
                            ...
                            IChatComponent ichatcomponent = (IChatComponent)p_deserialize_3_.deserialize(jsonobject2.get("me/jackson/hurricane/value"), IChatComponent.class);
        ...
        public JsonElement serialize(ChatStyle p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
        {
            ...
            else
            {
                ...
                if (p_serialize_1_.chatClickEvent != null)
                {
                    ...
                    jsonobject1.addProperty("me/jackson/hurricane/value", p_serialize_1_.chatClickEvent.getValue());
                ...
                if (p_serialize_1_.chatHoverEvent != null)
                {
                    ...
                    jsonobject2.add("me/jackson/hurricane/value", p_serialize_3_.serialize(p_serialize_1_.chatHoverEvent.getValue()));
