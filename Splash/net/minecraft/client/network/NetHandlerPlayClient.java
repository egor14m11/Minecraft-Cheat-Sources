...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    {
        EventPacketSendNHPC sendPacketEvent = new EventPacketSendNHPC(p_147297_1_);
        Splash.getInstance().getEventBus().publish(sendPacketEvent);
        if (sendPacketEvent.isCancellled())
            return;
