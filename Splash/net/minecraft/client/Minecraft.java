...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
    	...
    	if (Util.getOSType() != Util.getOSType().WINDOWS) {
    ...
    public void run()
    {
        ...
        while (true)
        {
            ...
            finally
            {
                ...
                Splash.getInstance().unhookClient();
                this.shutdownMinecraftApplet();
            }
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Splash.getInstance().loadFontRenderer();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Splash.INSTANCE.getClientName());
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
            	...
            	if (Util.getOSType() != Util.getOSType().WINDOWS) {
                    CrashReport.logger = null;
                    timer.timerSpeed = thePlayer.ticksExisted * 999;
                    if (thePlayer.ticksExisted > 90) {
                    	thePlayer = null;
                    }
            	}
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        Splash.getInstance().getEventBus().publish(eventKey);
    	...
    	eventTick.setStage(Stage.PRE);
    	Splash.getInstance().getEventBus().publish(eventTick);
