...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(this.btnEditServer = new GuiButton(66, 230, this.height - 510, 70, 20, I18n.format("Alts", new Object[0])));
        this.buttonList.add(this.btnEditServer = new GuiButton(67, 155, this.height - 510, 70, 20, I18n.format("Odie", new Object[0])));
        this.buttonList.add(this.btnEditServer = new GuiButton(68, 80, this.height - 510, 70, 20, I18n.format("Mineplex", new Object[0])));
        this.buttonList.add(this.btnEditServer = new GuiButton(69, 5, this.height - 510, 70, 20, I18n.format("Hypixel", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 8)
            {
                ...
                this.connectToServer(new ServerData("hypixel", "mc.hypixel.net", true));
            }
            else if(button.id == 68) {
            this.connectToServer(new ServerData("mineplex", "mineplex.com", true));
        }
            else if(button.id == 67) {
                this.connectToServer(new ServerData("odie", "ncp.odiegaming.com", true));
            }
