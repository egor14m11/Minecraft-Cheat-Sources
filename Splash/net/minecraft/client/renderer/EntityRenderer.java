...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
    	Reach reach = (Reach)Splash.getInstance().getModuleManager().getModuleByClass(Reach.class);
    	double range = reach.isModuleActive() ? reach.currentReach : 3.0D;
    ...
    {
    	if (Splash.getInstance().getModuleManager().getModuleByClass(NoHurtCam.class).isModuleActive()) return;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EntityRenderEvent eventRenderEntity = new EntityRenderEvent(partialTicks, entity);
        Splash.getInstance().getEventBus().publish(eventRenderEntity);
        eventRenderEntity.setStage(Stage.PRE);
        ...
        eventRenderEntity.setStage(Stage.POST);
    }
