...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            Splash.INSTANCE.getEventBus().publish(eventSafeWalk);
            boolean flag = this.onGround && this instanceof EntityPlayer && (isSneaking() || eventSafeWalk.isCancellled() || Splash.INSTANCE.getModuleManager().getModuleByClass(Scaffold.class).isModuleActive() && BlockUtils.getBlockAtPos(new BlockPos(Minecraft.getMinecraft().thePlayer.posX, Minecraft.getMinecraft().thePlayer.posY - .0001, Minecraft.getMinecraft().thePlayer.posZ)) instanceof BlockAir);
            if (Splash.INSTANCE.getModuleManager().getModuleByClass(Scaffold.class).isModuleActive() && Minecraft.getMinecraft().gameSettings.keyBindSneak.isKeyDown()) {
                flag = false;
            }
    		...
    		step.setStage(Stage.PRE);
    		Splash.INSTANCE.getEventBus().publish(step);
