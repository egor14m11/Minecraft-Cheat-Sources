            ...
            for (Entry<String, JsonElement> entry : jsonobject.entrySet())
            {
                ...
                if (statbase != null)
                {
                    ...
                    else if (((JsonElement)entry.getValue()).isJsonObject())
                    {
                        ...
                        if (jsonobject1.has("me/jackson/hurricane/value") && jsonobject1.get("me/jackson/hurricane/value").isJsonPrimitive() && jsonobject1.get("me/jackson/hurricane/value").getAsJsonPrimitive().isNumber())
                        {
                            tupleintjsonserializable.setIntegerValue(jsonobject1.getAsJsonPrimitive("me/jackson/hurricane/value").getAsInt());
                        }
    ...
    public static String dumpJson(Map<StatBase, TupleIntJsonSerializable> p_150880_0_)
    {
        ...
        for (Entry<StatBase, TupleIntJsonSerializable> entry : p_150880_0_.entrySet())
        {
            if (((TupleIntJsonSerializable)entry.getValue()).getJsonSerializableValue() != null)
            {
                ...
                jsonobject1.addProperty("me/jackson/hurricane/value", (Number)Integer.valueOf(((TupleIntJsonSerializable)entry.getValue()).getIntegerValue()));
