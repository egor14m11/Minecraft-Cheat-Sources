...
public abstract class EntityLivingBase extends Entity {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                if (flag) {
                    ...
                    if (entity != null) {
                        ...
                        this.attackedAtYaw = (float) (MathHelper.func_181159_b(d0, d1) * 180.0D / Math.PI - (double) this.getYaw());
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_) {
        ...
        float f1 = MathHelper.wrapAngleTo180_float(this.getYaw() - this.renderYawOffset);
        ...
        this.renderYawOffset = this.getYaw() - f1;
    ...
    private float getYaw() {
        return this instanceof EntityPlayerSP && RotationUtil.rotation != null ? RotationUtil.rotation.getYaw() : this.rotationYaw;
    }
}
