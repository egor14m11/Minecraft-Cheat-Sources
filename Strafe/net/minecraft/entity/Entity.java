...
public abstract class Entity implements ICommandSender {
    ...
    protected final Vec3 getVectorForRotation(float pitch, float yaw) {
        if (this instanceof EntityPlayerSP && RotationUtil.rotation != null && RotationUtil.spoofLook) {
            yaw = RotationUtil.rotation.getYaw();
            pitch = RotationUtil.rotation.getPitch();
        }
