...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void drawBackground() {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation(Strafe.INSTANCE.BACKGROUND));
        GuiIngame.drawScaledCustomSizeModalRect(0, 0, 0, 0, this.width, this.height, this.width, this.height, this.height, this.width);
    }
