...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void addToSendQueue(Packet packet) {
        final EventPacket event = new EventPacket(EventPacket.Action.SEND, packet);
    ...
    public void addToSendQueue(BlockPos blockPos, int i, ItemStack itemStack, int i1, float v, int i2) {
    }
}
