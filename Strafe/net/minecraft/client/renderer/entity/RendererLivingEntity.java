    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        if(entity == Minecraft.getMinecraft().thePlayer) {
            ...
            if (entity.isSneaking()) {
                ...
                GlStateManager.enableTexture2D();
                GlStateManager.depthMask(true);
                fontrenderer.chroma = true;
                fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, 0, 553648127);
                fontrenderer.chroma = false;
                GlStateManager.enableLighting();
                GlStateManager.disableBlend();
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.popMatrix();
                   ...
                   fontrenderer.chroma = true;
                this.renderOffsetLivingLabel(entity, x, y - (entity.isChild() ? (double)(entity.height / 2.0F) : 0.0D), z, Minecraft.getMinecraft().thePlayer.getDisplayName().getFormattedText(), 0.02666667F, 0.1);
                fontrenderer.chroma = false;
                }
        }
    }
