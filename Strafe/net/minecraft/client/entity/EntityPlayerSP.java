...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        Strafe.INSTANCE.scriptManager.eventUpdate();
    ...
    public void onUpdateWalkingPlayer() {
        final EventPreMotion event = new EventPreMotion(this.rotationYaw, this.rotationPitch, this.onGround);
        EventManager.call(event);
        Strafe.INSTANCE.scriptManager.eventMotion();
        if (mc.gameSettings.thirdPersonView != 0 && RotationUtil.rotation != null) {
            this.rotationYawHead = RotationUtil.rotation.getYaw();
            this.rotationPitchHead = RotationUtil.rotation.getPitch();
        }
        ...
        if (this.isCurrentViewEntity()) {
            ...
            boolean isMoving = dX * dX + dY * dY + dZ * dZ > 9.0E-4D || this.positionUpdateTicks >= 20;
            boolean isRotating = dYaw != 0.0D || dPitch != 0.0D;
