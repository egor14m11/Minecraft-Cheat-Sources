...
public class GuiConnecting extends GuiScreen {
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    Strafe.INSTANCE.discordRP.update("Playing on", "" + ip + (port != 25565 ? ":" + port : ""));
    ...
    public void initGui() {
        ...
        this.buttonList.add(new UIButton(0, this.width / 2 - 100, this.height / 4 + 120 + 12, I18n.format("gui.cancel")));
    }
