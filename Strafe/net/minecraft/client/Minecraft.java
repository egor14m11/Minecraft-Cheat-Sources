...
public class Minecraft implements IThreadListener, IPlayerUsage {
     ...
     */
    private void startGame() throws LWJGLException, IOException, ScriptException, NoSuchMethodException {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading Strafe Client..");
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Strafe.INSTANCE.moduleManager.modules.stream().filter(module -> module.getKey() == k).forEach(Module::toggle);
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        ...
        Strafe.INSTANCE.discordRP.update("Playing Singleplayer", "Hacking Ingame");
    }
