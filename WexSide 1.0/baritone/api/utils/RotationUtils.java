...
public final class RotationUtils {
    ...
    private static Rotation calcRotationFromVec3d(Vec3d orig, Vec3d dest) {
        ...
        double dist = Math.sqrt(delta[0] * delta[0] + delta[2] * delta[2]) + ThreadLocalRandom.current().nextDouble(-2, 2);
        double pitch = MathHelper.atan2(delta[1], dist) + ThreadLocalRandom.current().nextDouble(-2, 2);
        return new Rotation(
