...
public class Rotation {
	...
	/**
	 * Adds the yaw/pitch of the specified rotations to this rotation's yaw/pitch,
	...
	/**
	 * Subtracts the yaw/pitch of the specified rotations from this rotation's
	 * yaw/pitch, and returns the result.
	 *
	 * @param other Another rotation
