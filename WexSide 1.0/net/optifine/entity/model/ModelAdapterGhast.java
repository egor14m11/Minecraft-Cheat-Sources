...
public class ModelAdapterGhast extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer) RefUtils.getFieldValue(modelghast, ModelGhast_body);
            }
            else
            {
                String s = "tentacle";
                ...
                {
                    ModelRenderer[] amodelrenderer = (ModelRenderer[]) RefUtils.getFieldValue(modelghast, ModelGhast_tentacles);
