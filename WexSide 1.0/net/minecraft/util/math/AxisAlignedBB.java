...
public class AxisAlignedBB {
	...
	public AxisAlignedBB scale(float factor) {
		AxisAlignedBB a = new AxisAlignedBB(this.minX / factor, this.minY, this.minZ / factor, this.maxX / factor,
				this.maxY, this.maxZ / factor);
		return a;
	}
