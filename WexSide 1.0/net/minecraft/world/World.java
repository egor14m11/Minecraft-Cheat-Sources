...
public abstract class World implements IBlockAccess {
	...
	public RayTraceResult rayTraceBlocks2(Vec3d start, Vec3d end) {
		return this.rayTraceBlocks(start, end, true, true, true);
	}
	...
	public Vec3d getSkyColor(Entity entityIn, float partialTicks) {
		...
		int i, j, k;
		if (entityIn != null) {
			i = MathHelper.floor(entityIn.posX);
			j = MathHelper.floor(entityIn.posY);
			k = MathHelper.floor(entityIn.posZ);
		} else {
			i = 0;
			j = 0;
			k = 0;
	...
	public boolean handleMaterialAcceleration2(AxisAlignedBB bb, Material materialIn, Entity entityIn) {
		int j2 = MathHelper.floor(bb.minX);
		int k2 = MathHelper.ceil(bb.maxX);
		int l2 = MathHelper.floor(bb.minY);
		int i3 = MathHelper.ceil(bb.maxY);
	...
	public boolean checkLightFor(EnumSkyBlock lightType, BlockPos pos) {
		EventGameOverlay event = new EventGameOverlay(EventGameOverlay.OverlayType.Light);
