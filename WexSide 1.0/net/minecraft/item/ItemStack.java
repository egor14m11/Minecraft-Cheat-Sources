...
import ru.wendoxd.modules.impl.player.Helper;
...
public final class ItemStack implements IItemStack {
	...
	public boolean disableEnchantment;
	/** Size of the stack. */
	...
	public ItemStack onItemUseFinish(World worldIn, EntityLivingBase entityLiving) {
		if (entityLiving == Minecraft.getMinecraft().player) {
			Aura.consumeTime = System.currentTimeMillis();
		}
		if (getItem() instanceof ItemAppleGold) {
			Helper.lastGappleConsumeTime = this.getItem().hasEffect(this) ? System.currentTimeMillis() + 5000
	...
	public boolean isItemEqualIgnoreDurability2(ItemStack stack) {
