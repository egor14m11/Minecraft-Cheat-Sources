...
import ru.wendoxd.modules.impl.visuals.EnchantmentColor;
import ru.wendoxd.modules.impl.visuals.Glow;
import ru.wendoxd.modules.impl.visuals.NoOverlay;
...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
	...
	public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
		...
		if (entitylivingbaseIn instanceof EntityPlayer) {
			...
			if ((type = CastHelper.isInstanceof(entitylivingbaseIn, castHelper.build())) != null) {
	...
	public static void renderEnchantedGlint(RenderLivingBase<?> p_188364_0_, EntityLivingBase p_188364_1_,
		...
		if (NoOverlay.nooverlay.isEnabled(false) && NoOverlay.type.get(13))
			return;
		...
		if (!Config.isShaders() || !Shaders.isShadowPass) {
			...
			for (int i = 0; i < 2; ++i) {
				...
				float f2 = 0.76F;
				if (EnchantmentColor.enchantmentcolor.isEnabled(false)) {
					GlStateManager.color(EnchantmentColor.enchantmentcolor.getColor().getRed() / 255F,
							EnchantmentColor.enchantmentcolor.getColor().getGreen() / 255F,
							EnchantmentColor.enchantmentcolor.getColor().getBlue() / 255F,
							EnchantmentColor.enchantmentcolor.getColor().getAlpha() / 255F);
				} else {
