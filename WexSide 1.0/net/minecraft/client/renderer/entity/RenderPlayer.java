...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer> {
	...
	public static ResourceLocation amogusTexture = new ResourceLocation("wexside/amogus.png"),
			demonTexture = new ResourceLocation("wexside/demon.png"),
			rabbitTexture = new ResourceLocation("wexside/rabbit.png"),
			sonicTexture = new ResourceLocation("wexside/sonic.png");
