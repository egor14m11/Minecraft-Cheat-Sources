...
import ru.wendoxd.events.impl.block.EventBlockRender;
...
public class BlockRendererDispatcher implements IResourceManagerReloadListener {
	...
	public boolean renderBlock(IBlockState state, BlockPos pos, IBlockAccess blockAccess,
		...
		try {
			...
			EventBlockRender event = new EventBlockRender(state, pos, blockAccess, worldRendererIn);
			...
			if (enumblockrendertype == EnumBlockRenderType.INVISIBLE) {
				...
				case MODEL:
					try {
						return this.blockModelRenderer.renderModel(blockAccess, this.getModelForState(state), state,
								pos, worldRendererIn, true);
					} catch (Exception e) {
					}
