	...
	public void renderItemInFirstPerson(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, ItemStack p_187457_6_, float p_187457_7_) {
		if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
			...
			if (p_187457_6_.isEmpty()) {
				...
				if (SwingAnimations.enabled.isEnabled(false) && SwingAnimations.isEnabled()) {
					if (flag1) {
						GL11.glTranslatef(SwingAnimations.right_x.getFloatValue(),
								SwingAnimations.right_y.getFloatValue(), SwingAnimations.right_z.getFloatValue());
					} else {
						GL11.glTranslatef(SwingAnimations.left_x.getFloatValue(),
								SwingAnimations.left_y.getFloatValue(), SwingAnimations.left_z.getFloatValue());
					}
				}
				if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0
					...
					if (enumhandside == EnumHandSide.RIGHT) {
						...
						if (SwingAnimations.animations.get() == 1 && SwingAnimations.isEnabled()) {
							GL11.glRotated(90, 0, 1, 0);
							GL11.glRotated(-60, 0, 0, 1);
							GL11.glRotated(-80 - 40 * anim, 1, 0, 0);
						} else if (SwingAnimations.animations.get() == 2 && SwingAnimations.isEnabled()) {
							GL11.glTranslated(0.2f, 0.2f, -0.15f * anim - 0.15f);
							GL11.glRotated(-120, 1, 0, 0);
							GL11.glRotated(-anim * 90 + 30, 0, 1, 0);
				...
				if (SwingAnimations.spin.isEnabled(false) && SwingAnimations.isEnabled()) {
					GL11.glRotated((spin = spin - 0.1), 0, 1, 0);
				}
