...
import ru.wendoxd.modules.impl.visuals.ChunkAnimator;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
     ...
     */
    public static boolean cheatInitialized;
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("WexSide, купи экспенсив - https://vk.com/expensiveclient");
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
        if (guiScreenIn != null && !(guiScreenIn instanceof MenuShell)) {
            MenuAPI.transparencies.reset();
        }
        ...
        if (!this.playerController.getIsHittingBlock()) {
            ...
            if (!this.player.isRowingBoat()) {
                ...
                for (EnumHand enumhand : EnumHand.values()) {
                    ...
                    EventManager.call(erc);
                    if (itemstack.getItem() instanceof ItemAppleGold && erc.isCanceled()) {
                        break;
                    }
                    if (this.objectMouseOver != null) {
                        switch (this.objectMouseOver.typeOfHit) {
                            ...
                            case BLOCK:
                                ...
                                if (this.world.getBlockState(blockpos).getMaterial() != Material.AIR) {
                                    ...
                                    if (enumactionresult == EnumActionResult.SUCCESS) {
                                        ...
                                        if (!itemstack.isEmpty() && (itemstack.getStackSize() != i
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null
                || (BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().isPathing() && player != null)
    ...
    private void processKeyBinds() {
        ...
        boolean skip = this.skipMousePress;
    ...
    public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage) {
        ...
        try {
            ...
            fieldClasses.set(loader, classes);
            ChunkAnimator.renderChunk.clear();
