...
public class ModelRenderer {
	...
	public ModelRenderer addCube(final float offX, final float offY, final float offZ, final float width,
			final float height, final float depth, final float delta, final boolean mirrored) {
		this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, offX, offY, offZ, (int) width,
				(int) height, (int) depth, delta, mirrored));
		return this;
	}

	public ModelRenderer addCube(final float offX, final float offY, final float offZ, final float width,
			final float height, final float depth, final float delta) {
		this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, offX, offY, offZ, (int) width,
				(int) height, (int) depth, delta));
		return this;
	}
