...
public class ModelPlayer extends ModelBiped {
	...
	public ModelPlayer(final float modelSize, final boolean smallArmsIn) {
		...
		if (smallArmsIn) {
			...
			(this.bipedLeftArmwear = new ModelRenderer(this, 48, 48)).addBox(-1.0f, -2.0f, -2.0f, 3, 12, 4,
					modelSize + 0.25f);
			this.bipedLeftArmwear.setRotationPoint(5.0f, 2.5f, 0.0f);
			(this.bipedRightArmwear = new ModelRenderer(this, 40, 32)).addBox(-2.0f, -2.0f, -2.0f, 3, 12, 4,
					modelSize + 0.25f);
			this.bipedRightArmwear.setRotationPoint(-5.0f, 2.5f, 10.0f);
		} else {
			(this.bipedLeftArm = new ModelRenderer(this, 32, 48)).addBox(-1.0f, -2.0f, -2.0f, 4, 12, 4, modelSize);
			this.bipedLeftArm.setRotationPoint(5.0f, 2.0f, 0.0f);
			(this.bipedLeftArmwear = new ModelRenderer(this, 48, 48)).addBox(-1.0f, -2.0f, -2.0f, 4, 12, 4,
					modelSize + 0.25f);
			this.bipedLeftArmwear.setRotationPoint(5.0f, 2.0f, 0.0f);
			(this.bipedRightArmwear = new ModelRenderer(this, 40, 32)).addBox(-3.0f, -2.0f, -2.0f, 4, 12, 4,
					modelSize + 0.25f);
			this.bipedRightArmwear.setRotationPoint(-5.0f, 2.0f, 10.0f);
		}
		(this.bipedLeftLeg = new ModelRenderer(this, 16, 48)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4, modelSize);
		this.bipedLeftLeg.setRotationPoint(1.9f, 12.0f, 0.0f);
		(this.bipedLeftLegwear = new ModelRenderer(this, 0, 48)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4,
				modelSize + 0.25f);
		this.bipedLeftLegwear.setRotationPoint(1.9f, 12.0f, 0.0f);
		(this.bipedRightLegwear = new ModelRenderer(this, 0, 32)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4,
				modelSize + 0.25f);
		...
		this.rabbitBone.cubeList
				.add(new ModelBox(this.rabbitBone, 28, 45, -5.0f, -13.0f, -5.0f, 10, 11, 8, 0.0f, false));
	...
	public void render(final Entity entityIn, final float limbSwing, final float limbSwingAmount,
		...
		if (entityIn instanceof EntityPlayer) {
			...
			if ((type = CastHelper.isInstanceof(entityIn, castHelper.build())) != null) {
				modelType = Module.visuals_entitiestab.get(type.ordinal()).model.get();
			}
		}
		GlStateManager.pushMatrix();
		if (modelType == 1) {
			final boolean flag = entityIn instanceof EntityLivingBase
