...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener {
	...
	public void initGui() {
		...
		this.x = new GuiTextField(0, mc.fontRendererObj, width / 2 + 100, height / 2 + 100, 50, 20);
		this.y = new GuiTextField(0, mc.fontRendererObj, width / 2 + 100, height / 2 + 130, 50, 20);
		// this.toggle = new GuiButton(1337, width / 2 + 100, height / 2 - 50, "Вкл");
