...
public class GuiOptionSlider extends GuiButton {
	...
	protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			RenderUtils.drawRect(this.xPosition + this.sliderValue * (float) (this.width - 6), this.yPosition,
					this.xPosition + this.sliderValue * (float) (this.width - 6) + 8, this.yPosition + 20,
					RenderUtils.rgba(50, 50, 50, 255));
			// this.drawTexturedModalRect(this.xPosition + (int)(this.sliderValue *
			// (float)(this.width - 8)), this.yPosition, 0, 66, 4, 20);
			// this.drawTexturedModalRect(this.xPosition + (int)(this.sliderValue *
			// (float)(this.width - 8)) + 4, this.yPosition, 196, 66, 4, 20);
		}
	}
