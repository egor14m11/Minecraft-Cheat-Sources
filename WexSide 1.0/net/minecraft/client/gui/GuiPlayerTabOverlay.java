...
public class GuiPlayerTabOverlay extends Gui {
	...
	public static boolean tabRender;
	...
	public static Animation y_animation = new Animation();
	...
	public static void tick() {
		y_animation.update(Minecraft.getMinecraft().gameSettings.keyBindPlayerList.isKeyDown());
	}
	...
	public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
		double offset = y_animation.getDrop();
		GlStateManager.pushMatrix();
		GlStateManager.translate(1, -200 + (200 * offset), 1);
		RenderUtils.sizeAnimation(width, -200 + (200 * offset), offset);
		...
		for (int k4 = 0; k4 < l3; ++k4) {
			...
			if (k4 < list.size()) {
				...
				if (StreamerMode.streamermode.isEnabled(false)) {
					if (StreamerMode.type.get(2) && !s4.contains(mc.player.getName())) {
						s4 = "\u00a7aProtected";
					}
					if (StreamerMode.type.get(2)) {
						s4 = s4.replace(mc.player.getName(), TextFormatting.GREEN + "Protected");
					}
				}
