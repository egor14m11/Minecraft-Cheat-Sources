...
public class GuiDisconnected extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, Math.min(this.height / 2 + this.textHeight / 2 + this.fontRendererObj.FONT_HEIGHT + 23, this.height - 30), "Reconnect"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            ...
            this.mc.displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this.mc, GuiConnecting.data));
        }
    }
