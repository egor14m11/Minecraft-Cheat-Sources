    ...
    class Button extends GuiButton
    {
        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                ...
                RenderUtils.drawRect(this.xPosition + this.volume * (float) (this.width - 6), this.yPosition, this.xPosition + this.volume * (float) (this.width - 8)+8, this.yPosition + 20, RenderUtils.rgba(50, 50, 50, 255));
