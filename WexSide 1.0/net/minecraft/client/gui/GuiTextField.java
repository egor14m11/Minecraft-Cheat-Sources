		...
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				if (Minecraft.getMinecraft().currentScreen instanceof GuiAltManager) {
					RenderUtils.drawRoundedRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1,
							this.yPosition + this.height + 0.7F, -6250336, 6);
					RenderUtils.drawRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width,
							this.yPosition + this.height, -16777216, 3);
				} else {
			...
			if (!s.isEmpty()) {
				...
				if (StreamerMode.streamermode.isEnabled(false) && StreamerMode.type.get(5) && s1.startsWith("/warp")) {
					s1 = "/warp ";
				}
				if (StreamerMode.streamermode.isEnabled(false) && StreamerMode.type.get(6) && s1.startsWith("/l")) {
					s1 = "/l ";
				}
				if (StreamerMode.streamermode.isEnabled(false) && StreamerMode.type.get(6) && s1.startsWith("/reg")) {
					s1 = "/reg ";
				}
