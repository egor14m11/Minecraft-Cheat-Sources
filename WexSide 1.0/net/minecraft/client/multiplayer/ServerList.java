...
public class ServerList {
	...
	public void loadServerList() {
		try {
			this.servers.clear();
			NBTTagCompound nbttagcompound = CompressedStreamTools.read(new File("data/servers.dat"));
	...
	public void saveServerList() {
		try {
			...
			CompressedStreamTools.safeWrite(nbttagcompound, new File("data/servers.dat"));
		} catch (Exception exception) {
