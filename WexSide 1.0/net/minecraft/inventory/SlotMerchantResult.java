...
public class SlotMerchantResult extends Slot
{
    ...
    private boolean doTrade(MerchantRecipe trade, ItemStack firstItem, ItemStack secondItem)
    {
        ...
        {
            if (!itemstack1.isEmpty() && !secondItem.isEmpty() && itemstack1.getItem() == secondItem.getItem() && secondItem.getStackSize() >= itemstack1.getStackSize())
            {
                firstItem.func_190918_g(itemstack.getStackSize());
                secondItem.func_190918_g(itemstack1.getStackSize());
                return true;
            }
