...
public abstract class EntityThrowable extends Entity implements IProjectile {
	...
	public void setVelocity(double x, double y, double z) {
		...
		if (this instanceof EntityEnderPearl && ESP.predicts.get(0) && !breaked) {
			buildPositions(200);
		}
	}
	...
	public void buildPositions(int ticks) {
		...
		int prevIgnoreTime = this.ignoreTime;
		...
		Entity prevIgnoreEntity = this.ignoreEntity;
		...
		this.ignoreTime = prevIgnoreTime;
		this.ticksExisted = prevTicksExisted;
		this.ignoreEntity = prevIgnoreEntity;
	}
