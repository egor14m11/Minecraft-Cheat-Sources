...
public class GuiNameField extends Gui {
	...
	public GuiNameField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
		this.id = componentId;
	...
	public void drawTextBox() {
		...
		int size = (int) Fonts.MNTSB_12.drawStringWithShadow(flag ? s.substring(0, j) : s, (float) l + 1,
				(float) i1 + 3.5F, i);

		if (isFocused) {
			Fonts.MNTSB_12.drawStringWithShadow((inputTicker % 100 < 50 ? "_" : ""), size + 1, (float) i1 + 3, i);
			inputTicker++;
		}
	}
